...
export const states: StateGuide[] = [
  ...
  },
  {
    ...
    reviewedAt: '2026-07-17',
    summary:
      '内华达州先按用途和文件能力选择 REAL ID、Standard license/ID 或 Driver Authorization Card（DAC）：REAL ID 用于联邦身份场景，Standard 仍可州内驾驶和一般身份证明，DAC 只授予驾驶权限而不作为身份证明。成为 Nevada resident 后，如要在州内驾驶，现行 NRS 483.245 要求在 30 天内取得 Nevada 驾照。',
    realIdSummary:
      '首次或升级 Nevada REAL ID 必须到 DMV office 出示一份合格 identity、一份显示完整 SSN 的证明、两份 Nevada residential-address 证明、完整姓名变化链及适用的 DMV-approved translation。有效外州 REAL ID 通常只能作为 Nevada Standard credential 的 identity 依据；要取得 Nevada REAL ID，专门 REAL ID 页面要求重新出示 foundational documents。',
    licenseSummary:
      '21 岁及以上持有效美国州、美国领地或 Canada 驾照的新居民，在没有不良记录等触发条件时通常只做 vision test；外国证件不是自动免试依据。中国大陆驾照不在当前 DMV 015 reciprocity 名单中，成为 Nevada resident 后通常要按 foreign-country license 路径完成 vision、knowledge 和 skills tests。',
    appointmentNote:
      'Quick Cards 只能让符合条件的成人在线开始首次 license、ID、instruction permit 或 DAC 申请；conditional approval 后仍要预约办公室出示原件、付款和拍照。Nevada DMV 当前除牌照交回、逾期债务付款、部分 VIN inspection 和 Turbo Titles 文件交回外，其他 office 服务均要求预约。',
    editorNotes: [
      'Nevada REAL ID 是现有 driver license、permit 或 ID 的联邦合规版本，右上角有金色 Nevada 星标；Standard 卡标有 Not for Real ID Purposes，DAC 标有 Not Valid for ID。',
      ...
      '姓名不同要用政府签发 marriage certificate、divorce decree、adoption record 或 court order 连起每一次变化；Social Security card 不能代替姓名变更文件。',
      'SSN 证明可用 Social Security card、W-2、IRS 1099 或 printed pay stub，文件必须显示当前法定姓名和完整号码。',
      '已有合法身份但没有 SSN 的申请人可能取得 Standard license/ID；已申请但尚未收到 SSN 时，Nevada DMV 页面允许在申请表中作 attestation。',
      'REAL ID 与 Standard 通常都要两份显示申请人姓名和 Nevada residential address 的证明，online account 的原始打印件可以接受。',
      'Lease、utility bill、bank statement、pay stub、court record 等常见地址材料通常要在前 60 天内出具；insurance、medical、tax、property-tax 或 mortgage 类材料按最近签发版本准备。',
      ...
      '任何非英文文件都要由 Nevada DMV approved translator 制作完整 typed/electronically printed translation，包含日期、translator number、姓名、签名和规定声明；摘要式翻译或把声明另放一页会被拒。',
      ...
      '首次 knowledge 与 skills testing fee 当前为 $25，之后每次 retest $10；KnowToDrive online knowledge exam 另收每次 $6.75，DMV 的 $25 initial testing fee 仍会收取。',
      '单独把现有 Nevada driver license 升级 REAL ID 的页面费用为 $8.50，ID card 为 $7.50；首次签发或续期仍应按对应 license/ID transaction fee 判断总额。',
      'Nevada resident 包括依法定居、在州内经营并保有车辆、在州内生活工作，或为取得仅居民可用权益而声明 residency 的人。',
      '成为 resident 后继续在 Nevada 驾驶，NRS 483.245 要求 30 天内取得 Nevada driver license；新居民车辆通常也要在 30 天内注册。',
      ...
      '游客不能取得 Nevada license/ID；成为居民后，持 China 等非 Canada 外国驾照者通常要 vision、knowledge 和 skills tests。',
      ...
      'Nevada 网页对 Taiwan 路径写 21+、有效 Class B license、Taiwan consular verification、vision 和 knowledge test，而 DMV 015 表格写 foreign national 18+；18 至 20 岁申请人应先向 DMV 确认是否可用 waiver。',
      ...
      'Online 与 office knowledge test 直接提供 English 和 Spanish；需要其他语言的 non-commercial applicant 可按规则使用 interpreter。',
      ...
      '18 岁及以上 beginning driver 的 instruction permit 可选；不办 permit 时不能线上预约 road test，要在通过 knowledge test 后到 office 由工作人员安排。',
      ...
      '多数 65 岁以下 driver license 有效 8 年，65 岁及以上 license 与 DAC 通常有效 4 年；使用 D/S 移民记录的 Limited Term credential 通常只签发 1 年。',
      ...
      '改名要先在 SSA 更新并至少等待 2 个工作日，再到 office 带当前 credential 和授权改名的原始法律文件；updated Social Security card 本身不够。',
      'MyDMV 可补发多数遗失、被盗或损坏的 license、ID、permit 或 DAC，但卡片不能在未来 60 天内到期，驾驶权限也不能 suspended/revoked。',
      '所有 Nevada license 和 ID 均邮寄，online renewal 通常 7 至 10 个工作日，office transaction 通常 7 至 14 个工作日；30 天仍未收到应联系 DMV。',
      'Nevada resident 不能同时持有任何州的 driver license 与 Nevada ID card；普通 Nevada ID 最低申请年龄为 10 岁。',
    ],
    documentHighlights: [
      ...
      '外州新居民带现有 state-issued license/permit/ID；申领 Nevada credential 时原外州卡会打孔 VOID 后退回。',
    ...
    commonMistakes: [
      ...
      '驾照过期超过 1 年仍按普通线上续期，未准备 knowledge test；超过 4 年又未准备 skills test。',
    ...
    recommendedSteps: [
      '先判断用途：需要国内航班/联邦设施的带星 REAL ID，还是只需 Standard 驾照/ID；无法满足 Standard identity 路径且只需驾驶时再核对 DAC。',
      ...
      '新居民带现有外州 credential；21+ 的 U.S./territory/Canada 驾照持有人先核对是否只有 vision test，违规、DUI、停吊销或 restriction 则按触发项目准备考试。',
      '外国访客同时携带有效原驾照，IDP 只作翻译辅助；成为 resident 后改走 Nevada credential 与 30 天路径。',
      '中国大陆驾照持有人按 vision、knowledge、skills tests 准备，不套用 Taiwan/South Korea 的 DMV 015 waiver。',
      'Taiwan/South Korea 申请人先读 DMV 015；Taiwan 还核对网页列出的 21+、Class B 和 consular verification，年龄或文件有冲突时先联系 DMV。',
      'Knowledge test 先选 English/Spanish online 或 office；需要中文口译时提前找到合格非家属 interpreter，并准备 approval letter 与 DLD 11。',
      '18+ 新手决定是否办 instruction permit；要线上预约 road test 就先取得 permit，不办则通过笔试后到 office 安排。',
      ...
      '办完保存 interim document 并注册 MyDMV 跟踪邮寄；7 至 14 个工作日是常见窗口，30 天未收到立即联系 DMV。',
      '续期先让 MyDMV 判断资格；71+、DAC、CDL、Limited Term、姓名变化、过期超过 364 天或需考试时改走相应 office/mail 路径。',
      '只改地址时同时检查 driver credential 与每辆车的 registration record，30 天内完成；改名则先更新 SSA 并等待至少 2 个工作日。',
      '遗失补证先确认卡片距到期超过 60 天且 privilege 正常，再决定 MyDMV 或 office；临近到期应走 renewal。',
    ],
    actionLinks: [
      {
        label: 'Nevada REAL ID',
        url: 'https://dmv.nv.gov/realid.htm',
        description: '三类卡区别、联邦用途、REAL ID 材料、外州 REAL ID 和升级费用。',
      },
      {
        label: 'Proof of Identity & Residency',
        url: 'https://dmv.nv.gov/dlresidency.htm',
        description: 'REAL ID、Standard、DAC 三套 identity、SSN、地址、姓名和非公民要求。',
      },
      {
        label: 'Driver Authorization Cards',
        url: 'https://dmv.nv.gov/dac.htm',
        description: 'DAC 用途、材料、翻译、考试、费用、续期和外州卡交回。',
      },
      {
        label: 'New Resident Guide',
        url: 'https://dmv.nv.gov/newresident.htm',
        description: 'Resident 定义、外州转入、考试触发、新居民费用和车辆登记。',
      },
      {
        label: 'New Adult Drivers',
        url: 'https://dmv.nv.gov/nvdladult.htm',
        description: '18+ permit 选择、外国申请人、Taiwan 路径和 suspended/revoked 处理。',
      },
      {
        label: 'Driver License Testing',
        url: 'https://dmv.nv.gov/dltesting.htm',
        description: 'Vision、knowledge、skills、语言、口译、车辆、费用和考试触发。',
      },
      {
        label: 'Quick Cards',
        url: 'https://dmv.nv.gov/quickcards.htm',
        description: '首次申请线上起步、资格限制、office 完成和邮寄时效。',
      },
      {
        label: 'Driver License Renewal',
        url: 'https://dmv.nv.gov/dlrenewal.htm',
        description: 'Online/mail/office 续期、资格、Limited Term、期限、考试和邮寄。',
      },
      {
        label: 'Appointments',
        url: 'https://dmv.nv.gov/appointments.htm',
        description: 'General/drive-test 预约、少量 walk-in 例外和 rural 预约窗口。',
      },
      {
        label: 'Driver License / ID Fees',
        url: 'https://dmv.nv.gov/dlfees.htm',
        description: '按年龄和交易列出的 license、DAC、permit、ID、考试与改址费用。',
      },
      {
        label: 'Name and Address Changes',
        url: 'https://dmv.nv.gov/addchange.htm',
        description: 'SSA 顺序、姓名文件、30 天地址期限、MyDMV 和当前费用。',
      },
      {
        label: 'Nevada DMV 首页',
        url: 'https://dmv.nv.gov/',
        description: '进入 DriveNV、MyDMV、Quick Cards、appointments 和实时服务状态。',
      },
    ],
    sources: [
      {
        ...
        url: 'https://dmv.nv.gov/realid.htm',
        note: '星标、Standard/DAC 区别、TSA、identity、SSN、两份地址、姓名、外州 REAL ID、Limited Term 和费用。',
      },
      {
        label: 'Nevada DMV Proof of Identity & Residency',
        url: 'https://dmv.nv.gov/dlresidency.htm',
        note: 'REAL ID、Standard、DAC 三套材料，60 天地址、姓名、SSN、非公民、Taiwan 和 resident 定义。',
      },
      {
        label: 'Nevada DMV Driver Authorization Cards',
        url: 'https://dmv.nv.gov/dac.htm',
        note: 'DAC 驾驶边界、identity 三档、翻译、地址、费用、考试、interpreter、续期和外州证件。',
      },
      {
        label: 'Nevada DMV New Resident Guide',
        url: 'https://dmv.nv.gov/newresident.htm',
        note: 'Resident triggers、外州材料、考试触发、foreign-country 路径、费用、预约和邮寄。',
      },
      {
        label: 'Nevada Revised Statutes Chapter 483',
        url: 'https://www.leg.state.nv.us/nrs/nrs-483.html',
        note: '现行 NRS 483.240/245 的访客驾驶与新居民 30 天换证规则，以及 DAC 法定边界。',
      },
      {
        label: 'Nevada Official Driver Handbook',
        url: 'https://dmv.nv.gov/pdfforms/dlbook.pdf',
        note: '2026 驾照、新居民 30 天、credential 有效期、移民期限与驾驶规则。',
      },
      {
        label: 'Nevada DMV First License, ID or DAC',
        url: 'https://dmv.nv.gov/nvdlfirst.htm',
        note: '首次申请材料、外州与外国证件考试矩阵、renewal/reinstatement 测试触发。',
      },
      {
        label: 'Nevada DMV New Adult Drivers',
        url: 'https://dmv.nv.gov/nvdladult.htm',
        note: '18+ permit optional、外国申请人、Taiwan 21+/Class B/verification 和 PDPS。',
      },
      {
        label: 'Nevada DMV Driver License Testing',
        url: 'https://dmv.nv.gov/dltesting.htm',
        note: 'Vision 20/40、25 题/80%、English/Spanish、interpreter、road-test 车辆、费用与触发矩阵。',
      },
      {
        label: 'Nevada DMV Adult Road Test',
        url: 'https://dmv.nv.gov/roadtestadult.htm',
        note: 'Road-test eligibility、预约、材料、registration/insurance、自动失败和 retest。',
      },
      {
        label: 'Nevada DMV 015 Foreign National Waiver',
        url: 'https://dmv.nv.gov/pdfforms/dmv015.pdf',
        note: '3/2025 South Korea 与 Republic of China (Taiwan) reciprocity，只免 drive test 及法律声明。',
      },
      {
        label: 'Nevada DMV Approved Translators',
        url: 'https://dmv.nv.gov/translators.asp',
        note: 'Approved list、完整 typed translation、日期、translator number、签名和拒件条件。',
      },
      {
        label: 'Nevada DMV Driver License / ID Fees',
        url: 'https://dmv.nv.gov/dlfees.htm',
        note: '按年龄列出的 license、DAC、permit、ID、testing、duplicate、late 和 change 费用。',
      },
      {
        label: 'Nevada DMV Driver License Renewal',
        url: 'https://dmv.nv.gov/dlrenewal.htm',
        note: 'Online/mail/office eligibility、71+、DAC/CDL、Limited Term、过期考试、有效期和邮寄。',
      },
      {
        label: 'Nevada DMV Duplicate Credential',
        url: 'https://dmv.nv.gov/dlduplicate.htm',
        note: 'MyDMV/office、60 天到期边界、suspended/revoked 与 CDL 限制。',
      },
      {
        label: 'Nevada DMV Name and Address Changes',
        url: 'https://dmv.nv.gov/addchange.htm',
        note: 'SSA 先行与 2 个工作日、法定姓名文件、30 天改址、分开更新车辆和费用。',
      },
      {
        label: 'Nevada DMV Quick Cards',
        url: 'https://dmv.nv.gov/quickcards.htm',
        note: '首次申请线上起步、排除人群、office 原件/付款/照片、interim 和 7 至 14 天邮寄。',
      },
      {
        label: 'Nevada DMV Appointments',
        url: 'https://dmv.nv.gov/appointments.htm',
        note: 'Appointment-only、四类例外、permit 与 drive test、Wednesday 和 rural 预约窗口。',
      },
      {
        label: 'Nevada DMV Office Locations',
        url: 'https://dmv.nv.gov/locat.htm',
        note: 'Metropolitan、rural、CDL office 服务、地址、时段和 appointment 状态。',
      },
      {
        label: 'Nevada DMV Quick Cards and Online Services',
        url: 'https://dmv.nv.gov/onlineservices.htm',
        note: 'MyDMV、DriveNV、first-time Quick Cards、renewal、duplicate、written test 和 shipping status。',
      },
      {
        label: 'Nevada DMV Identification Cards',
        url: 'https://dmv.nv.gov/idcards.htm',
        note: '最低年龄、不得与驾照并持、材料、费用、interim、邮寄和 30 天未收到。',
      },
      {
        label: 'Nevada DMV Frequently Asked Questions',
        url: 'https://dmv.nv.gov/faqs.htm',
        note: '外州证件交回、外国访客驾照、IDP 边界、补证、REAL ID、过期考试和邮寄。',
      },
      {
        label: 'TSA Acceptable Identification',
        url: 'https://www.tsa.gov/travel/security-screening/identification',
  ...
  },
  {
    ...
    reviewedAt: '2026-07-17',
    summary:
      '俄勒冈州先在 Standard credential 与带星 REAL ID 之间选择：Standard noncommercial license、permit 或 ID 要证明身份、出生日期、Oregon residence，并在已获配 SSN 时提供可核验号码，但不要求证明美国合法居留；REAL ID 另要求 lawful status，才可作为州证件用于受 REAL ID 约束的联邦场景。成为 Oregon resident 后，如要驾驶，应在 30 天内取得 Oregon 驾照，并在同一期限内完成车辆 title 和 registration。',
    realIdSummary:
      '第一次申请或从 Standard 升级 Oregon REAL ID 必须到 DMV office，带 identity 与 lawful-status 原件或签发机关认证副本、SSN 或不符合 SSN 的官方证明、两份不同来源的打印版 Oregon residence-address 证明，以及连接每次姓名变化的认证文件。地址证明可以是合格文件的 photocopy 或电子文件 printout，但 identity、lawful-status 与 name-change 文件不能用普通复印件替代；已经持有 Oregon REAL ID 的人符合条件时可在线续期或补证，单独升级并不会延长原卡到期日。',
    licenseSummary:
      '交回有效或过期不超过 1 年的美国州/领地/DC/国务院、Canada、Germany、Japan、South Korea 或 Taiwan 驾照时，多数新居民可能免 knowledge 与 drive tests。中国大陆驾照不在当前免试名单中，不能套用 Taiwan 路径，通常要按首次 Oregon Class C 路径完成 vision、knowledge 和 drive tests；Standard 申请人可用符合期限和翻译要求的 foreign passport 等证明身份，没有获配 SSN 时在申请中作电子声明。',
    appointmentNote:
      '多数 office 业务可通过 DMV2U 预约，也可到开放办公室等 standby service，但各点时段和服务不同，walk-in 不保证当天办完。Class C knowledge test 可在线或在 office 完成，并提供简体中文读题与语音；drive test 只能预约 Oregon DMV 或 DMV-contracted Class C testing business，第三方自行定价。',
    editorNotes: [
      'Oregon REAL ID 是可选的联邦合规 license、permit 或 ID，右上角有星标；未升级的卡标有 Not for REAL ID Act，仍可在有效驾驶权限范围内驾驶，但不能单独用于要求 REAL ID 的联邦用途。',
      '18 岁及以上旅客自 2025 年 5 月 7 日起进入 TSA checkpoint 时，应出示 REAL ID 或 passport 等 TSA 接受的替代证件；有效外国政府护照也在 TSA 当前接受名单中。',
      'Oregon office 签发的 interim paper credential 和 online receipt 可证明适用的驾驶权限，但 TSA 不把 temporary driver license 当作可接受身份证件。',
      '第一次申请 Oregon REAL ID 或把 Standard 卡升级为 REAL ID 不能完全在线完成，必须到 office 出示 federally required documents；DMV 会扫描并保存 REAL ID 文件副本 10 年。',
      'REAL ID identity/lawful-status 常见路径包括未过期 U.S. passport、U.S. birth certificate、Certificate of Naturalization/Citizenship、未过期 Permanent Resident Card、I-766，或符合 visa 与 I-94 条件的未过期 foreign passport。',
      'REAL ID 的 identity、lawful-status 与姓名文件必须用原件或签发机关认证副本，普通 photocopy、电子图像和仅自行扫描的文件不能替代。',
      'REAL ID 申请人可口头提供 SSN，不必仅为此携带实体 Social Security card，但号码和当前法定姓名必须通过 SSA 核验。',
      '没有资格取得 SSN 的 REAL ID 申请人要带 SSA、DHS、其他联邦机关或联邦法院出具的不符合资格证明，并在 office 签 Form 735-7255。',
      'Original REAL ID 要两份显示当前姓名和 Oregon residence address 的打印文件，两份来自不同 agency、business 或 institution，mailing address 可以另列但不能用 P.O. Box 取代 residence address。',
      'REAL ID 地址材料允许使用合格 photocopy 或电子账单 printout；这项规则不同于 identity、lawful-status 和 name-change 原件要求，不要把两类材料混为一谈。',
      '住在同一地址的人也可亲自陪同并出示自己的 residence proof，以 verbal statement 支持申请人的地址，但不要只带一封没有其他核验路径的私人说明。',
      '当前姓名与 identity 文件不同时，要用政府 marriage certificate、domestic-partnership record、divorce decree、adoption decree 或 court order 连起变化，文件仍须是原件或签发机关认证副本。',
      '临时合法居留申请人的 limited-term REAL ID 通常到 authorized stay 截止，最长不超过同类八年期限；如果停留期限不确定，通常自签发日起 1 年。',
      'Oregon 自 2021 年实施 HB 2015 后，Standard noncommercial license、permit 和 ID 不再要求证明 legal presence；这不表示持卡人具有移民身份，也不把 Standard 卡变成 REAL ID。',
      'Standard non-REAL ID 通常用一份 primary identity/date-of-birth 原件或认证副本；当前清单接受含英文或附英文翻译、有效或过期不超过 5 年的 foreign passport。',
      '外国政府驾照在 Standard identity 清单中属于 secondary document；没有 primary document 时通常要从不同机关或法院准备至少两份 secondary documents，且至少一份同时显示姓名和出生日期。',
      'Standard 申请人如已获配 SSN 必须提供可核验号码；从未获配 SSN 的人可在申请流程中作电子声明，不应虚构号码或把 ITIN 当作 SSN。',
      'Non-REAL ID 申请要一份显示姓名和当前 Oregon residence address 的文件，合格 photocopy 或在电子设备上展示的版本通常可接受，但 DMV 保留要求额外证据或拒绝文件的权利。',
      'Oregon 一人只能持有一张有效州级 driver license 或 ID credential；取得 Oregon license、permit 或 ID 会使外州卡失效，申请时还要交回手中的 Oregon、外州或外国 license、permit 或 ID。',
      '当前八年期 Class C 首次 Standard license 为 $64，首次 REAL ID license 为 $94；八年期续期分别为 $54 与 $84，REAL ID 的 $30 附加费在 original、renewal 和 replacement 每次都收取。',
      '当前 replacement license/permit 为 Standard $30、REAL ID $60；Class C knowledge test 每次 $7，DMV Class C drive test 每次 $45，contracted testing business 另按自己的价格收费。',
      '成为 Oregon resident 后 30 天内，如要驾驶应取得 Oregon license，并为车辆办理 Oregon title 与 registration；只处理驾照而漏掉车辆并不满足新居民页面的完整要求。',
      'Oregon residency 判断会看每年连续居住至少 6 个月、子女公校非居民学费、resident tuition、居民税、军籍 home of record 等事实；仅在 Oregon 拥有房产本身不必然构成居民。',
      '交回有效或过期不超过 1 年的美国州、领地、DC、U.S. Department of State、Canada、Germany、Japan、South Korea 或 Taiwan 驾照时，多数申请人可能免 knowledge 和 drive tests，但 DMV 仍可按记录或安全问题要求考试。',
      'Oregon visitor 如保持州外永久住所且未采取建立 Oregon residency 的行动，可凭有效外国政府驾照在 Oregon 驾驶；成为 resident 后则进入 30 天换证规则。',
      '中国大陆不在 Oregon 当前 foreign-license 免试名单；中国大陆驾照不能按 Taiwan 证件处理，也不能单独代替 Oregon 申请所需的 identity、address、SSN 声明和适用考试。',
      '成年人首次申请 Oregon Class C license 时要通过 vision test，并在不符合转入或 driver-education 豁免时完成 knowledge 与 drive tests。',
      'Class C knowledge test 有 35 道选择题，答对 28 题才通过；online 和 office 版本都提供 English、Spanish、Arabic、Chinese (Simplified Mandarin)、Japanese、Korean、Russian 与 Vietnamese。',
      'Online knowledge test 必须使用带 mouse、keyboard 和 webcam 的 desktop 或 laptop，不能用手机、平板或其他 touchscreen device。',
      'Online test 注册要求考生和适用 proctor 都有可核验 SSN；从未获配 SSN 或无法通过供应商身份核验的人应到 DMV office 考试。',
      '18 岁及以上 online tester 不要求 proctor；未满 18 岁要由 21 岁以上、持 SSN 且过去 12 个月监考不超过 5 次的人注册并监督。',
      '同类 online knowledge test 每 24 小时最多两次、线上总计最多四次，之后要到 office；office 资源允许时，失败后可能同日重考，但每次仍收考试费。',
      'Knowledge test 禁止书本、笔记、手机、交谈或他人代考；作弊会中止考试并导致 90 天不得重考，让他人代考还可能触发一年驾驶权限或申请权暂停及刑事后果。',
      '需要 drive test 时必须先通过 knowledge test；考试只能预约 DMV 或 contracted Class C testing business，后者只负责 Class C 并自行确定营业日和费用。',
      'DMV drive test 当天要提供 current liability insurance、车辆 current registration，并使用符合安全要求的 passenger vehicle；DMV test fee 当前每次 $45。',
      '18 岁以上 applicant 若要在 road test 前上路练习才需要 instruction permit；不需要练习的人可在完成前置要求后直接预约 drive test。',
      'Oregon license 可在到期前 12 个月至到期后 2 年内续期；过期超过 2 年要按新申请付 original fee，并重新完成 vision、knowledge 和 drive tests。',
      'Online renewal 通常要求 DMV 照片不足 9 年、保留现有照片/身高/体重、没有要新增或删除的 restriction/endorsement、不是 limited-term，且驾驶权限未 suspended、cancelled 或 revoked。',
      '已有 Oregon REAL ID 的人符合其他条件时可 online renewal；第一次换成 REAL ID 仍要 office，65 岁及以上也不能 online renewal，必须到 office 做 vision test。',
      '遗失、被盗或损坏的 credential 通常可在 DMV2U 补办；第一次升级 REAL ID、姓名变化或需要提交新身份文件时应改走 office。',
      '搬家后必须在 30 天内在线或电话免费更新 DMV 地址；DMV 不再发 address sticker，也不会仅因改址自动寄新卡，需要卡面显示新地址时另付 replacement fee。',
      'Credential 改名应先更新 SSA，再到 office 带 legal-name-change、identity 和 address 文件；REAL ID 姓名必须与 SSA 匹配，driver credential 改名也不会自动修改车辆 title/registration。',
      'Permanent card 会寄到 DMV 记录地址且 USPS 不转寄；官方页面要求最多预留约 20 天，office interim card 或 online receipt 在等待期间不能当作 TSA 接受的身份证件。',
      'Oregon office 页面提供 Mandarin 与 Cantonese 版本的 office-service list，但具体地点的营业日、预约类型和可办业务仍要在出发前逐点确认。',
      'Oregon ID card 没有最低年龄，但不能与另一张有效州级 driver license/ID 并持；当前八年期 original Standard ID 为 $47、REAL ID 为 $77。',
    ],
    documentHighlights: [
      '先选择 Standard 或 REAL ID：Standard 不要求 lawful-status proof，REAL ID 要按联邦清单证明 identity 与 lawful status；两者都不是移民身份决定。',
      'REAL ID identity、lawful-status 与姓名链带原件或签发机关认证副本；可用文件包括适用的 U.S. passport/birth certificate、I-551、I-766 或未过期 foreign passport + visa + I-94。',
      '提供可核验 SSN；REAL ID 未获配 SSN 者另带联邦机关/法院出具的不符合资格证明并签 Form 735-7255，Standard 未获配者作电子声明。',
      'REAL ID 准备两份不同来源、打印版、显示当前姓名和 Oregon residence address 的文件；P.O. Box 只能另作 mailing address，不能取代 residence。',
      '地址证明可以使用合格 photocopy 或电子文件 printout；不要因此把 identity、lawful-status 或 name-change 文件也换成普通复印件。',
      '姓名不同则准备能连接每次变化的 government marriage/domestic-partnership record、divorce/adoption decree 或 court order，并先完成适用的 SSA 更新。',
      'Standard identity 优先准备一份 primary 原件；foreign passport 可有效或过期不超过 5 年，并须含英文或附英文翻译，外国驾照通常只算 secondary evidence。',
      'Standard 另备一份当前 Oregon residence-address proof；已获配 SSN 者提供可核验号码，从未获配者在申请中如实声明。',
      '外州或外国转入带原 credential；免试名单要求证件有效或过期不超过 1 年，中国大陆驾照持有人按非免试路径准备考试。',
      'Road test 带 current vehicle registration、current liability insurance 和合格车辆；需要先练习时再办理 instruction permit。',
      'Office 办理后核对 interim card 的姓名和地址，并确保 DMV 记录地址可收件，因为 permanent card 不会被 USPS 转寄。',
    ],
    commonMistakes: [
      '以为 Standard Oregon license 也必须证明 lawful status，因而在其实符合 Standard identity 和 residency 路径时放弃申请。',
      '把中国大陆驾照当作 Taiwan 驾照，期待直接免 knowledge 与 drive tests。',
      '只带中国驾照作为 identity，忽略外国驾照通常只是 secondary document，不能单独完成 Standard 身份证明。',
      'REAL ID 两份地址材料来自同一家 institution，或只有 P.O. Box 而没有 Oregon residence address。',
      '用手机照片或普通扫描件代替 REAL ID identity、lawful-status 和 name-change 原件/认证副本。',
      '反过来以为 REAL ID 地址证明也必须全部是原件，遗漏官方允许的合格 photocopy 或电子账单 printout。',
      'REAL ID 姓名与 SSA 不一致，或没有 SSN 资格却只做口头声明、未带联邦不符合资格证明。',
      '在卡片有效期中途升级 REAL ID，却以为 $30 附加费会换来新的八年有效期。',
      '临近航班才办 REAL ID，或把 interim paper credential / online receipt 当作 TSA 接受证件。',
      '没有 SSN 仍尝试 online knowledge test，或用手机/平板进入只支持 desktop/laptop 的考试。',
      '已有 current valid license 只为练习而参加正式 online knowledge test，忽略失败可能影响现有 driving privilege。',
      '没有先通过 knowledge test 就预约 drive test，或考试车辆缺 current registration / liability insurance。',
      '把 standby service 当作当天一定受理，没有先检查 office 实时状态、营业日和具体业务。',
      '65 岁以上、limited-term 或要首次升级 REAL ID 时直接假定可以 online renewal。',
      'Oregon license 过期超过 2 年仍按普通 renewal 准备，没有预算 original fee 和三项考试。',
      '免费更新地址后等待 DMV 寄 address sticker 或新卡，忽略新卡要另行申请并付 replacement fee。',
      '搬家超过 30 天仍未通知 DMV，或只改 credential 地址却忘记核对车辆记录。',
      '先到 DMV 改名，没有先处理 SSA，也以为 credential 改名会自动修改 vehicle title/registration。',
      '取得 Oregon credential 后仍同时使用原外州或外国 credential，忽略交回与失效规则。',
      '成为 Oregon resident 后只关注驾照，漏掉同为 30 天的 vehicle title/registration。',
    ],
    recommendedSteps: [
      '先判断自己是 visitor 还是已经建立 Oregon residency；resident 如要驾驶，从成立 residency 起按 30 天安排驾照和车辆业务。',
      '再按用途选择 Standard 或 REAL ID：有有效 passport 等 TSA accepted ID 时，不必把临行前升级 REAL ID 当作唯一方案。',
      '确认交易类型是首次申请、外州/外国转入、续期、replacement、姓名变更、地址变更还是 ID card，不把不同材料清单混用。',
      '使用 DMV2U REAL ID checklist 生成个人材料清单，并在出发前重新打开 Required Identity Documentation 核对当前可接受文件。',
      '走 Standard 路径时，准备 primary identity/date-of-birth 原件、一份 Oregon residence proof、已获配 SSN 或未获配声明；本州 Standard 流程不要求额外提交 lawful-status proof，申请 REAL ID 或 CDL 时则要改用相应清单。',
      '走 REAL ID 路径时，按 identity/lawful status、SSN/不符合资格证明、两份不同来源地址、完整姓名链四组整理文件。',
      '姓名不一致时先更新 SSA，再准备每一步政府签发的认证文件；同时单独安排 vehicle title/registration 的姓名更新。',
      '外州或外国转入先核对旧证签发地和过期时间；中国大陆驾照按无 reciprocity 路径规划 vision、knowledge 与 drive tests。',
      '需要 knowledge test 时可选择简体中文 online 或 office 版本；没有 SSN、设备不合格或供应商无法核验时直接改约 office。',
      '线上考试前准备 desktop/laptop、mouse、keyboard 和 webcam，成人本人独立完成，不让他人提示或代考。',
      '通过 knowledge test 后，如需上路练习先取得 instruction permit；否则按资格直接预约 DMV 或 contracted business 的 drive test。',
      'Road test 前核对车辆 registration、liability insurance、安全状况，并分别确认 DMV $45 test fee 或第三方报价及 license issuance fee。',
      '通过 DMV2U 预约适当业务，出发前查看 office 实时状态与具体服务；没有预约只能按 standby 排队且不保证当天完成。',
      '窗口付款前按 current fee page 区分 original、renewal、replacement、REAL ID surcharge 和每次 test fee；当前八年期 Class C REAL ID license 的 original、renewal、replacement 分别为 $94、$84、$60。',
      '办结后立即核对 interim card；实体卡 20 天仍未到就用 DMV2U 查 card status，不要依赖 USPS forwarding。',
      '续期先检查照片年龄、本人年龄、limited-term、restriction/endorsement 和 suspension 状态，再决定 online 或 office。',
      '搬家后 30 天内免费更新地址；只有确实需要卡面显示新地址时才另付费 replacement。',
      '领取 Oregon credential 时交回其他州或国家 credential，并确认旧证已失效。',
      '新居民同时完成 vehicle title/registration，不要把车辆业务误认为会随驾照自动完成。',
    ],
    actionLinks: [
      {
        label: 'Oregon REAL ID',
        url: 'https://www.oregon.gov/odot/dmv/pages/realidtraveler.aspx',
        description: 'REAL ID 用途、1-2-3 材料提示、费用、办公室和预约入口。',
      },
      {
        label: 'Required Identity Documentation',
        url: 'https://www.oregon.gov/odot/dmv/pages/driverid/idproof.aspx',
        description: 'Standard/REAL ID identity、lawful status、SSN、姓名和地址完整清单。',
      },
      {
        label: 'Get a Driver License - Over 18',
        url: 'https://www.oregon.gov/odot/dmv/pages/driverid/licenseget.aspx',
        description: '首次、转入、考试、续期、补证、online 资格和制证流程。',
      },
      {
        label: 'New to Oregon',
        url: 'https://www.oregon.gov/odot/dmv/pages/new2or/moving.aspx',
        description: '30 天期限、免试签发地、visitor 和车辆 title/registration。',
      },
      {
        label: 'Online Knowledge Testing',
        url: 'https://www.oregon.gov/odot/dmv/pages/online_services/online_knowledge_testing.aspx',
        description: '简体中文、设备、SSN、proctor、次数和违规边界。',
      },
      {
        label: 'Appointments',
        url: 'https://www.oregon.gov/odot/dmv/pages/appointments.aspx',
        description: 'Office 与 drive-test 预约、修改和取消入口。',
      },
      {
        label: 'Driver and ID Fees',
        url: 'https://www.oregon.gov/odot/dmv/pages/fees/driver.aspx',
        description: 'Original、renewal、replacement、limited-term 和 tests 当前费用入口。',
      },
      {
        label: 'Oregon REAL ID FAQs',
        url: 'https://www.oregon.gov/odot/dmv/pages/real_id.aspx',
        description: '首次申请、文件保存、$30 附加费、20 天邮寄和 limited-term。',
      },
      {
        label: 'DMV2U',
        url: 'https://dmv2u.oregon.gov/',
        description: '预约、材料清单、线上考试、续期、补证、改址和 card status。',
      },
    ],
    sources: [
      {
        ...
        url: 'https://www.oregon.gov/odot/dmv/pages/realidtraveler.aspx',
        note: 'Star/Standard 判断、1-2-3 文件、非公民 visa/I-94/I-797A、appointment、三周和 $30。',
      },
      {
        label: 'Oregon DMV REAL ID FAQs',
        url: 'https://www.oregon.gov/odot/dmv/pages/real_id.aspx',
        note: '联邦用途、Standard 标记、原件、SSN、地址、10 年保存、20 天邮寄、temporary ID、费用和 term。',
      },
      {
        label: 'Oregon DMV Required Identity Documentation',
        url: 'https://www.oregon.gov/odot/dmv/pages/driverid/idproof.aspx',
        note: 'Standard primary/secondary identity、REAL ID lawful status、SSN、姓名链、地址原件/printout 区别和不可接受文件。',
      },
      {
        label: 'Oregon DMV Driver Information',
        url: 'https://www.oregon.gov/odot/dmv/pages/online_quick_tips/driver_information.aspx',
        note: 'Standard/REAL ID、HB 2015 后材料、Class C、current fees、tests、limited term、renew/replace、address、mail。',
      },
      {
        label: 'Oregon DMV New to Oregon',
        url: 'https://www.oregon.gov/odot/dmv/pages/new2or/moving.aspx',
        note: '新居民 30 天、免试签发地、motorcycle 差异、visitor 外国驾照和车辆业务。',
      },
      {
        label: 'Oregon DMV Residency and Domicile',
        url: 'https://www.oregon.gov/odot/dmv/pages/driverid/residency.aspx',
        note: '六个月、公校/大学学费、resident tax、military home of record、property 与车辆 eligibility。',
      },
      {
        label: 'Oregon DMV Get a Driver License - Over 18',
        url: 'https://www.oregon.gov/odot/dmv/pages/driverid/licenseget.aspx',
        note: '材料、vision、knowledge/drive tests、免试签发地、surrender、interim、limited term、renew、replace 和 20 天。',
      },
      {
        label: 'Oregon DMV Online Knowledge Testing',
        url: 'https://www.oregon.gov/odot/dmv/pages/online_services/online_knowledge_testing.aspx',
        note: '八种语言、desktop/webcam、SSN、proctor、attempt limits、accommodation、impersonation 和 office fallback。',
      },
      {
        label: 'Oregon Driver Manual - Testing',
        url: 'https://www.oregon.gov/odot/dmv/pages/online_manual/testing.aspx',
        note: 'Vision、35 题/28 正确、office/online 规则、translator、作弊、drive-test 车辆与考试豁免。',
      },
      {
        label: 'Oregon DMV Drive Test Guide',
        url: 'https://www.oregon.gov/odot/dmv/pages/form/what_to_expect_on_your_drive_test.aspx',
        note: 'Registration、liability insurance、identity、$45 test、$64 issuance 和 test-day 要求。',
      },
      {
        label: 'Oregon DMV Contracted Class C Testing Businesses',
        url: 'https://www.oregon.gov/odot/dmv/pages/driverid/classctestingbusiness.aspx',
        note: 'DMV-contracted business、Class C scope、customer number、自定费用与预约。',
      },
      {
        label: 'Oregon DMV Driver and ID Fees',
        url: 'https://www.oregon.gov/odot/dmv/pages/fees/driver.aspx',
        note: 'Original、renewal、replacement、limited-term、test 和 miscellaneous 当前费用分类。',
      },
      {
        label: 'Oregon DMV Change Address',
        url: 'https://www.oregon.gov/odot/dmv/pages/dv/chgaddress.aspx',
        note: '30 天、online/phone、无 sticker、optional replacement、$30/$40 与 vehicle record。',
      },
      {
        label: 'Oregon DMV Change Name',
        url: 'https://www.oregon.gov/odot/dmv/pages/dv/chgname.aspx',
        note: 'SSA 先行、REAL ID match、Standard verification、office 材料和车辆文件不自动更新。',
      },
      {
        label: 'Oregon DMV Appointments',
        url: 'https://www.oregon.gov/odot/dmv/pages/appointments.aspx',
        note: 'In-person appointment、修改取消及 DMV/contracted drive-test 分流。',
      },
      {
        label: 'Oregon DMV Offices',
        url: 'https://www.oregon.gov/odot/dmv/pages/offices/index.aspx',
        note: 'Office status、services、Mandarin/Cantonese list、standby、hours、payment 和 drive-test appointment 边界。',
      },
      {
        label: 'Oregon DMV Identification Cards',
        url: 'https://www.oregon.gov/odot/dmv/pages/driverid/idget.aspx',
        note: 'No minimum age、identity/address/SSN、surrender、interim、mail、renew/replace 和 quit-driving ID。',
      },
      {
        label: 'Oregon HB 2015 Official Measure',
        url: 'https://olis.oregonlegislature.gov/liz/2019R1/Measures/Overview/HB2015',
        note: '取消 noncommercial license、permit 和 ID 的 legal-presence proof requirement，2021-01-01 生效。',
      },
      {
        label: 'TSA Acceptable Identification',
        url: 'https://www.tsa.gov/travel/security-screening/identification',
        note: '18+ checkpoint、REAL ID、foreign passport、temporary license、expired-ID 和 identity-verification 边界。',
      },
      {
        label: 'Oregon DMV2U',
        url: 'https://dmv2u.oregon.gov/',
        note: '预约、线上知识考试、renew/replace、address、checklist 和 card status 入口。',
      },
    ],
    relatedTopicSlugs: [
      'real-id-basics',
  ...
  },
  {
    ...
    reviewedAt: '2026-07-17',
    summary:
      '康涅狄格州先区分三条证件路径：右上角金色星标的 REAL ID 可用于受 REAL ID 约束的联邦身份场景；没有星标并写有 Not for Federal Identification 的普通驾照仍可在有效驾驶权限范围内驾驶；Drive Only 只供符合条件、无法证明美国 lawful presence 的居民取得驾驶权限，不能用于联邦身份识别或投票。成为 Connecticut resident 后，外州驾照和车辆 registration 通常都要在 90 天内转入。',
    realIdSummary:
      '第一次申请 Connecticut REAL ID 必须本人到 DMV site。当前 checklist 要两份不同 identity documents（至少一份 primary）、原件或 certified copies、两份不同来源且通常在 90 天内的 Connecticut residence hard copies、完整姓名链和 DMV-approved English translation；普通 photocopy 不接受。CT DMV 当前 REAL ID 页面又明确说不再要求仅为 REAL ID 提交 SSN 证明文件，但新办 credential 仍要提供并核验 SSN 或适用的 SSA ineligibility 路径，办理前不要只看旧 checklist 的单一句话。',
    licenseSummary:
      '有效或过期不超过两年的美国州/领地驾照，以及 Canada、Germany 或 France 驾照，可按 transfer 路径预约、做 vision test 并支付 $40 application fee 与 $84 license fee。其他国家包括中国大陆不在 transfer 名单中，要先办 adult learner’s permit、完成适用课程和考试；但能出示过去 foreign license 或 driving history 的成年人可能免 90 天持证等待，这不等于免 permit、knowledge 或 road test。',
    appointmentNote:
      'Learner’s permit 的 vision/knowledge tests 和 road test 都要本人预约。2026 年 1 月 1 日起 permit applicant 先完成免费线上 Connecticut Work Zone Safety Course 并打印证书；knowledge test 有 25 题、答对 20 题通过，电脑考试提供 Mandarin Chinese，另可申请 Chinese Simplified hard-copy test。首次 REAL ID、非美国公民首次申请、Drive Only、转入和姓名变更要按指定 DMV office 路径办理。',
    editorNotes: [
      'Connecticut REAL ID 是可选的 verified license 或 ID，右上角是金色星标；没有星标的 credential 标注 Not for Federal Identification，仍可合法驾驶，但不能单独用于要求 REAL ID 的联邦身份用途。',
      '18 岁及以上旅客在 TSA checkpoint 应使用 REAL ID 或 passport、Permanent Resident Card 等 TSA 接受的替代证件；已有可接受证件时，不必把临行前升级 REAL ID 当作唯一方案。',
      '第一次取得金色星标必须本人到 DMV site 或适用 partner office 完成一次性 original-document verification，不能只走普通 online renewal。',
      'REAL ID checklist 要两份不同 identity documents，至少一份来自 primary list；文件必须 valid/unexpired original 或 certified copy，普通 photocopy、notarized photocopy、损坏文件不接受。',
      'Primary 常见 U.S. passport/birth certificate、I-551、I-766 或附适用 immigration supporting documents 的 foreign passport；SS card、CT/外州驾照、Canadian photo license、court order 等属于 secondary examples，不能把两份同类证件当作两份不同 identity。',
      'REAL ID 要两份不同来源的 Connecticut residency hard copies，显示申请人姓名和 Connecticut residence address，通常在 90 天内且为 computer-generated；税单、保险、registration、lease 等少数类别按 checklist 的 12 个月或当前有效期规则。',
      '不要只用 P.O. Box 或 mailing address 代替 Connecticut residence address；官方清单要求两份文件显示实际 Connecticut residence address。',
      '非英文文件必须由 CT DMV-approved translator 翻译，译文要有 translator number、文件类型、翻译日期、打印姓名/签名，并与 original document 一起提交。',
      '姓名与 primary identity 不一致时，要用 certified marriage/civil-union record、dissolution 或 probate court order 串起每次变化；多次改名不能只带最后一份。',
      '先在 SSA 完成姓名更新并至少预留 48 小时，再到 DMV 办 name change 或 REAL ID，避免 SSA 与 credential 记录不一致。',
      'CT DMV 当前 REAL ID landing page 明确写明：按 REAL ID Modernization Act 与州政策，申请 REAL ID 不再要求提交 SSN documentation；但新办 license/permit/ID 的 general credential page 和 checklist 仍要求提供可核验 SSN，未获配 SSN 的非公民按 SSA ineligibility 规则处理。',
      '因此没有实体 Social Security card 不等于一定不能办 REAL ID；仍应准备准确 SSN，并在首次 credential、non-citizen 或 limited-term 场景按当前交易页核对是否要 W-2、1099、SSA letter 或其他文件。',
      '未在美国出生且不能出示有效 U.S. passport 的申请人通常通过 SAVE 核验 lawful status，官方页面提示可能需要 10 个 business days 或更久，并可能要求回到同一 DMV office。',
      '非美国公民首次申请 Connecticut learner’s permit 或 driver license 必须本人到 DMV hub office，不能把 express office 或普通 online service 当作替代。',
      'CT REAL ID 页面上方说其他 visa categories 可能符合 limited-term REAL ID，但同页 FAQ 当前又说 only DACA residents；同一官方页面表述不完全一致，非 DACA 临时身份申请人应让 CT DMV 确认当前 eligibility，本站不代替州方判断。',
      '当前 limited-term FAQ 要 DACA applicant 提交有效 I-766 Category C33、secondary identity、SSN、适用姓名文件和两份 Connecticut residency，并要求 legal-status document 至少剩余 6 个月。',
      'Limited-term REAL ID 与 legal-status document 的到期日对齐并标注 LIMITED-TERM；当前 FAQ 还写明一旦改成 limited-term，之后不能自行恢复 regular full-term credential。',
      'Drive Only 面向 16 岁以上、无法证明 lawful presence 的 undocumented residents，不是 REAL ID、不能用于投票，也不能作为一般联邦身份证件。',
      'Drive Only checklist 要 applicant 在 Connecticut 居住至少 90 天，并用两份来自不同来源、符合年龄窗口的 mail/e-mail 证明；最近 90 天内搬家时要按清单准备新旧地址共四份材料。',
      'Drive Only 身份文件用原件或 certified documents，非英文材料必须由 DMV-approved translator 翻译；预约时还要签署在符合资格后申请合法化身份的 affidavit。',
      'Connecticut 当前不接受外州 Drive Only 或类似 driving-privilege license 直接 transfer，申请人要按新的 Connecticut Drive Only permit、training 与 tests 路径办理。',
      'Drive Only 页面列出的费用为 $40 testing、$19 learner’s permit 和通过 road test 后 $36 license fee；遗失 Drive Only 也必须到 DMV office 补办，不能用普通 online duplicate。',
      'Drive Only 申请会检查 Connecticut driving issues、fraudulent credential 和 Connecticut felony record；官方页面写明 Connecticut felony 或 CT DMV identity fraud 会影响资格，缺材料、考试失败或 background check 失败通常不退款。',
      '成为 Connecticut resident 后通常有 90 天转入外州驾照，并在同一 90 天内转入 out-of-state vehicle registration；两个业务不会因完成其中一个而自动完成另一个。',
      '外州驾照要 current 或过期不超过 2 年，申请人带原证、acceptable identification、R-229，预约 vision test，并支付 $40 application fee 与 $84 license fee。',
      '遗失外州驾照时，可用签发州出具且日期在 60 天内的 certified driving history；原证过期超过 2 年则要取得 Connecticut learner’s permit、完成 8-hour Safe Driving Practices Course 并参加 skills test。',
      'Canada、Germany 与 France 的有效驾照可按 out-of-state transfer 流程办理；中国大陆、Taiwan 及其他未列国家不能套用这一 transfer waiver，要先办 adult learner’s permit。',
      '中国大陆或其他非 reciprocity 国家过去签发的驾照/驾驶记录，可用于申请 adult permit 的 90-day wait exemption，但不把外国证件变成可直接转入的 license，也不自动免 vision、knowledge、training 或 road test。',
      '仍保持外州或外国永久住所的 full-time student、active-duty military/dependent 或 visitor 可能不必转 Connecticut license；visitor/student 可用有效 foreign license 在 Connecticut 驾驶最多一年。',
      'Foreign license 不是 Connecticut identity document；若驾照不是 English 或 Spanish，还必须随车携带由原签发国家取得的 IDP，且 IDP 单独不构成有效驾照。',
      '18 岁以上首次 applicant 先办 adult learner’s permit；一般至少持有 90 天并完成 8-hour Safe Driving Practices Course，曾持 CT、外州、领地或 foreign license 并提供旧证或 driving history 等情况可能免 90 天等待。',
      '2026 年 1 月 1 日起任何 learner’s permit applicant 都要完成免费的 online Connecticut Work Zone Safety Course，用 legal name 建立账户、打印 completion certificate，并在 knowledge test 前交给 DMV。',
      'Class D knowledge test 有 25 题、至少答对 20 题；vision 要达到 20/40 或更好并有 140-degree binocular peripheral field，先通过 vision 才能参加 knowledge test。',
      '电脑 knowledge test 当前提供 Mandarin Chinese；另可提前申请 hard-copy Chinese Simplified test，不要把网站机翻、中文 manual 或口头翻译当作已预约的中文考试。',
      'Knowledge test 失败后要等待 7 天并重新支付 $40；vision 失败可立即重新预约，但同样要重新安排 appointment 和费用。',
      'Permit appointment 当前收 $40 testing fee（覆盖 vision、knowledge 和 road tests）及 $19 Class D learner’s permit fee；通过 road test 后 first regular license 当前另付 $84。',
      'Road test 前要通过 vision/knowledge、完成 Work Zone Safety Course、满足 permit 持有期和 training；到场带 confirmation、R-229、learner’s permit、current registration 与 Connecticut insurance card。',
      'Road-test vehicle 必须 mechanically safe，registration 与 insurance 要当前有效；没有有效驾照的 applicant 不能独自把车开到考场，应由合格 licensed driver 陪同。',
      'Road test 至少提前 3 天 reschedule 才能避免损失 prepaid test fee；到场建议提前 15 分钟，缺 permit、registration、insurance 或车辆不合格会导致改约。',
      'CT Get a Driver’s License 页面当前写首次 noncommercial license 约 6.5 至 8.5 年，DMV fees 页面仍写 $84 对应约 5.5 至 7 年；两个官方页面的首证期限表述不一致，本站只采用一致的 $84 费用，实际 expiration 以交易系统和卡面为准。',
      '普通 license renewal 可在到期前 180 天开始；当前 6-year renewal 为 $72、8-year 为 $96，65 岁以上可选 $24 的 two-year renewal，late fee 为 $25。',
      '第一次 REAL ID、非美国公民、Drive Only、CDL、suspended、过期至少 2 年、部分 endorsement、需要改名或上次未拍新照片的人不能按普通 online renewal 完成。',
      '地址变化计划与 online renewal 一起处理时，CT DMV 建议至少提前一周先在线改址；过期 2 年或更久要回到 new-license 流程。',
      '普通遗失、被盗或损坏 license 的 duplicate fee 为 $30；online duplicate 不适用于姓名变化、非美国公民、Drive Only 或 CDL，这些情形应预约 in-person。',
      '地址变化后 48 小时内要更新 DMV 的 license/ID 与 vehicle registration 记录；online change 免费，当前卡背可贴/打印 address label，需要新卡面地址时再付 $30 duplicate。',
      '姓名变更先更新 SSA 并等最多 48 小时，再带 certified supporting document 到 appointment；material change 会收回旧 credential、发 temporary paper card，并收 $30 change fee。',
      'DMV in-person transaction 通常先发 temporary paper credential，永久 license/ID 在 20 business days 内寄到 application address且不转寄；online renewal/duplicate 页面有时写 30 days，应按对应交易页跟踪。',
      'Temporary paper credential 可用于适用驾驶权限，但 TSA 不把它当作 standalone airport ID；续期时通常要与 expiring/expired card 一起使用并以 TSA 当前规则为准。',
      '没有有效 driver license 的 Connecticut resident 可申请 non-driver ID，new ID 当前 $28、约七年；已有 license 或 permit 时需要按 exchange/surrender 路径处理，不能把两张有效 credential 当作可并持。',
      'DMV hub、branch、express 和 partner office 可办业务不同，测试、non-citizen first-time、Drive Only、CDL 等要按具体页面选择地点；预约页面和 location service list 应在出发前再次核对。',
    ],
    documentHighlights: [
      '先按 REAL ID、ordinary non-verified license/ID 或 Drive Only 选择对应 checklist，不要把三套 identity、SSN/lawful-status 和 residency 规则混在一起。',
      'REAL ID identity 带两份不同证件且至少一份 primary；只带 original 或 issuing-agency certified copy，普通/公证复印件和手机照片不接受。',
      '准备两份不同来源、hard-copy、显示姓名与 Connecticut residence address 的 residency proof，通常在 90 天内；按清单核对税单、保险、registration 或 lease 的例外期限。',
      '提供准确 SSN；当前 REAL ID page 不再要求仅为 REAL ID 出示 SSN documentation，但首次 credential、non-citizen 或 limited-term 交易仍要按适用页面准备 SSN/SSA 文件。',
      '姓名不一致时，带 certified marriage/civil-union certificate、dissolution 或 probate court order 串起完整姓名链，并先完成 SSA update。',
      '非英文 identity、residency 或 foreign-license documents 交由 DMV-approved translator，译文与 original document 一起带到现场。',
      '非美国出生申请人带当前 passport、I-94、I-551、I-766、I-20/DS-2019 等与本人 status 相符的组合，并给 SAVE 留出 10+ business days。',
      'DACA limited-term REAL ID 另核对 I-766 Category C33、至少 6 个月 remaining status、SSN、secondary identity、姓名文件和两份地址证明。',
      'Drive Only 用该项目自己的 original/certified identity 与 90-day Connecticut residency checklist；近期搬家者按官方四份新旧地址 mail 规则准备。',
      '外州转入带 current/不超过两年 expired license、R-229 和 acceptable identity；丢证时准备 60 天内 certified driving history。',
      '中国大陆等 non-reciprocity license holder 另带过去 license 或 country driving history，用于判断 90-day wait exemption，但仍按 adult permit/tests 路径。',
      'Road test 带 permit、appointment confirmation、R-229、current registration、Connecticut insurance card 和 mechanically safe vehicle。',
    ],
    commonMistakes: [
      '把金色星标、ordinary non-verified license 和 Drive Only 当成同一证件，只比较费用而没先判断用途与资格。',
      '第一次申请 REAL ID 却走普通 online renewal，或以为网上续期会自动完成 original-document verification。',
      '只带一份 identity，或两份完全相同类别文件，忽略 checklist 要至少一份 primary 和两份不同 identity。',
      '用普通 photocopy、notarized photocopy、手机照片或损坏文件替代 REAL ID original/certified documents。',
      '把 P.O. Box、mailing address 或不显示本人姓名的账单当作 Connecticut residence address proof。',
      '两份 residency 来自同一 source，或都超出 90 天又不属于官方允许的 12-month/current exceptions。',
      '看到旧 checklist 写 SSN proof 就认定丢失实体 Social Security card 一定不能办，也没有阅读当前 REAL ID Modernization note。',
      '反过来把“不再要求 SSN documentation”理解成 DMV 完全不需要 SSN、SSA ineligibility 或系统核验。',
      '非英文文件自行翻译，或译文没有 DMV-approved translator number、签名、日期和 original document。',
      '姓名在 SSA、primary identity 与 residency 文件上不一致，也没有完整 certified name-change chain。',
      '非美国公民临近旅行才申请，没有给 SAVE 或 limited-term eligibility clarification 留 10+ business days。',
      '把中国大陆或 Taiwan 驾照当作 Canada/Germany/France reciprocity，直接预约 out-of-state transfer。',
      '听说过去 foreign license 可免 90 天，就误以为 adult permit、knowledge、training 和 road test 也都免除。',
      '只转入 driver license，漏掉同为 90 天的 vehicle registration；或外州 license 过期超过两年仍按普通 transfer 准备。',
      'IDP 单独使用、在美国购买 IDP，或 foreign license 非 English/Spanish 时只带驾照不带原签发国 IDP。',
      '2026 permit appointment 没有先完成 Work Zone Safety Course，或忘记打印 completion certificate。',
      '把 Mandarin computer test 与 Chinese Simplified hard-copy test 当作同一预约形式，没有提前向 DMV 确认。',
      'Knowledge test 失败后立即约次日，忽略 7 天等待和重新支付 $40。',
      'Road test 车辆缺 current registration/Connecticut insurance，或 applicant 没有合格 licensed driver 陪同却自行开到考场。',
      '搬家超过 48 小时仍未更新 license/ID 和 vehicle records，或以为免费 online change 会自动寄一张新卡。',
      '地址已经变化但在 online renewal 前不足一周才改址，导致新卡仍按 transaction 中选择的 shipping address 处理。',
      '遗失证件时直接走 online duplicate，忽略 non-citizen、Drive Only、CDL 或 name-change 情形必须 in-person。',
      '把 temporary paper credential 当作 TSA standalone ID，或依赖 USPS forwarding 接收永久卡。',
      'Drive Only applicant 把外州 driving-privilege license 当作可直接 transfer，或没有准备 90-day residency 与 background-check 边界。',
    ],
    recommendedSteps: [
      '先看卡面和目的：金色星标用于 REAL ID federal purpose，普通证件仍可驾驶，Drive Only 只解决符合资格者的 driving privilege。',
      '已有 passport、green card 等 TSA accepted ID 时，先判断是否真的需要在本次 renewal/duplicate 之外额外付 $30 升级。',
      '打开 current Get REAL ID page 与 PDF checklist，特别比较 SSN-documentation note，不把 2023 checklist 单独当作最新政策全文。',
      '按 identity、SSN/SSA、two residency、name chain、lawful status/translation 五组放文件；每份写下 source、日期、是否 original/certified。',
      '非美国公民先确认 full-term、DACA limited-term、ordinary non-verified 或 Drive Only 路径，并让 DMV 解释同页对 non-DACA limited-term 的冲突表述。',
      '需要 SAVE 的人预留至少 10 business days 以上，不在旅行、status document 到期或搬家前最后几天才开始。',
      'Drive Only applicant 使用专用 checklist 核对 90-day Connecticut residency、两份或搬家后的四份 mail、翻译和 affidavit，不套 REAL ID 清单。',
      '新居民先记录 residency established date，在 90 天内分别安排 license transfer 与 vehicle registration transfer。',
      '外州/Canada/Germany/France license holder 检查原证是否 current 或过期不超过两年，并准备 R-229、identity、vision 与 $40+$84。',
      '中国大陆等其他国家 license holder 走 adult learner’s permit；同时带旧证或 driving history，向 DMV 申请适用的 90-day wait exemption。',
      'Permit applicant 先用 legal name 完成免费 Work Zone Safety Course并打印证书，再预约 in-person vision/knowledge test。',
      '需要中文考试时明确提出 Mandarin computer test 或 Chinese Simplified hard-copy test，预约前确认具体 location 和提供方式。',
      'Knowledge appointment 带 original checklist documents、R-229、眼镜/隐形眼镜、Work Zone certificate，并预算 $40 test 与 $19 permit。',
      '取得 permit 后完成 8-hour Safe Driving Practices Course和适用练习期；有过去 license 的人只申请等待期 exemption，不自行跳过其他步骤。',
      'Road test 前逐项检查 permit、confirmation、R-229、registration、insurance、车辆安全和 licensed companion；不能参加时至少提前 3 天 reschedule。',
      '续期先检查 180-day window、online exclusions、6/8-year fee 和 65+ option；首次 REAL ID、non-citizen、Drive Only、expired 2+ years 等改走对应现场路径。',
      '搬家后 48 小时内免费更新 license/ID 与 registration；准备 online renewal 时至少提前一周改址，需要新卡面地址再付 duplicate fee。',
      '改名先在 SSA 办理并等 48 小时，带 certified name-change documents 预约 DMV，另核对 vehicle registration 是否也要同场更新。',
      '补证前判断是否符合 online route；non-citizen、Drive Only、CDL、姓名变化或复杂身份情形直接预约 office。',
      '现场办结后核对 temporary paper credential 与 mailing address，20 business days 未收到就查 card status；不要依赖 mail forwarding。',
    ],
    actionLinks: [
      {
        label: 'Connecticut Get REAL ID',
        url: 'https://portal.ct.gov/dmv/licenses-permits-ids/get-real-id',
        description: 'Gold star、eligibility、SSN modernization note、limited-term、费用与现场入口。',
      },
      {
        label: 'REAL ID Document Checklist PDF',
        url: 'https://portal.ct.gov/dmv/-/media/dmv/dmv-pdfs/selectidaccptdocs3pdf.pdf',
        description: 'Identity、SSN、两份 residency、lawful status、姓名链和翻译原件要求。',
      },
      {
        label: 'Get a Connecticut Driver’s License',
        url: 'https://portal.ct.gov/dmv/licenses-permits-ids/get-a-drivers-license-ct?page=1',
        description: '首次驾照、non-citizen、foreign license/IDP、SSN、地址和考试语言。',
      },
      {
        label: 'Transfer Out-of-State License',
        url: 'https://portal.ct.gov/dmv/licenses-permits-ids/transfer-out-of-state-license',
        description: '90 天、有效期、Canada/Germany/France、费用、丢证和车辆转入。',
      },
      {
        label: 'Adult Learner’s Permit',
        url: 'https://portal.ct.gov/dmv/licenses-permits-ids/get-learners-permit/adult-learners-permit',
        description: '90 天、过去外国驾照 exemption、8-hour course、考试与 permit fee。',
      },
      {
        label: 'Knowledge and Vision Tests',
        url: 'https://portal.ct.gov/dmv/licenses-permits-ids/take-knowledge-vision-test',
        description: '2026 Work Zone course、中文考试、25/20、vision、失败重考和预约。',
      },
      {
        label: 'Take the Road Test',
        url: 'https://portal.ct.gov/dmv/licenses-permits-ids/take-road-test',
        description: '预约、permit、registration、insurance、车辆与 reschedule 要求。',
      },
      {
        label: 'Renew Driver License',
        url: 'https://portal.ct.gov/dmv/licenses-permits-ids/renew-driver-license',
        description: '180-day window、online exclusions、费用、现场/邮寄和地址提醒。',
      },
      {
        label: 'Change License or Registration',
        url: 'https://portal.ct.gov/dmv/licenses-permits-ids/change-driver-license',
        description: '48 小时地址、SSA 48 小时姓名、$30 change 与 registration 更新。',
      },
      {
        label: 'Get a Drive Only License',
        url: 'https://portal.ct.gov/dmv/licenses-permits-ids/get-drive-only-license',
        description: 'Eligibility、permit/tests、费用、out-of-state non-transfer 与 background checks。',
      },
      {
        label: 'Connecticut DMV Fees',
        url: 'https://portal.ct.gov/dmv/resources/dmv-fees',
        description: 'License、permit、duplicate、renewal、Drive Only 和 non-driver ID 当前费用。',
      },
      {
        label: 'Make or Change Appointment',
        url: 'https://portal.ct.gov/dmv/resources/make-change-appointment',
        description: 'Permit、transfer、REAL ID、name change 和其他 office appointment。',
      },
    ],
    sources: [
      {
        ...
        url: 'https://portal.ct.gov/dmv/licenses-permits-ids/get-real-id',
        note: 'Gold star/ordinary/Drive Only、in-person、SSN modernization、eligibility、limited-term、$30 和 20-day mail。',
      },
      {
        label: 'Connecticut REAL ID Document Checklist',
        url: 'https://portal.ct.gov/dmv/-/media/dmv/dmv-pdfs/selectidaccptdocs3pdf.pdf',
        note: 'Two identity documents、original/certified、SSN、two residency、SAVE、姓名链与翻译。',
      },
      {
        label: 'Connecticut DMV Get a Driver’s License',
        url: 'https://portal.ct.gov/dmv/licenses-permits-ids/get-a-drivers-license-ct?page=1',
        note: '首次流程、non-citizen/SAVE、SSN、residency、foreign license/IDP、中文考试、term 与 48-hour address。',
      },
      {
        label: 'Connecticut DMV Transfer Out-of-State License',
        url: 'https://portal.ct.gov/dmv/licenses-permits-ids/transfer-out-of-state-license',
        note: '90 天、current/2-year expiry、vision、$40+$84、lost history、expired 2+、Canada/Germany/France、visitor 和 vehicle。',
      },
      {
        label: 'Connecticut DMV Adult Learner’s Permit',
        url: 'https://portal.ct.gov/dmv/licenses-permits-ids/get-learners-permit/adult-learners-permit',
        note: '18+、90 天、过去 out-of-country license exemption、8-hour course、qualified trainer、$40/$19。',
      },
      {
        label: 'Connecticut DMV Knowledge and Vision Tests',
        url: 'https://portal.ct.gov/dmv/licenses-permits-ids/take-knowledge-vision-test',
        note: '2026 Work Zone course、25/20、20/40 vision、Mandarin/Chinese Simplified、7-day retest、$40 和 appointments。',
      },
      {
        label: 'Connecticut DMV Road Test',
        url: 'https://portal.ct.gov/dmv/licenses-permits-ids/take-road-test',
        note: 'Eligibility、confirmation、R-229、permit、vehicle、registration、insurance、licensed companion 和 3-day reschedule。',
      },
      {
        label: 'Connecticut DMV Fees',
        url: 'https://portal.ct.gov/dmv/resources/dmv-fees',
        note: '$84 new、$40 exam、$19 permit、$30 duplicate/change、$72/$96 renewal、$24 age 65、$36 Drive Only、$28 ID。',
      },
      {
        label: 'Connecticut DMV Renew Driver License',
        url: 'https://portal.ct.gov/dmv/licenses-permits-ids/renew-driver-license',
        note: '180 days、online exclusions、first REAL ID/non-citizen/Drive Only/2+ years、address week、mail、65+ 和 fee。',
      },
      {
        label: 'Connecticut DMV Duplicate Driver License',
        url: 'https://portal.ct.gov/dmv/licenses-permits-ids/request-duplicate-driver-license',
        note: 'Online/in-person/mail eligibility、non-citizen/Drive Only/CDL/name exclusions、$30、temporary card 和 no forwarding。',
      },
      {
        label: 'Connecticut DMV Change License or Registration',
        url: 'https://portal.ct.gov/dmv/licenses-permits-ids/change-driver-license',
        note: '48-hour address、free online、address label、$30 duplicate、SSA/name 48 hours、certified documents 和 registration。',
      },
      {
        label: 'Connecticut DMV Drive Only License',
        url: 'https://portal.ct.gov/dmv/licenses-permits-ids/get-drive-only-license',
        note: '16+ undocumented eligibility、federal/voting boundary、steps、fees、non-transfer、duplicate、felony/fraud checks。',
      },
      {
        label: 'Connecticut Drive Only Document Checklist',
        url: 'https://portal.ct.gov/dmv/-/media/dmv/dmv-pdfs/di4pdf.pdf',
        note: 'Original/certified identity、90-day Connecticut residency、recent move four-mail rule、translation、affidavit 和 felony notice。',
      },
      {
        label: 'Connecticut DMV Renew Drive Only License',
        url: 'https://portal.ct.gov/dmv/licenses-permits-ids/renew-drive-only-license',
        note: 'In-person renewal、two residency sources、translation、name change、three-year renewal 与 tracking。',
      },
      {
        label: 'Connecticut DMV Approved Translators',
        url: 'https://portal.ct.gov/dmv/resources/approved-translators',
        note: 'Non-English document、translator number、date、signature、original-document 和 Chinese provider list。',
      },
      {
        label: 'Connecticut DMV Non-Driver ID',
        url: 'https://portal.ct.gov/dmv/licenses-permits-ids/get-non-driver-id',
        note: 'Eligibility、license surrender/exchange、REAL ID docs、in-person、20 business days 和 $28 seven-year ID。',
      },
      {
        label: 'Connecticut DMV Central Issuance',
        url: 'https://portal.ct.gov/dmv/licenses-permits-ids/get-a-drivers-license-ct/protect-your-identity-central-issuance-ct',
        note: 'Temporary paper credential、20 business days、application address、no forwarding、TSA limitation 和 tracking。',
      },
      {
        label: 'Connecticut DMV Appointments',
        url: 'https://portal.ct.gov/dmv/resources/make-change-appointment',
        note: 'Permit tests、new resident transfer、REAL ID、name change、license/ID transaction appointment。',
      },
      {
        label: 'Connecticut DMV Locations and Hours',
        url: 'https://portal.ct.gov/dmv/resources/locations-office-hours',
        note: 'Hub、branch、express、partner offices、services、appointments 和 location-specific availability。',
      },
      {
        label: 'TSA Acceptable Identification',
        url: 'https://www.tsa.gov/travel/security-screening/identification',
        note: 'Domestic checkpoint accepted IDs 与 temporary driver license limitation。',
      },
    ],
    relatedTopicSlugs: [
      'real-id-basics',
  ...
  },
  {
    ...
    accessStatus: {
      label: '官方页需点验',
      tone: 'watch',
      note: 'Minnesota DVS 官方入口页面可达性会波动，部分链接在特定时间点返回 403/404。用户路径应以联系确认与官方目录为主，不以可达性差异替代业务判断',
      fallbackLabel: 'USA.gov 备用入口',
      fallbackUrl: 'https://www.usa.gov/state-motor-vehicle-services',
    },
    documentHighlights: [
    ...
    actionLinks: [
      ...
      },
      {
        ...
        description: '明尼苏达 DVS 线上服务入口',
      },
      {
        label: 'Minnesota DVS Contact',
        url: 'https://dps.mn.gov/divisions/dvs/contact',
        description: '明尼苏达 DVS 官方联系方式与服务入口',
      },
      {
        label: 'Minnesota DVS Contact Form',
        url: 'https://dps.mn.gov/divisions/dvs/contact/driver-services-online-contact-forms',
      ...
      },
      {
        ...
        description: '明尼苏达 DVS REAL ID 官方材料清单 PDF（原始版本）',
      },
      {
    ...
    sources: [
      ...
      {
        label: 'Minnesota Address Update',
        url: 'https://dps.mn.gov/divisions/dvs/license-and-id/common-transactions-all-dl-and-id-card-types/change-your-address-your-dl-id-card',
      },
      {
        label: 'Minnesota Renew Your DL/ID',
        url: 'https://dps.mn.gov/divisions/dvs/license-and-id/common-transactions-all-dl-and-id-card-types/renew-your-dl-id-card',
      },
      {
      ...
      {
        label: 'Minnesota Statutes 171.01',
        url: 'https://www.revisor.mn.gov/statutes/cite/171.01',
      },
      {
        label: 'TSA Identification Standards',
        url: 'https://www.tsa.gov/travel/security-screening/identification',
      },
    ],
    relatedTopicSlugs: [
  ...
  },
  {
    ...
    summary:
      'Indiana 新办驾照、permit 或 ID 的申请人要提交 identity、lawful status、SSN 和 residency 文件，BMV 会签发 REAL ID。只有已经持有 non-compliant credential 的居民才能继续维持非合规证件。持有效外州驾照的新居民应在搬入后 60 天内换 Indiana 驾照，名下外州车辆的 title 和 registration 也要另行转入。',
    realIdSummary:
      '第一次取得 Indiana REAL ID 必须到 BMV branch。官方清单要求一份 identity、一份 lawful status、一份显示完整 SSN 的证明，以及两份印有姓名和 Indiana residential address 的纸质居住证明。姓名或出生日期与 identity/lawful-status 文件不一致时，要用政府签发文件连接每次变化。',
    licenseSummary:
      '年满 18 岁且持有效外州驾照的新居民到 branch 交回外州 credential，带原驾照、official driving record 或 verification letter 之一，再提交身份材料并通过 vision screening。外州驾照已过期时要考 knowledge，过期超过五年或持有效外州驾照不足一年时还要考 driving skills。持中国大陆等 out-of-country license 的居民通常要通过 vision、knowledge 和 skills exams；Japan 与 Taiwan 的合格驾照可按 reciprocity 免 skills exam，但不免 knowledge 和 vision。',
    appointmentNote:
      'Knowledge exam 不要求预约，电脑考试应至少在关门前一小时到场，纸质考试至少提前 30 分钟。Driving skills exam 必须预约，当前页面要求提前至少 48 小时、最多三周安排。普通 branch 业务可以预约或 walk-in，且不必去居住县的 branch。',
    editorNotes: [
      'Indiana 当前的 New Resident 和 Driver License 页面都说明：年满 18 岁并持有效外州驾照者不要求 knowledge exam；中央制证旧 FAQ 仍有“written test”字样。遇到过期证件、记录不足或系统要求时，以当前交易页和 branch 判断为准。',
      '在线续期不是通用入口。通常要是美国公民、Indiana resident、信息无变化、上次在 branch 续期、证件过期不超过 180 天且不触发考试、限制、停牌或积分条件。',
      '新居民、首次申领或证件已经到期时，branch 通常发 30 天 interim driver credential；永久卡在材料无问题时约 14 天寄到 mailing address，interim 不应当作普通 photo ID 使用。',
      'Temporary 或 permanent lawful status 申请人的材料会经 SAVE 核验，官方说明最长可能约两周；除 replacement 外，每次申请都可能要再次提供 lawful-status 文件。',
    ],
    documentHighlights: [
      ...
      '一份 lawful-status 文件；很多 identity 文件也能满足这一类别，但 non-citizen 要按本人身份准备 I-94、visa、I-20、DS-2019、I-551、I-766 等适用组合。',
      '一份显示姓名和完整九位 SSN 的原件，例如 Social Security card、W-2、SSA-1099、non-SSA-1099 或合格 pay stub。没有资格取得 SSN 时要提供 SSA ineligibility 证明。',
      '两份不同的 printed Indiana residency 文件，必须显示本人姓名和 residential address；P.O. Box 不能代替居住地址。',
      'Utility、credit-card、doctor 或 hospital bill，以及 bank statement/transaction receipt 通常要在申请前 60 天内。Insurance policy 可按清单使用一年内文件，W-2、税单或年度 benefit summary 可使用当前或紧邻前一年度。',
      '当前 legal name 或出生日期与 identity/lawful-status 文件不一致时，带 government-issued adoption、marriage、divorce、court order 或 amended birth certificate；多次改名可能需要多份文件。',
      ...
      'Out-of-country license 必须是英文，或同时带可核验英文翻译或 IDP；外国驾照本身不能作为 Indiana identity proof。',
    ],
    commonMistakes: [
      ...
      '把中国大陆驾照当作 reciprocity transfer。Indiana 当前列出的 reciprocal countries 是 Japan 和 Taiwan，中国大陆申请人通常仍需 skills exam。',
      '打开 myBMV 就认为一定能线上续期或补证，忽略 citizenship、上次续期方式、地址/姓名变化、到期时间、积分和 credential status 限制。',
      '把 residential address 和 mailing address 当成同一项。Residential address 变化要在 30 天内到 branch 用两份证明更新，mailing address 才能单独在线修改。',
    ...
    recommendedSteps: [
      ...
      '新居民确认搬入日期和外州驾照状态。有效外州证通常只需 vision；已过期、过期超过五年或持证不足一年会改变考试要求。',
      '持外国驾照者先看 Out-of-Country Licenses 页面。中国大陆驾照按普通 foreign-license 路径准备，Taiwan 驾照再核对 reciprocity letter 和三年有效/过期窗口。',
      'Renewal 或 replacement 先逐条核对线上资格；姓名、residential address、非公民材料、首次 REAL ID 或系统限制通常要去 branch。',
      '需要 knowledge exam 时按 branch 截止时间 walk in；需要 driving skills exam 时用 myBMV 提前 48 小时至三周预约。',
      '交易完成后保存 interim 和 receipt，在 myBMV 跟踪邮寄。14 天未收到永久卡时按 BMV mail 页面联系并核对 mailing address。',
    ],
    actionLinks: [
      {
      ...
      {
        label: 'Out-of-Country Licenses',
        url: 'https://www.in.gov/bmv/licenses-permits-ids/learners-permits-and-drivers-licenses-overview/out-of-country-licenses',
        description: '外国驾照、翻译、考试和 Japan/Taiwan reciprocity。',
      },
      {
        label: 'Renew an Indiana Credential',
        url: 'https://www.in.gov/bmv/licenses-permits-ids/learners-permits-and-drivers-licenses-overview/drivers-license/renewing-a-drivers-license-learners-permit-or-identification-card/',
        description: '续期窗口、线上资格、到场条件和过期规则。',
      },
      {
        label: 'Replace an Indiana Credential',
        url: 'https://www.in.gov/bmv/licenses-permits-ids/learners-permits-and-drivers-licenses-overview/drivers-license/replacing-a-drivers-license-learners-permit-or-identification-card',
        description: '补证线上资格、邮寄地址和必须到场情形。',
      },
      {
        label: 'Amend Name or Address',
        url: 'https://www.in.gov/bmv/licenses-permits-ids/learners-permits-and-drivers-licenses-overview/drivers-license/amending-your-drivers-license-or-identification-card',
        description: '姓名、residential address 和 mailing address 更新规则。',
      },
      {
        label: 'Branch Visit and Appointments',
        url: 'https://www.in.gov/bmv/branch-locations-and-hours/preparing-for-branch-visits/',
        description: 'Branch 业务、knowledge exam 到场时间和预约入口。',
      },
      {
        label: 'Indiana Driver Manual',
        url: 'https://www.in.gov/bmv/licenses-permits-ids/learners-permits-and-drivers-licenses-overview/learners-permit/drivers-manual/',
        description: '提供简体中文手册和当前考试章节。',
      },
    ],
    sources: [
      {
      ...
      {
        label: 'Indiana BMV Out-of-Country Licenses',
        url: 'https://www.in.gov/bmv/licenses-permits-ids/learners-permits-and-drivers-licenses-overview/out-of-country-licenses',
      },
      {
        label: 'Indiana BMV Driver License',
        url: 'https://www.in.gov/bmv/licenses-permits-ids/learners-permits-and-drivers-licenses-overview/drivers-license/',
      },
      {
        label: 'Indiana BMV Credential Renewal',
        url: 'https://www.in.gov/bmv/licenses-permits-ids/learners-permits-and-drivers-licenses-overview/drivers-license/renewing-a-drivers-license-learners-permit-or-identification-card/',
      },
      {
        label: 'Indiana BMV Credential Replacement',
        url: 'https://www.in.gov/bmv/licenses-permits-ids/learners-permits-and-drivers-licenses-overview/drivers-license/replacing-a-drivers-license-learners-permit-or-identification-card',
      },
      {
        label: 'Indiana BMV Credential Amendments',
        url: 'https://www.in.gov/bmv/licenses-permits-ids/learners-permits-and-drivers-licenses-overview/drivers-license/amending-your-drivers-license-or-identification-card',
      },
      {
        label: 'Indiana BMV Branch Visit and Appointments',
        url: 'https://www.in.gov/bmv/branch-locations-and-hours/preparing-for-branch-visits/',
      },
      {
        label: 'Indiana BMV Credential Mailing',
        url: 'https://www.in.gov/bmv/licenses-permits-ids/learners-permits-and-drivers-licenses-overview/receiving-your-drivers-license-or-id-card-through-the-mail/',
      },
      {
        label: 'Indiana BMV Driver Manual and Languages',
        url: 'https://www.in.gov/bmv/licenses-permits-ids/learners-permits-and-drivers-licenses-overview/learners-permit/drivers-manual/',
      },
      {
        label: 'Indiana BMV SAVE Program',
        url: 'https://www.in.gov/bmv/licenses-permits-ids/real-id-overview/systematic-alien-verification-for-entitlements-save-program/',
      },
      {
        label: 'Indiana BMV Driving Skills Test',
        url: 'https://www.in.gov/bmv/licenses-permits-ids/learners-permits-and-drivers-licenses-overview/drivers-license/driving-skill-examination',
      },
    ],
    relatedTopicSlugs: [
      'real-id-basics',
  ...
  },
  {
    ...
    reviewedAt: '2026-07-19',
    summary:
      '搬到 Tennessee 并持外州驾照的新居民，应在建立州内居住后 30 天内到 full-service Driver Services Center 换证。申请前可以在 e-Services 上传材料预审，官方要求为预审预留最多 5 个工作日；到场时仍必须带原件或签发机构认证副本。',
    realIdSummary:
      'Tennessee REAL ID 是可选证件。第一次申请必须本人到场；已有 Tennessee 驾照或 ID 的人可去 Driver Services Center 或参与办理的 County Clerk，没有 Tennessee credential 的人要去 full-service Driver Services Center。核心组合是一份 U.S. citizenship 或 legal presence、一份显示完整 SSN 的证明或从未获发 SSN 时的宣誓书、两份 Tennessee residency，以及连接到身份文件原始姓名的完整改名链。',
    licenseSummary:
      '新居民申请时要交回外州驾照，或在适用情形提交 driving record；外国驾照可以保留。所有新居民都要做 vision screening，外州驾照过期超过 6 个月或持外国驾照的人还要通过 Tennessee knowledge 和 road skills tests。持联邦授权 temporary legal presence 的申请人应核对 Types of Issued Licenses、Identification License 和现行手册中的 Temporary Driver License / XID 说明，不应套用只面向 Regular Class D 的资格段落。',
    appointmentNote:
      '预约并非每个 Driver Services Center、每种业务都有。当前 locations 页面要求预约者提前 15 分钟到场，迟到可能被取消并改按 walk-in；新居民、首次申领、考试和首次 REAL ID 还要确认地点是否为 full-service center。',
    editorNotes: [
      'Tennessee 两个当前官方入口对 Kentucky 的 MVR 要求显示不一致：New Residents 说明列出 California、Connecticut、Illinois、Nevada 和 West Virginia，MVR Verification 的州别请求链接另含 Kentucky；来自这些州的申请人应在预约前打开 MVR Verification 入口确认；该入口要求记录在申请前 30 天内签发。',
      'Regular Driver License 页把 regular credential 限定给 U.S. citizen 或 lawful permanent resident；Types of Issued Licenses 和现行手册仍列出 Temporary Driver License，Identification License 页也保留 temporary legal presence 文件和 XID 说明；两条路径不是同一种 credential。',
      '21 岁及以上 Tennessee 驾照或 ID 通常自签发日起有效 8 年。线上续期不是保证资格：每隔一个续期周期需要现场拍新照片，Temporary credential 和 CDL 续期也必须到场。',
      '地址变化后 10 天内要通知 Driver Services，通知 USPS 不能代替州记录更新。只更新档案不收费，也不会自动寄新卡；P.O. Box 不能作为 residential address。',
      '当前费用表列 Regular Class D 八年证件总费用为 28 美元，第一张普通 duplicate 为 8 美元、之后通常为 12 美元；County Clerk partner 对其提供的服务另收 4 美元行政费。付款前仍应打开当前费用表确认。',
    ],
    documentHighlights: [
      'U.S. citizenship、permanent resident 或适用 temporary legal presence 文件必须是原件或 certified copy，photocopy 不接受。',
      'Temporary legal presence 常见组合包括有效 foreign passport、visa 和 I-94；F-1/F-2/M-1/M-2 还要带有效 I-20，J-1/J-2 还要带 DS-2019。',
      '一份显示姓名和完整 SSN 的文件，例如 Social Security card、最近 12 个月的 W-2/1099 或 payroll stub；从未获发 SSN 时可用在 examiner 或 notary 面前签署的 sworn affidavit。',
      '两份 Tennessee residency 证明。官方 New Residents 页面把“current”通常定义为最近 4 个月内，另有明确期限的文件按各自期限。',
      'Lease 只能作为一份居住证明，还要附最近 30 天内的 landlord letter，并另外准备第二份合格 residency 文件。',
      'Utility bill、bank statement、employer letter、含住宅地址的 pay stub、合格保险单、Tennessee registration/title 等可按当前清单使用；checks、checkbook、insurance wallet card 不接受。',
      '身份或 legal-presence 文件仍是旧姓名时，要带能从原始姓名连接到当前姓名的全部 marriage certificate、divorce decree 或 court order。',
      '外州换证带现有外州驾照；若来自 MVR Verification 当前列出的州，还要按该页取得申请前 30 天内签发的 Motor Vehicle Record。',
    ],
    commonMistakes: [
      ...
      '持中国等外国驾照就认为可免考；Tennessee 当前页面要求外国新居民通过 vision、knowledge 和 road skills tests。',
      '外州驾照过期超过 6 个月，却没有为 knowledge 和 road skills tests 做准备。',
      '以为首次 REAL ID 可以完全在线完成，或已有外州 REAL ID 就不用重新提交 Tennessee 所需材料。',
      '临近出行才办 REAL ID；现场先发 paper interim，官方预计 hard copy 需要 10 至 20 天，paper credential 可能不被 TSA 接受。',
    ...
    recommendedSteps: [
      ...
      '新居民或首次申请人可先在 e-Services 上传材料预审，至少给系统预留 5 个工作日；预审通过也要把原件或 certified copies 带到 full-service center。',
      '申请 REAL ID 时按四组准备：citizenship/legal presence、完整 SSN 或适用 affidavit、两份 residency、完整姓名变更链。',
      '外州新居民确认驾照到期状态和 MVR 要求。所有外州新居民准备 vision screening，驾照过期超过 6 个月再准备 knowledge 与 road tests。',
      '外国驾照持有人按 foreign new resident 路径准备三项考试；temporary legal presence 申请人核对 Types of Issued Licenses、Identification License 和现行手册中的 XD/XID 材料。',
      '续期、补证、改名和改址分别打开对应页面。没有 DD number 不能在线补证，改名必须现场，地址变化要在 10 天内通知。',
      '在 locations 页面按服务筛选 full-service center，再查看是否有对应 appointment；预约者提前 15 分钟到场。',
      '交易完成后保存 paper interim 和回执。需要用 REAL ID 出行时，为 10 至 20 天的实体卡邮寄时间留余量。',
    ],
    actionLinks: [
      {
        label: 'Tennessee REAL ID',
        url: 'https://www.tn.gov/safety/driver-services/helpful-information/real-id.html',
        description: 'REAL ID 用途、到场地点、材料、费用和邮寄说明。',
      },
      {
        label: 'Tennessee New Residents',
        url: 'https://www.tn.gov/safety/driver-services/classd/dlnew.html',
        description: '30 天换证期限、材料、MVR 和考试条件。',
      },
      {
        label: 'Adult First-Time Drivers',
        url: 'https://www.tn.gov/safety/driver-services/classd/new-drivers.html',
        description: '18 岁以上首次申领、预审、材料与考试步骤。',
      },
      {
        label: 'Temporary Legal Presence / ID',
        url: 'https://www.tn.gov/safety/driver-services/idonly.html',
        description: 'Temporary legal presence 文件、XID 说明和现场入口；驾驶类 XD 另对照官方手册。',
      },
      {
        label: 'Renewing a License or ID',
        url: 'https://www.tn.gov/safety/driver-services/helpful-information/dlrenew.html',
        description: '八年有效期、线上资格与必须到场的续期情形。',
      },
      {
        label: 'Replace a Lost License',
        url: 'https://www.tn.gov/safety/driver-services/helpful-information/dlduplicate.html',
        description: 'DD number、线上补证限制和 duplicate 费用。',
      },
      {
        label: 'Address Change',
        url: 'https://www.tn.gov/safety/driver-services/helpful-information/address-change.html',
        description: '10 天通知期限、免费更新记录和新卡选择。',
      },
      {
        label: 'Driver Services Centers',
        url: 'https://www.tn.gov/safety/driver-services/locations.html',
        description: '按服务查 full-service center、预约和到场规则。',
      },
      {
        label: 'Motor Vehicle Record Verification',
        url: 'https://www.tn.gov/safety/driver-services/helpful-information/mvrverification.html',
        description: '非 S2S 州转入时的 MVR 获取入口和 30 天签发窗口。',
      },
    ],
    sources: [
      {
      ...
      {
        label: 'Tennessee Driver Services New Resident Driver License Requirements',
        url: 'https://www.tn.gov/safety/driver-services/classd/dlnew.html',
      },
      {
        label: 'Tennessee Driver Services Adult First-Time Driver License Requirements',
        url: 'https://www.tn.gov/safety/driver-services/classd/new-drivers.html',
      },
      {
        label: 'Tennessee Driver Services Types of Issued Licenses',
        url: 'https://www.tn.gov/safety/driver-services/helpful-information/dlinfo.html',
      },
      {
        label: 'Tennessee Driver Services Identification License and Temporary Legal Presence',
        url: 'https://www.tn.gov/safety/driver-services/idonly.html',
      },
      {
        label: 'Tennessee Driver Services Regular Driver License',
        url: 'https://www.tn.gov/safety/driver-services/classd.html',
      },
      {
        label: 'Tennessee Driver Services Credential Renewal',
        url: 'https://www.tn.gov/safety/driver-services/helpful-information/dlrenew.html',
      },
      {
        label: 'Tennessee Driver Services Credential Replacement',
        url: 'https://www.tn.gov/safety/driver-services/helpful-information/dlduplicate.html',
      },
      {
        label: 'Tennessee Driver Services Address Change',
        url: 'https://www.tn.gov/safety/driver-services/helpful-information/address-change.html',
      },
      {
        label: 'Tennessee Driver Services Proof of Residency Requirements',
        url: 'https://www.tn.gov/safety/driver-services/helpful-information/tnresidency.html',
      },
      {
        label: 'Tennessee Driver Services Name Change',
        url: 'https://www.tn.gov/safety/driver-services/helpful-information/dlnamechange.html',
      },
      {
        label: 'Tennessee Driver Services Fees',
        url: 'https://www.tn.gov/safety/driver-services/helpful-information/fees.html',
      },
      {
        label: 'Tennessee Driver Services Motor Vehicle Record Verification',
        url: 'https://www.tn.gov/safety/driver-services/helpful-information/mvrverification.html',
      },
      {
      ...
      {
        label: 'Tennessee Comprehensive Driver License Manual',
        url: 'https://www.tn.gov/content/dam/tn/safety/documents/DL_Manual.pdf',
      },
    ],
    relatedTopicSlugs: [
      'real-id-basics',
  ...
  },
  {
    ...
    summary:
      'Wisconsin 驾照和 ID 由 WisDOT Division of Motor Vehicles 管理。建立 Wisconsin residency 后，普通驾照应在 60 天内、CDL 应在 30 天内办理；首次 Wisconsin 驾照或 ID 必须本人到 DMV service center。先区分美国外州转入、外国驾照、首次驾驶人、续期、补证和 REAL ID。',
    realIdSummary:
      'Wisconsin 同时签发带星标的 REAL ID-compliant card 和标有 “NOT FOR FEDERAL PURPOSES” 的 non-compliant card；REAL ID 是可选项，不影响普通驾照的州内驾驶效力。首次 REAL ID 要本人到场，按 name and date of birth、legal presence、identity、SSN、姓名变化和两份 Wisconsin 地址证明逐类交原件或 certified copy。',
    licenseSummary:
      '有效或过期不满 8 年的美国外州驾照通常可走转入路线并接受视力检查；超过 8 年则要重新参加 knowledge、highway signs 和 road test。外国驾照另走外国驾驶人与 reciprocity 路径：当前免 knowledge / skills tests 的互惠国家仅列 France、Germany、South Korea 和 Taiwan，中国大陆驾照不在名单内。',
    appointmentNote:
      '首次 Wisconsin credential、外州转入、首次 REAL ID 和需要文件核验的业务要到 service center；appointment 推荐但并非普遍强制。Class D knowledge / signs tests 按 walk-in 办理且不接受预约，road test 则要单独预约；出发前要核对具体地点是否提供考试和当天营业时间。',
    editorNotes: [
      'Wisconsin 同一时间只能持有 driver license 或 ID card，不能两者都保留；把驾照换成 ID card 会放弃驾驶资格。',
      '建立 Wisconsin residency 后，regular license 应在 60 天内申请，CDL 应在 30 天内申请；principal residence、在州内报 income tax 或登记投票都可能构成 residency。',
      '外州 REAL ID 不会自动转换成 Wisconsin REAL ID；转入时仍要重新提交 Wisconsin 要求的全部 REAL ID 材料。',
      '有效或过期不满 8 年的美国外州驾照可申请 Wisconsin 驾照；超过 8 年要重考 knowledge、highway signs 和 road test。',
      '外州驾照过期超过 6 个月、申请人未满 21 岁，或持证驾驶经验不足 3 年时，可能签发 probationary license。',
      '遗失外州驾照时要提供其他 identity 文件和原州驾照号码；手机照片或普通 photocopy 不能代替外州原卡。',
      '外州驾照会被加盖或打印 “VOID” 后退还；申请人还必须在所有 50 州保持有效驾驶资格，存在 suspension 时不能转入。',
      ...
      'WisDOT 当前 convention list 列出 Taiwan，但没有列出 mainland China；中国大陆驾照持有人不应预设享有最长一年访客驾驶规则，应在驾驶前向 DMV 确认。',
      '外国驾照 knowledge / skills test 互惠当前只适用于 France、Germany、South Korea 和 Taiwan，并要求至少 21 岁、至少 3 年驾驶经验且外国驾照未过期。',
      'Taiwan reciprocity 路线要求有效台湾驾照，并提交 IDP 或由 Taipei Economic and Cultural Office in Chicago 出具的 notarized translation；仍要做 vision exam、提交 MV3001、材料和费用。',
      ...
      '15 至 17 岁青少年的 online Class D test 当前仅有 English 和 Spanish，每次 $10；Chinese 选项在现场测试，不能从线上入口取得。',
      '现场 Class D knowledge / signs tests 当前不收费、无需预约，未通过后最早次日重考；同一种考试一年最多五次，之后需要 DMV 特别许可。',
      'road test 要自备符合申请 class、状态安全且 registration 有效的车辆；interpreter 不能随车，但 examiner 会尽合理努力建立基本沟通。',
      'Class D skills exam 当前每次预约收费 $15，未提前至少 24 小时取消也收费；未通过后的等待期由系统按结果计算，通常为 1 至 14 天。',
      '当前费用表列出 regular Class D original 和 8-year renewal 均为 $42.50、probationary original $28、duplicate $14，逾期续期另加 $5 late fee。',
      'regular license 可提前一年续期，probationary license 可提前 90 天；renewal reminder 通常在到期年份生日之前 45 至 60 天发到档案地址。',
      'online renewal 主要面向 18 至 64 岁美国公民、Class D / DM、证件未过期或过期不满一年且符合其他条件的人；首次 REAL ID、姓名或照片等资料变化、非公民和 CDL 不能按普通线上路线完成。',
      '第一次在 renewal 同时升级 REAL ID 不另收升级费；续期后再升级则按 duplicate 收费，而且首次 REAL ID 必须本人到 service center。',
      '非美国公民每次申请 driver license、instruction permit 或 ID card 都要出示 legal presence 文件；lawful temporary visitor 的卡会标 “limited term”，到期日随合法居留文件且最长不超过 8 年周期。',
      '有 SSN 的申请人必须提供号码，DMV 会通过 SSOLV 核对姓名、出生日期和号码；无法在线核验或没有可核验 SSN 记录时应按现场文件核验路线办理。',
      '搬家后应在 10 天内更新 DMV 的 residence / mailing address；只更新记录不会寄新卡，需要新地址印在卡上时另办 replacement 并付费。',
      '所有实体驾照和 ID 集中制卡邮寄；现场通常给 45 天 photo receipt，可在实体卡到达前作为驾照或 ID，正常约 10 个工作日收到且 USPS 不会转寄到申请表以外地址。',
      'REAL ID 不是国内航班唯一身份证件；有效 passport 等 TSA 接受证件可以替代，而国际旅行仍需要 passport。',
    ],
    documentHighlights: [
      'REAL ID 按类别准备一份 name and date of birth、一份 legal presence、一份 identity、SSN，以及两份 Wisconsin residency 证明；同一文件只有在规则允许时才能覆盖多个类别。',
      'REAL ID 材料须为 original 或 issuing agency certified copy；普通 photocopy、fax 和 scan 不接受，出生登记摘要和医院出生证明也不属于合格 certified birth certificate。',
      'non-compliant card 可接受的 name / date-of-birth 文件范围更宽，但仍要求 lawful presence、identity、Wisconsin residency 和适用的 SSN 核验。',
      '所有地址文件必须显示本人姓名和当前 Wisconsin residence street address；P.O. Box 或 commercial receiving agency 不能代替居住地址。',
      'utility bill、paystub、bank statement 等电子文件的 printout 可接受；lease / rental agreement 在当前租期内可以使用，residency 清单对该类文件允许 photocopy。',
      ...
      '有 SSN 时在 MV3001 提供号码；姓名、出生日期和 SSN 应与 SSA 记录一致，SSOLV 失败时 DMV 可能要求实体证明和额外核验。',
      '美国外州转入带原驾照；原卡遗失时带其他 identity 文件并提供完整的原州驾照号码。',
      '外国驾照路线带本国有效驾照和 IDP 或合格英文翻译；South Korea 与 Taiwan 互惠对翻译文件另有领事机构要求。',
      '参加 road test 要自备适合申请 class 的车辆，确保车辆安全、控制装置可用并带有效 registration。',
      '现场续期带当前驾照或其他 identity 文件；非公民另带 legal status，姓名变化另带 certified name-change record。',
      '线上申请前先更新 DMV 地址，并确认邮箱、打印设备和付款方式；线上使用的 live photo 只做身份核验，不会替换档案中的证件照片。',
    ],
    commonMistakes: [
      ...
      '把 IDP 当成独立驾照，或在本国驾照无效时仍依赖 IDP 驾驶。',
    ...
    recommendedSteps: [
      ...
      '建立 residency 后按 regular 60 天或 CDL 30 天安排办理；第一次 Wisconsin credential 预留本人到场时间。',
      '先比较 REAL ID 与 passport 等 TSA 替代证件；只需驾驶时可选择 non-compliant card，但仍要满足 Wisconsin 的身份和合法居留要求。',
      ...
      '美国外州驾照持有人确认过期时间；超过 8 年按全套知识、路标和路考准备，遗失原卡则先找齐号码和替代 identity。',
      ...
      '需要中文 Class D 笔试时选择现场 knowledge / signs test，并向具体 center 确认 Chinese 设备或书面版本；不使用仅 English / Spanish 的 teen online test。',
      'knowledge test 按 walk-in 安排并预留至少约 45 分钟；road test 另行预约，自备安全且 registration 有效的车辆。',
      '续期先检查 online eligibility；首次 REAL ID、非公民、姓名 / 照片 / restriction 变化和 CDL 直接按现场路线准备。',
      '搬家后 10 天内在线或邮寄更新 DMV address；需要新地址印卡时再申请 replacement。',
    ...
    actionLinks: [
      {
        ...
        description: '比较 REAL ID / non-compliant card，并核对首次申请材料和费用规则。',
      },
      {
        label: 'Driver License Documentation',
        url: 'https://wisconsindot.gov/Pages/dmv/license-drvs/how-to-apply/documentation.aspx',
        description: '进入 name、identity、legal presence、residency、SSN 和 name-change 清单。',
      },
      {
        label: 'Out-of-State License Transfer',
        url: 'https://wisconsindot.gov/Pages/dmv/license-drvs/how-to-apply/ooslicense.aspx',
        description: '核对 60 天期限、材料、8 年考试门槛和 probationary license。',
      },
      {
        label: 'Foreign Driver License',
        url: 'https://wisconsindot.gov/Pages/dmv/license-drvs/how-to-apply/foreign.aspx',
        description: '查看 visitor、student、IDP / translation 和 convention list。',
      },
      {
        label: 'Foreign License Reciprocity',
        url: 'https://wisconsindot.gov/Pages/dmv/license-drvs/how-to-apply/dl-reciprocity.aspx',
        description: '核对 France、Germany、South Korea 与 Taiwan 的免试条件和专属材料。',
      },
      {
        label: 'Knowledge Tests and Languages',
        url: 'https://wisconsindot.gov/Pages/dmv/teen-driver/teen-hw-aply/knowledge.aspx',
        description: '查看 Chinese、walk-in、重考次数和 teen online test 边界。',
      },
      {
        label: 'Driver License Renewal',
        url: 'https://wisconsindot.gov/Pages/dmv/license-drvs/rnew-and-chge/license-renewal.aspx',
        description: '检查 online / in-person eligibility、REAL ID upgrade、期限和邮寄。',
      },
      {
        label: 'Change DMV Address',
        url: 'https://wisconsindot.gov/Pages/online-srvcs/change-addy/default.aspx',
        description: '在搬家后 10 天内更新记录，并判断是否另办 replacement。',
      },
      {
        label: 'DMV Fees',
        url: 'https://wisconsindot.gov/Pages/dmv/vehicles/title-plates/dmv-fees.aspx',
        description: '查看 Class D、skills exam、renewal、duplicate 和 late fee。',
      },
      {
        label: 'DMV Service Centers',
        url: 'https://wisconsindot.gov/Pages/online-srvcs/find-dmv/default.aspx',
        description: '查地点、营业时间、wait times 和具体服务。',
      },
      {
        label: 'TSA Acceptable Identification',
        url: 'https://www.tsa.gov/travel/security-screening/identification',
        description: '核对国内航班可用的 REAL ID、passport 和其他身份证件。',
      },
    ],
    sources: [
      {
        ...
        url: 'https://wisconsindot.gov/Pages/dmv/license-drvs/how-to-apply/realid.aspx',
        note: 'optional status、卡面标记、联邦用途、材料、首次到场和 renewal / duplicate 费用。',
      },
      {
        label: 'Wisconsin DMV Driver License Documentation',
        url: 'https://wisconsindot.gov/Pages/dmv/license-drvs/how-to-apply/documentation.aspx',
        note: '驾照和 ID 的各类材料总入口与 BDS316。',
      },
      {
        label: 'Wisconsin Acceptable Documents BDS316',
        url: 'https://wisconsindot.gov/Documents/dmv/shared/bds316-english.pdf',
        note: 'REAL ID / non-compliant 的 legal presence、name / birth、identity 和 residency 清单。',
      },
      {
        label: 'Proof of Name and Date of Birth',
        url: 'https://wisconsindot.gov/Pages/dmv/license-drvs/how-to-apply/proof-name-dob.aspx',
        note: 'REAL ID 与 non-compliant 的 name / DOB 原件清单和差异。',
      },
      {
        label: 'Proof of Identity',
        url: 'https://wisconsindot.gov/Pages/dmv/license-drvs/how-to-apply/identity.aspx',
        note: 'REAL ID 与 non-compliant 共用的 identity 文件及额外审核。',
      },
      {
        label: 'Proof of Citizenship or Legal Presence',
        url: 'https://wisconsindot.gov/Pages/dmv/license-drvs/how-to-apply/citizen-leg-pres.aspx',
        note: '公民、permanent / conditional resident、temporary visitor、limited term 与每次出示规则。',
      },
      {
        label: 'Wisconsin DMV Proof of Residency',
        url: 'https://wisconsindot.gov/Pages/dmv/license-drvs/how-to-apply/residency.aspx',
        note: '两份当前街道地址、P.O. Box 限制、电子 printout、lease 和特殊住址证明。',
      },
      {
        label: 'Provide Social Security Number',
        url: 'https://wisconsindot.gov/Pages/dmv/license-drvs/how-to-apply/socialsecuritynumber.aspx',
        note: 'SSN 提供、SSOLV 电子验证和失败后的文件核验。',
      },
      {
        label: 'Social Security Online Verification',
        url: 'https://wisconsindot.gov/Pages/dmv/license-drvs/how-to-apply/ssnverification.aspx',
        note: '姓名、出生日期和 SSN 与 SSA 的匹配流程。',
      },
      {
        label: 'How to Get a Wisconsin Driver License',
        url: 'https://wisconsindot.gov/Pages/dmv/license-drvs/how-to-apply/get-lic.aspx',
        note: 'license / ID 二选一、resident 定义和 60 / 30 天期限。',
      },
      {
        label: 'Wisconsin DMV Apply for a Driver License',
        url: 'https://wisconsindot.gov/Pages/dmv/license-drvs/how-to-apply/ooslicense.aspx',
        note: '美国外州转入、本人到场、材料、8 年考试、probationary、receipt 和 10 天寄卡。',
      },
      {
        label: 'Wisconsin DMV New Residents',
        url: 'https://wisconsindot.gov/Pages/dmv/vehicles/title-plates/new-res-default.aspx',
        note: '新居民驾照 / ID、REAL ID 重交材料、appointment、外州卡和状态要求。',
      },
      {
        label: 'Driving with a Foreign Driver License',
        url: 'https://wisconsindot.gov/Pages/dmv/license-drvs/how-to-apply/foreign.aspx',
        note: 'tourist / student、convention list、本国驾照、IDP / English translation 与互惠入口。',
      },
      {
        label: 'Foreign Driver License Reciprocity',
        url: 'https://wisconsindot.gov/Pages/dmv/license-drvs/how-to-apply/dl-reciprocity.aspx',
        note: 'France、Germany、South Korea、Taiwan 的年龄、经验、有效驾照、材料、翻译和免试条件。',
      },
      {
        label: 'Wisconsin Knowledge Tests',
        url: 'https://wisconsindot.gov/Pages/dmv/teen-driver/teen-hw-aply/knowledge.aspx',
        note: '现场 walk-in、Chinese、audio、约 45 分钟、重考次数和 teen online test。',
      },
      {
        label: 'Wisconsin Road Test General Information',
        url: 'https://wisconsindot.gov/Pages/dmv/license-drvs/how-to-apply/roadtestgeneral.aspx',
        note: '路考适用情形、车辆、registration、沟通、费用和重考等待。',
      },
      {
        label: 'Wisconsin Motorists Handbook',
        url: 'https://wisconsindot.gov/Documents/dmv/shared/bds126-motorists-handbook.pdf',
        note: 'Class D progression、材料、考试和驾驶规则。',
      },
      {
        label: 'Wisconsin Driver License Renewal',
        url: 'https://wisconsindot.gov/Pages/dmv/license-drvs/rnew-and-chge/license-renewal.aspx',
        note: 'online eligibility、in-person documents、REAL ID upgrade、45 天 receipt 和 10 天邮寄。',
      },
      {
        label: 'Wisconsin Duplicate License or ID',
        url: 'https://wisconsindot.gov/Pages/dmv/license-drvs/lst-or-stoln/duplicate-id.aspx',
        note: 'online / in-person replacement、资料变化、receipt、邮寄和费用。',
      },
      {
        label: 'Wisconsin DMV Address Change',
        url: 'https://wisconsindot.gov/Pages/online-srvcs/change-addy/default.aspx',
        note: '10 天、online / mail、记录更新不发新卡、CDL 和 replacement。',
      },
      {
        label: 'Wisconsin DMV Name Change',
        url: 'https://wisconsindot.gov/Pages/dmv/license-drvs/rnew-and-chge/name-change.aspx',
        note: '先改 SSA、等待 48 小时、现场 replacement、材料和交回当前卡。',
      },
      {
        label: 'Wisconsin DMV Fee Schedule',
        url: 'https://wisconsindot.gov/Pages/dmv/vehicles/title-plates/dmv-fees.aspx',
        note: 'Class D permit、original、renewal、duplicate、skills exam、late fee 和 ID fee。',
      },
      {
        label: 'Wisconsin Identification Card',
        url: 'https://wisconsindot.gov/Pages/dmv/license-drvs/how-to-apply/id-card.aspx',
        note: 'ID 不可驾驶、license / ID 二选一、首次现场、线上限制和 voting ID。',
      },
      {
        label: 'Where Is My Driver License or ID',
        url: 'https://wisconsindot.gov/Pages/online-srvcs/other-servs/where-is-dl-id.aspx',
        note: '7 至 10 天、未收到卡、地址、退件和 print-status 路径。',
      },
      {
        label: 'Wisconsin DMV Online Services',
        url: 'https://wisconsindot.gov/Pages/online-srvcs/external/dmv.aspx',
        note: '驾照、ID、考试、预约、地点、改址、费用和状态总入口。',
      },
      {
        label: 'Wisconsin DMV Service Centers',
        url: 'https://wisconsindot.gov/Pages/online-srvcs/find-dmv/default.aspx',
        note: '地点、营业时间、wait times 和服务差异。',
      },
      {
        label: 'Wisconsin Driver License Application MV3001',
        url: 'https://wisconsindot.gov/Documents/formdocs/mv3001.pdf',
        note: '现行申请表、SSN disclosure、product / transaction type 与 applicant declarations。',
      },
      {
        label: 'TSA Acceptable Identification',
        url: 'https://www.tsa.gov/travel/security-screening/identification',
        note: '国内航班接受的 REAL ID 与 passport 等替代身份证件。',
      },
    ],
    relatedTopicSlugs: [
      'real-id-basics',
  ...
  },
  {
    ...
    reviewedAt: '2026-07-21',
    summary:
      'Utah Driver License Division 按移民身份签发三类驾驶证件：美国公民、美国国民或永久居民走 Regular；有合法居留文件的非公民走 Limited-Term；无法取得 REAL ID 的部分 parolee 或 undocumented immigrant 可申请 Driving Privilege Card。先选对证件类型，再判断是首次申请、美国外州转入、外国驾照、续期或补证。',
    realIdSummary:
      'Utah 的 Regular 和符合条件的 Limited-Term credential 按 REAL ID 文件路径核验；申请人通常要提交身份与出生日期、SSN、合法身份和两份 90 天内的 Utah 住址证明。Driving Privilege Card 不是 Utah 政府身份证件，也不能代替 REAL ID 登机。',
    licenseSummary:
      '持有效美国外州或外国驾照申请 Utah 驾照时，通常参加 25 题 open-book knowledge test；从未持证者参加 50 题 closed-book test，并完成 Traffic Safety and Trends exam 与驾驶技能考试。DLD 可接受有效外国驾照作为既往驾驶资格证明，但仍可能要求路考，不应理解为中国驾照可以直接免试换证。',
    appointmentNote:
      '首次申请、外州或外国驾照转入和 DPC 首次申请都走现场路线；先在 Driver Licensing Services 选择准确业务，再从对应服务页预约并核对办理地点。Limited-Term 申请人要先在预审 portal 上传移民文件并等待 DLD 通知，再预约到场。',
    editorNotes: [
      'Regular Class D 面向美国公民、美国国民和 lawful permanent resident；成年人的证件通常有效 8 年，未成年人通常为 5 年。',
      'Limited-Term Class D 面向有 lawful presence 的非公民；到期日取移民文件到期日或 5 年中较早者，文件没有到期日时通常只签发 1 年。',
      'Driving Privilege Card 是 Class D 驾驶用途证件，不是 Utah 政府身份证件，也不能用于 CDL、motorcycle endorsement 或申请 Utah ID card；它通常在签发后的第一个生日到期。',
      '没有 SSN 的 DPC 申请人要提供 ITIN 或相应 IRS 文件；首次 DPC 还要提交获准机构制作并传送的 fingerprint card 和照片。',
      'Utah 居民通常包括把 Utah 作为住所、一个日历年居住六个月以上、在州内就业或取得居民待遇等情形；个案仍应以 DLD 的 residency 定义为准。',
      '持有效美国外州或外国驾照的访客通常可在 Utah 驾驶不超过六个月，但外州 learner permit 不能在 Utah 使用；成为居民后应按本州申请路径办理。',
      '首次申领且从未持证者参加 50 题 closed-book test；持有效美国外州或外国驾照者通常参加 25 题 open-book test。',
      'DLD 可把有效外国驾照当作既往驾驶资格证明，但申请人仍要参加对应笔试，且可能被要求路考；中国驾照不存在页面承诺的直接换证或全面免试。',
      'Regular 和 Limited-Term 笔试在可用时可选择 Mandarin Chinese 文字与音频；若所需语言不可用，可使用 DLD 批准的口译员。',
      'DPC 的首次申请和续期笔试只能使用英语，翻译材料也不允许带入。',
      '首次驾驶人除 50 题笔试外，还要完成 Traffic Safety and Trends exam 并通过 skills test；DLD 路考要自备已注册、符合法律和安全要求且安全带正常的车辆。',
      '同一天最多参加两次 knowledge test；累计三次未通过后要重新付费。skills test 也应在申请后六个月内完成，三次失败后要再付费。',
      '普通驾照可在到期前六个月续期；online renewal 只向符合资格且收到 PIN 的申请人开放，上次已在线续期、证件过期超过一年、存在驾驶记录或医疗限制等情况要现场办理。',
      'DPC 可以提前六个月续期，但不能在线续期；DPC 过期超过六个月、存在 suspension 或多于一次 citation 时可能要重考 25 题英语笔试。',
      'Utah 地址变化后应在 10 天内在线更新 DLD 记录；USPS 地址变更不会同步到 DLD，想把新地址印在卡上还要办理 renewal 或 replacement。',
      '原件丢失、损坏或资料变化且距离到期超过六个月时走 replacement；距离到期六个月内通常应走 renewal。',
      '当前费用表列出成年 Regular original $52、Limited-Term original $32、DPC original $32；首次 DPC 另收 $30 fingerprint fee。',
      'Regular 现场续期 $52、符合资格的 online renewal $42，65 岁以上分别为 $27 和 $22；DPC renewal 与各类 replacement 当前均为 $23。',
      '现场完成 Regular 或 Limited-Term 后通常会取得 temporary license，实体卡约 4 至 6 周寄到；DPC 首次或续期现场只给 no-privilege receipt，不能据此驾驶。',
      '申请人不能同时保留两张 REAL ID-compliant credential，例如 Utah driver license 与另一州 ID；办理前要准备交回或处理现有证件。',
      'REAL ID 不是搭乘美国国内航班的唯一选择；没有合格 REAL ID 时，应改用 TSA 当前接受的 passport 等身份证件。',
    ],
    documentHighlights: [
      '美国公民、美国国民或永久居民准备一份 identity and date of birth、一份 SSN 证明和两份显示当前 Utah 地址、日期在 90 天内的文件。',
      '有 lawful presence 的非公民还要准备当前移民文件，并按 Limited-Term portal 提前上传；DLD 会通过 SAVE 核验身份状态。',
      'DPC 首次申请要分别准备 primary identity、secondary identity、SSN 或 ITIN / IRS 文件、两份 90 天内的 Utah 地址证明，以及 fingerprint card 和照片。',
      '身份证明通常须为原件或有签发机关 seal、stamp 或 signature 的 certified copy；普通复印件、传真件、覆膜出生证和医院出生证明不接受。',
      '外国文件要附 certified translation；不能只带自己翻译的中文说明。',
      '当前姓名与 identity 文件不一致时，带 certified marriage certificate、divorce decree、court order 或其他能串起每次变化的文件。',
      'SSN 替代证明必须显示完整号码；没有资格取得 SSN 的 lawful-presence 申请人按清单准备 SSA ineligibility letter。',
      '两份 Utah residency 证明都要显示本人姓名和当前 residential address；未成年人的地址文件可按 DLD 规则使用寄给父母或 legal guardian 的邮件。',
      '外州或外国驾照申请人带当前驾照；美国外州证件通常需要交回，外国驾照和外国材料的处理以现场核验为准。',
      '参加 DLD skills test 时带自己的车辆，并准备有效 registration；车辆要符合法律和安全要求且安全带可用。',
      '补证时带当前证件；证件遗失时重新准备 identity 文件，地址已变则准备两份地址证明或先在线更新。',
      '所有原始材料可能被扫描并安全保存后退还；电子核验或额外审批可能超过一天并需要再次到场。',
    ],
    commonMistakes: [
      ...
      '参加路考时没有符合要求的车辆、registration 或正常安全带。',
      '看到 renewal 页面就默认可以线上办，忽略 PIN、上次续期方式、过期时长、medical condition 和驾驶记录限制。',
      '搬家后只向 USPS 改地址，没有在 10 天内更新 DLD 记录。',
    ...
    recommendedSteps: [
      '先按移民身份确认 Regular、Limited-Term 或 DPC；需要的是驾驶许可还是仅 ID card 也要分开。',
      ...
      'Regular / Limited-Term 需要中文笔试时，预约前向具体 office 确认 Mandarin Chinese 文字或音频可用性；DPC 则按全英语考试准备。',
      '从未持证者学习当前 Utah Driver Handbook，准备 50 题 closed-book test、Traffic Safety and Trends exam 与 skills test。',
      '需要路考时确认车辆 registration、安全状态和安全带；可选择 DLD 或获准 third-party tester。',
      '在 Driver Licensing Services 中选业务并预约合适 office；不同 office 的服务和营业安排应在出发前复核。',
      '续期先检查是否收到 online PIN 及所有 eligibility 条件；DPC renewal、身份或姓名核验等情形直接按现场路线。',
      '搬家后先在 10 天内在线更新 DLD 地址；需要新地址印卡时再选择 renewal 或 replacement。',
      ...
      '近期搭乘国内航班时不要依赖尚未寄到的卡或 DPC；提前准备 TSA 接受的 passport 等替代身份证件。',
    ],
    actionLinks: [
      {
        label: 'Utah Required Documents',
        url: 'https://dld.utah.gov/required-documents/',
        description: '先按公民、lawful presence 或 DPC 身份路线进入对应材料清单。',
      },
      {
        label: 'Regular Original / Transfer',
        url: 'https://dld.utah.gov/regular-original/',
        description: '美国公民、国民和永久居民首次申请、外州或外国驾照路径。',
      },
      {
        label: 'Limited-Term Prequalification',
        url: 'https://dld.utah.gov/limited-term-portal/',
        description: '非公民先上传移民文件并等待 SAVE 预审通知。',
      },
      {
        label: 'Driving Privilege Card Original',
        url: 'https://dld.utah.gov/dpc-original/',
        description: '核对 DPC 资格、ITIN、fingerprint、英语考试和现场流程。',
      },
      {
        label: 'Written Knowledge Test',
        url: 'https://dld.utah.gov/written-knowledge-test/',
        description: '查看 50 / 25 题规则、Mandarin Chinese 和 approved interpreter。',
      },
      {
        label: 'Regular Renewal',
        url: 'https://dld.utah.gov/regular-renewal/',
        description: '核对提前续期、online PIN、现场条件、费用和制卡时间。',
      },
      {
        label: 'Address Change',
        url: 'https://dld.utah.gov/address-change-regular/',
        description: '在搬家后 10 天内更新 DLD 记录，并判断是否需要新卡。',
      },
      {
        label: 'Driver Licensing Services / Appointment',
        url: 'https://dld.utah.gov/driver-licensing-services/',
        description: '按证件和业务类型进入准确申请及预约入口。',
      },
      {
        label: 'DLD Office Locations',
        url: 'https://dld.utah.gov/office-locations/',
        description: '核对 office 地址、营业时间和具体可办服务。',
      },
      {
        label: 'Driver License Fees',
        url: 'https://dld.utah.gov/fees/',
        description: '查看 original、renewal、replacement、ID 和 fingerprint 当前费用。',
      },
      {
        label: 'TSA Acceptable Identification',
        url: 'https://www.tsa.gov/travel/security-screening/identification',
    ...
    sources: [
      {
        label: 'Utah DLD Required Documents Hub',
        url: 'https://dld.utah.gov/required-documents/',
        note: '原件、certified copy、翻译、扫描保存和按身份分类的材料入口。',
      },
      {
        label: 'Required Documents for U.S. Citizens',
        url: 'https://dld.utah.gov/required-documents-for-us-citizen/',
        note: 'identity、SSN、两份 90 天内 Utah 地址证明及未成年人地址规则。',
      },
      {
        label: 'Required Documents for Non-U.S. Citizens',
        url: 'https://dld.utah.gov/required-documents-non-us-citizen/',
        note: 'lawful presence、SAVE、SSN 或 SSA letter、地址和翻译要求。',
      },
      {
        label: 'Parolee or Undocumented Immigrant Documents',
        url: 'https://dld.utah.gov/parolee-or-undocumented-immigrant/',
        note: 'DPC primary / secondary identity、ITIN、地址、fingerprint 和照片。',
      },
      {
        label: 'What Is a Regular Driver License',
        url: 'https://dld.utah.gov/what-is-a-regular-driver-license/',
        note: 'Regular 资格、期限、Utah residency 和 nonresident 驾驶边界。',
      },
      {
        label: 'What Is a Limited-Term Driver License',
        url: 'https://dld.utah.gov/what-is-a-limited-term-driver-license/',
        note: 'lawful-presence 资格与 limited-term expiration。',
      },
      {
        label: 'What Is a Driving Privilege Card',
        url: 'https://dld.utah.gov/what-is-a-driving-privilege-card/',
        note: 'DPC 用途、非政府 ID、ITIN、期限和不适用的证件类型。',
      },
      {
        label: 'Regular Original Driver License',
        url: 'https://dld.utah.gov/regular-original/',
        note: '首次、美国外州和外国驾照申请的文件、测试、费用与制卡流程。',
      },
      {
        label: 'Limited-Term Original Driver License',
        url: 'https://dld.utah.gov/limited-term-original/',
        note: 'lawful-presence 非公民 original / transfer 流程、测试和期限。',
      },
      {
        label: 'Driving Privilege Card Original',
        url: 'https://dld.utah.gov/dpc-original/',
        note: 'DPC 首次材料、English-only tests、费用和 no-privilege receipt。',
      },
      {
        label: 'Written Knowledge Test',
        url: 'https://dld.utah.gov/written-knowledge-test/',
        note: '50 / 25 题、次数、再次收费与可用语言。',
      },
      {
        label: 'In-Person Interpreter',
        url: 'https://dld.utah.gov/in-person-interpreter/',
        note: 'Mandarin Chinese 文字 / 音频和 approved interpreter 规则。',
      },
      {
        label: 'Driving Skills Test',
        url: 'https://dld.utah.gov/driving-test/',
        note: '首次申请路考、车辆、六个月时限、次数和 third-party tester。',
      },
      {
        label: 'Utah Driver Handbook March 2026',
        url: 'https://dld.utah.gov/wp-content/uploads/Driver-Handbook-REV-3.2026.pdf',
        note: '现行证件类型、访客驾驶、考试、材料、DPC 和 REAL ID 汇总。',
      },
      {
        label: 'Regular Driver License Renewal',
        url: 'https://dld.utah.gov/regular-renewal/',
        note: '提前续期、online eligibility、现场流程、年龄费用、期限和邮寄。',
      },
      {
        label: 'DPC Renewal',
        url: 'https://dld.utah.gov/dpc-renewal/',
        note: 'DPC 不能线上续期、English-only test、费用和 no-privilege receipt。',
      },
      {
        label: 'Regular Driver License Replacement',
        url: 'https://dld.utah.gov/regular-replacement/',
        note: '遗失、损坏、资料变化、六个月边界、材料、费用和 temporary license。',
      },
      {
        label: 'DPC Replacement',
        url: 'https://dld.utah.gov/dpc-replacement/',
        note: 'DPC replacement 条件、材料和免重新 fingerprint。',
      },
      {
        label: 'Utah DLD Address Change',
        url: 'https://dld.utah.gov/address-change-regular/',
        note: '10 天、online-only record update、USPS 不同步和 printed card 规则。',
      },
      {
        label: 'Utah DLD Name Change',
        url: 'https://dld.utah.gov/name-change-regular-license/',
        note: '现场办理、certified name-change records 和外国文件翻译。',
      },
      {
        label: 'Utah DLD Fee Schedule',
        url: 'https://dld.utah.gov/fees/',
        note: 'original、renewal、online、65 岁以上、replacement、ID 和 fingerprint fee。',
      },
      {
        label: 'Limited-Term Prequalification Portal',
        url: 'https://dld.utah.gov/limited-term-portal/',
        note: '移民文件预上传、USCIS / SAVE precheck 和等待通知后预约。',
      },
      {
        label: 'DPC Fingerprint Vendors',
        url: 'https://dld.utah.gov/dpc-fingerprint-vendors/',
        note: '首次 DPC fingerprint 与照片的 approved vendor / agency 路径。',
      },
      {
        label: 'Utah DLD Driver Licensing Services',
        url: 'https://dld.utah.gov/driver-licensing-services/',
        note: '按证件和 service type 选择申请与预约入口。',
      },
      {
        label: 'Utah DLD Office Locations',
        url: 'https://dld.utah.gov/office-locations/',
        note: '办公室、营业时间、预约入口和服务差异。',
      },
      {
        label: 'TSA Acceptable Identification',
        url: 'https://www.tsa.gov/travel/security-screening/identification',
        note: '国内航班接受的 REAL ID 与替代身份证件。',
      },
    ],
    relatedTopicSlugs: [
      'real-id-basics',
  ...
  },
  {
    ...
    reviewedAt: '2026-07-21',
    summary:
      'Missouri 驾照、permit 和 nondriver ID 由 Department of Revenue 通过当地 contract license office 签发，知识、视力、路标和驾驶考试则由 Missouri State Highway Patrol 负责。先区分首次申请、美国外州转入、外国驾照、续期、补证或 REAL ID，再分别去考试站或签发办公室。',
    realIdSummary:
      'Missouri 州法不强制办理 REAL ID；普通驾照仍可驾驶、投票和用于州内一般用途。需要 REAL ID 时，到 license office 提交身份、lawful status、SSN、两份来自不同来源的 Missouri residential address 文件和适用的姓名变更链；永久卡通常在 10 到 15 个工作日内邮寄。',
    licenseSummary:
      '建立 Missouri residency 后应尽快申请本州驾照。交回有效或过期不超过 184 天的美国外州驾照时，通常可免 Missouri 知识与驾驶考试，但仍要通过路标识别和视力检查；这项豁免没有把中国等外国驾照列入，因此外国驾照持有人应按首次申请和完整考试路线准备，并向 MSHP 确认个案。',
    appointmentNote:
      '考试与领证不是同一个地点体系：MSHP exam station 做考试，DOR contract license office 收材料、收费并签发。非 CDL 知识与驾驶考试通常不要求预约，但部分地点提供并建议预约 skills test；CDL skills test 必须预约，出发前还要核对具体地点的测试日、截止时间和天气限制。',
    editorNotes: [
      'Missouri 州法不强制居民持有 REAL ID；非 REAL ID 驾照或 ID 仍可用于驾驶、投票、州内用途和年龄验证。',
      '自 2025-05-07 起，国内航班和受 REAL ID 规则约束的联邦设施需要 REAL ID 或 TSA 接受的其他身份证件；有效美国护照或 passport card 可作为替代。',
      '美国外州驾照有效或过期不超过 184 天时，可在符合其他资格后豁免 Missouri 知识和驾驶考试，但所有申请人仍要通过路标识别和视力检查。',
      'DOR 公布的免试转入规则只列美国 jurisdiction 和特定美国 territories，没有把中国驾照列入；中国驾照持有人不要预设可以直接换证。',
      'MSHP 负责考试，DOR contract license office 负责收件、收费和签发；通过考试取得的分数记录本身不是驾驶许可。',
      '非 CDL 知识与驾驶考试通常无需预约，部分地点提供并建议预约 skills test；CDL skills test 必须预约。',
      'Class F 知识考试为 25 题，答对 20 题即 80% 才通过；同一种笔试每天最多尝试两次。',
      '驾驶考试每天最多一次，过去 12 个月通常最多三次，继续考试需 DOR 特别许可；非 CDL 知识和驾驶考试本身不收费。',
      'MSHP 当前说明 Class F 笔试提供 20 种语言，所链接的官方语言清单包含 Chinese；具体站点、设备和当日语言可用性仍应提前确认。',
      '远程续期只面向 21 至 49 岁、档案中有美国公民身份核验标记且满足驾驶记录等条件的人；上一次申请必须本人办理，连续两次远程续期不允许。',
      '使用 USCIS 移民文件的申请人不能走远程续期或远程补证，必须本人提交文件并接受 SAVE 核验。',
      '远程续期还要求在申请前 12 个月内完成视力检查，credential 必须仍有效或过期不超过 184 天。',
      '地址未变并且先前核验文件已扫描保存时，部分现有持证人可以 self-certify 地址；地址或 mailing address 已变时仍要提交当前证明。',
      '当前 Missouri 记录中 SSN 已核验的人可能可以口头提供号码；电子核验失败时仍须出示实体证明或向 SSA 处理。',
      '21 至 69 岁的普通驾照通常为 6 年，18 至 20 岁和 70 岁以上通常为 3 年；非公民证件可能随 lawful-status 文件提前到期。',
      '当前费用表列出 Class F 三年证件 $16.50、六年证件 $33，三年 duplicate $16.50、六年 duplicate $25.50；license office 还会按证件期限收取 $9 或 $18 processing fee。',
      '信用卡或借记卡付款另有 2% 加 $0.25 的 convenience fee，实际总额应在付款前由办理处确认。',
      '正常制卡邮寄通常为 10 至 15 个工作日，现场纸质 temporary document 通常有效 45 天，但不属于 REAL ID，不能作为国内航班的 REAL ID 身份件。',
      '从未获发 Missouri REAL ID 的人提前办理 initial REAL ID 时，可能获得一次 duplicate transaction fee waiver，但 $9 或 $18 processing fee 不免，增加 class、endorsement 或 restriction 也不适用该 waiver。',
      '实体卡寄出至少 25 个工作日仍未收到、且申请未超过 90 天时，可到 office 申请 replacement；没有地址或其他资料变化时可能免交易费。',
      'Missouri 原则上只允许同时保留一种有效 driver license 或 nondriver ID；申请 Missouri credential 时，先前外州 credential 会被作废或通知原州取消。',
      'Missouri 驾照过期不超过 184 天通常仍可续期而无需重新考试，但过期期间不能合法驾驶。',
    ],
    documentHighlights: [
      '身份与 lawful status 文件应有效且未过期；美国出生证应为 vital records agency 签发、带印章的 original certified document，医院出生证明不接受。',
      'SSN 证明要显示姓名和号码；18 岁以上申请人的 Social Security card 应签名且不能覆膜，未获分配 SSN 时带 SSA status letter。',
      '非 REAL ID 通常要一份 Missouri residential address 文件；REAL ID 要两份来自不同来源、显示本人姓名和当前 residential address 的文件。',
      'P.O. Box 不能代替 residential address；如果另设 alternate mailing address，还要额外证明该邮寄地址。',
      '当前姓名不同于 identity 或 lawful-status 文件时，用 certified marriage license、divorce decree、court order、adoption papers 或 amended birth certificate 串起每次变化。',
      '多次改名可能需要完整文件链；普通 photocopy 和 fax 不接受，境外结婚文件还可能要先在 Missouri county Recorder of Deeds 登记。',
      '美国外州转入带原 credential；若遗失、被盗或毁损，可准备签发州当前 Clearance Letter 或包含号码、class、endorsement 和 restriction 的 affidavit。',
      '首次驾驶人除了 identity、lawful status、SSN 和地址材料，还要带 MSHP 测试通过后签发的 Driver Examination Record Form 100。',
      '使用 USCIS 文件的申请人准备当前 immigration documents，并为现场 SAVE 核验和可能的额外审核预留时间。',
      '续期通常仍要核对 identity、lawful status、SSN 和 Missouri address；REAL ID renewal 需要两份地址文件，除非符合 same-address self-certification。',
      '参加驾驶考试要自备 street-legal vehicle，并准备当前 registration 和 insurance 证明。',
      '现场办理后保存 temporary paper credential 和收据，并确认 DOR 使用的 residential 或 mailing address 可以可靠收件。',
    ],
    commonMistakes: [
      '把 REAL ID 当作驾驶必需，或以为普通 Missouri 驾照自 2025-05-07 起已经不能开车。',
      '拿 temporary paper credential 直接去机场，忽略它明确不是 REAL ID。',
      '只去 license office 才发现首次申请要先在 MSHP exam station 完成考试并取得 Form 100。',
      '只去 exam station 通过测试，却没有再到 DOR license office 付费取得 permit 或 license。',
      '把中国驾照套用美国外州证件的 184 天免试规则，未准备知识和驾驶考试。',
      '外州驾照过期超过 184 天，仍按免知识与驾驶考试路线准备。',
      'REAL ID 只带一份地址证明，或两份地址文件来自同一来源。',
      '用 P.O. Box 代替 residential address，导致证件地址和邮寄都无法完成核验。',
      '带医院出生纸、普通复印件、传真件、覆膜 SSN card 或不完整的改名文件链。',
      '看到 MyDMV 入口就默认自己可远程续期，忽略年龄、公民核验标记、上次办理方式、视力检查和驾驶记录限制。',
      '使用 USCIS 文件仍尝试远程续期或远程补证，没有安排本人到场做 SAVE 核验。',
      '地址已变却继续使用 same-address self-certification，或只改邮寄地址而没有准备对应证明。',
      '只看 credential transaction fee，漏算 $9 / $18 office processing fee 和刷卡 convenience fee。',
      '临近航班才办 REAL ID，没有为 10 至 15 个工作日制卡邮寄和潜在审核留出时间。',
      '误以为过期不超过 184 天仍能开车；该期限只可能保留续期或转入资格，不延长驾驶权限。',
      '没有核对 exam station 的测试日、截止时间、预约选项和天气状态，到了现场才发现无法路考。',
    ],
    recommendedSteps: [
      '先确定业务是 first-time、U.S. out-of-state transfer、foreign-license application、renewal、duplicate、name / address change，还是 initial REAL ID。',
      '按用途比较 REAL ID 与 passport 等 TSA 接受证件；只用于驾驶、投票或州内一般用途时，不必自动升级。',
      '打开 DOR Driver Licensing Checklist，按 identity、lawful status、SSN、residential address 和 legal-name chain 分组准备材料。',
      'REAL ID 准备两份不同来源的 Missouri address 文件；non-REAL ID 通常准备一份，并另行处理 alternate mailing address。',
      '美国外州证件有效或过期不超过 184 天时，带原卡或合格 clearance document；仍要准备路标和视力检查。',
      '中国或其他外国驾照持有人按 first-time driver 路线联系 MSHP，准备知识、视力、路标和驾驶考试，不要依赖未经公布的 reciprocity。',
      '需要考试时先用 MSHP locator 核对地点、时间和服务；非 CDL skills test 有预约选项时优先预约。',
      '需要中文笔试时，带上官方 20-language 清单信息并提前向具体 exam station 确认 Chinese 是否可用。',
      '通过考试后保存 Form 100，再去任一合适的 Missouri license office 提交材料和付费。',
      '续期或补证先检查 MyDMV eligibility；使用 USCIS 文件、姓名或地址变化、首次 REAL ID 等情况按现场路线。',
      '付款前同时核对 credential transaction fee、office processing fee 和刷卡 convenience fee。',
      '现场办理后保存 45 天 temporary document，并按 10 至 15 个工作日规划实体卡；航空出行另备 TSA 接受证件。',
      '实体卡长期未到时先核对地址；达到寄出 25 个工作日且仍在申请后 90 天内，可按 DOR 规则到 office 处理 replacement。',
    ],
    actionLinks: [
      {
        label: 'Required Documents Checklist',
        url: 'https://dor.mo.gov/driver-license/issuance/required-documents-checklist.html',
        description: '按新居民、首次申请、renewal、duplicate、线上资格和地址变化核对材料。',
      },
      {
        label: 'Missouri REAL ID',
        url: 'https://dor.mo.gov/driver-license/issuance/real-id/',
        description: '判断是否需要 REAL ID，查看材料、费用 waiver 和邮寄时间。',
      },
      {
        label: 'REAL ID Interactive Guide',
        url: 'https://dor.mo.gov/driver-license/issuance/real-id/interactive-guide.html',
        description: '按个人身份和申请场景生成 REAL ID 材料清单。',
      },
      {
        label: 'Identity and Address Requirements',
        url: 'https://dor.mo.gov/driver-license/issuance/id-requirements.html',
        description: '核对 identity、lawful status、SSN、住址、姓名链和例外。',
      },
      {
        label: 'Missouri Driver License Hub',
        url: 'https://dor.mo.gov/driver-license/',
        description: 'DOR 驾照、permit、ID、表格和线上服务总入口。',
      },
      {
        label: 'License Office Locator',
        url: 'https://dor.mo.gov/license-office-locator/',
        description: '查找提交材料、付费和签发 credential 的 contract license office。',
      },
      {
        label: 'MSHP Exam Station Locator',
        url: 'https://apps.mshp.dps.mo.gov/HP32DES/DESMap.jsp',
        description: '查询考试站、测试日期、营业时间、电话和天气限制。',
      },
      {
        label: 'MSHP Driver Examination FAQ',
        url: 'https://apps.mshp.dps.mo.gov/MSHPWeb/PatrolDivisions/DVSD/DE/faqs.html',
        description: '考试预约、次数、费用、题数、分数和车辆要求。',
      },
      {
        label: 'Class F Test Languages',
        url: 'https://apps.mshp.dps.mo.gov/MSHPWeb/PatrolDivisions/DVSD/DE/documents/Languages_ClassF.pdf',
        description: 'MSHP 官方 Class F 笔试语言清单，包含 Chinese。',
      },
      {
        label: 'MyDMV Online Services',
        url: 'https://mydmv2.mo.gov/TAP/',
        description: '符合资格时办理远程续期、duplicate 和其他线上业务。',
      },
      {
        label: 'Driver License Fee Chart',
        url: 'https://dor.mo.gov/driver-license/documents/feechart.pdf',
        description: '核对 Class、期限、renewal 和 duplicate transaction fee。',
      },
      {
        label: 'TSA Acceptable Identification',
        url: 'https://www.tsa.gov/travel/security-screening/identification',
    ...
    sources: [
      {
        label: 'Missouri DOR Driver License Hub',
        url: 'https://dor.mo.gov/driver-license/',
        note: 'Missouri 驾照、permit、nondriver ID、线上服务与表格总入口。',
      },
      {
        label: 'Missouri DOR Required Documents Checklist',
        url: 'https://dor.mo.gov/driver-license/issuance/required-documents-checklist.html',
        note: '新居民、首次申请、renewal、duplicate、remote eligibility 与 credential surrender。',
      },
      {
        label: 'Missouri DOR Identity and Address Requirements',
        url: 'https://dor.mo.gov/driver-license/issuance/id-requirements.html',
        note: 'identity、lawful status、SSN、residency、same-address certification 与 name change。',
      },
      {
        label: 'Missouri DOR REAL ID',
        url: 'https://dor.mo.gov/driver-license/issuance/real-id/',
        note: 'REAL ID 是否必需、联邦用途、材料、费用 waiver、星标和制证时间。',
      },
      {
        label: 'Missouri DOR REAL ID Acceptable Documents PDF',
        url: 'https://dor.mo.gov/driver-license/documents/RID.pdf',
        note: '当前 REAL ID 可接受 identity、lawful status、SSN、residency 和姓名文件清单。',
      },
      {
        label: 'Missouri DOR REAL ID Interactive Guide',
        url: 'https://dor.mo.gov/driver-license/issuance/real-id/interactive-guide.html',
        note: '按个人场景生成申请材料清单。',
      },
      {
        label: 'Missouri Driver License and Nondriver ID',
        url: 'https://dor.mo.gov/driver-license/resources/license.html',
        note: '有效期、renewal test、transaction fee、付款方式和刷卡 convenience fee。',
      },
      {
        label: 'Missouri DOR Driver License FAQ',
        url: 'https://dor.mo.gov/faq/driver-license/general.html',
        note: '新居民、184 天、考试、地址、姓名、续期、路考车辆和 lost credential。',
      },
      {
        label: 'Missouri New Credential FAQ',
        url: 'https://dor.mo.gov/faq/driver-license/new-look.html',
        note: '10 至 15 个工作日、45 天 temporary、未收到卡和联邦用途限制。',
      },
      {
        label: 'Missouri Driver License Fee Chart',
        url: 'https://dor.mo.gov/driver-license/documents/feechart.pdf',
        note: '当前 credential transaction fee 表。',
      },
      {
        label: 'Missouri Driver Licensing Law Changes',
        url: 'https://dor.mo.gov/driver-license/law-changes/',
        note: '2025-08-28 生效的 $9 / $18 license office processing fee。',
      },
      {
        label: 'MSHP Driver Examination FAQ',
        url: 'https://apps.mshp.dps.mo.gov/MSHPWeb/PatrolDivisions/DVSD/DE/faqs.html',
        note: 'DOR / MSHP 职责、预约、题数、分数、次数、费用和考试格式。',
      },
      {
        label: 'MSHP DOR-FUSION Testing System',
        url: 'https://apps.mshp.dps.mo.gov/MSHPWeb/PatrolDivisions/DVSD/DE/DOR_FUSION.html',
        note: 'Class F 笔试 20 种语言与数字化成绩传输。',
      },
      {
        label: 'MSHP Class F Language List',
        url: 'https://apps.mshp.dps.mo.gov/MSHPWeb/PatrolDivisions/DVSD/DE/documents/Languages_ClassF.pdf',
        note: '官方列出的 Class F 笔试语言，包含 Chinese。',
      },
      {
        label: 'MSHP Driver Exam Station Locator',
        url: 'https://apps.mshp.dps.mo.gov/HP32DES/DESMap.jsp',
        note: '按 city 或 county 查询考试站、开放日、截止时间和天气限制。',
      },
      {
        label: 'Missouri License Office Locator',
        url: 'https://dor.mo.gov/license-office-locator/',
        note: '查找 DOR contract license office。',
      },
      {
        label: 'TSA Acceptable Identification',
        url: 'https://www.tsa.gov/travel/security-screening/identification',
        note: '国内航班可接受身份证件与 temporary license 限制。',
      },
    ],
    relatedTopicSlugs: [
      'real-id-basics',
  ...
  },
  {
    ...
    reviewedAt: '2026-07-21',
    summary:
      'Kansas 驾照和 ID 由 Department of Revenue Division of Vehicles 管理。首次申请、外州转入、REAL ID 文件核验和非公民业务先按现场路线准备；符合条件的续期、地址变更、状态查询和知识考试可从官方线上入口开始。新居民在建立 Kansas residency 后有 90 天换领本州驾照。',
    realIdSummary:
      'Kansas REAL ID 需要一份 lawful-presence 文件、一份 SSN 证明、两份近期 Kansas physical residential address 证明和适用的 legal-name-change 文件。材料须用原件或签发机关认证件，普通复印件、公证复印件和覆膜文件不接受；即使交回的是外州 REAL ID，也要重新提交 Kansas 所需材料。',
    licenseSummary:
      '有效外州驾照转入通常只需视力检查，过期外州驾照则要完成视力、知识和驾驶考试，外州 permit 也不能直接转入。KDOR 当前另列台湾和韩国互惠路线；中国大陆及其他未列入互惠的外国驾照应按 vision、written 和 driving exam 路线准备。',
    appointmentNote:
      'Kansas 每个 county 都提供某些驾照或 ID 服务，但部分办公室服务有限。预约不是所有业务的绝对前提，不过有预约的申请人优先；先在地点页确认该 office 是否办理首次申请、考试、REAL ID、non-citizen 或 CDL 业务。',
    editorNotes: [
      '从 2025 年 5 月 7 日起，TSA 不再把非 REAL ID 的州驾照或 ID 当作机场安检的合规身份证件；有效护照等 TSA 接受证件仍可替代。',
      '标有 NOT FOR FEDERAL ID 的 Kansas 证件仍可用于驾驶和多数日常州内身份用途，但不能按 REAL ID 规划国内航班安检。',
      '首次增加 REAL ID 要本人提交 lawful presence、SSN、两份 Kansas physical address 和姓名变更材料，不能只在 iKan 上传后等待寄卡。',
      'REAL ID 核验通常只做一次，但从外州 REAL ID 转入 Kansas 时仍须重新出示 Kansas 要求的全部材料。',
      '建立 Kansas residency 后应在 90 天内换领 Kansas 驾照。',
      '外州证件有效时通常免知识与驾驶考试；证件已过期、只有 permit 或存在其他州 hold 时，考试或签发资格会改变。',
      '非美国公民每次签发都要带当前 immigration documents，并由 Kansas 使用 SAVE 核验。',
      '非工作授权身份且从未取得 SSN 的外国学生或家属可不提交 SSN 证明，但仍要满足 lawful-presence 和其他材料要求。',
      'KDOR 当前分别公布台湾与韩国互惠信息；中国大陆驾照未列入这两条免试路径。',
      'KDOR 提供在家完成 non-commercial Class C knowledge exam 的官方入口，但考试语言和当次服务费应在进入考试前再次确认。',
      '普通续期可最早提前一年办理；现场续期仍要身份、SSN、Kansas principal residence address、视力检查、照片和签名。',
      'iKan 的驾照续期入口面向符合资格的 21 至 64 岁申请人，法定限制或个人记录可能要求改为现场办理。',
      'Kansas 法律要求地址变化后 10 天内通知 Division of Vehicles；只更新记录可以免费，要求印有新地址的卡片则走付费入口。',
      '实体 credential 多数在 14 至 20 天寄到，但官方要求最多预留 45 天；邮件没有 tracking，也不会自动 forward 到新地址。',
      '当前 Online Services 写新地址卡收费 $10，而 2023 年 fee chart 仍写 address change $8；付款前应以当前交易报价为准。',
      'KDOR 当前 Forms 页面列出英文与西班牙文 handbook，没有给出中文考试保证；需要中文帮助时应提前向办理 office 确认。',
      '每个 Kansas county 都有某种 driver license 或 ID 服务，但不能据此假定每个地点都能完成考试、non-citizen、REAL ID 或 CDL。',
    ],
    accessStatus: {
      label: '官方页需点验',
      tone: 'watch',
    ...
    documentHighlights: [
      '一份 lawful-presence 文件，例如签发机关认证的出生证、未过期美国护照、Permanent Resident Card、Employment Authorization Card 或适用的移民文件。',
      '一份显示完整号码的 SSN 证明，例如 Social Security Card、当前 W-2 / 1099 或当前 pay stub。',
      '非工作授权身份且从未获发 SSN 的外国学生或家属可按 KDOR 例外处理，不要自行伪造或填写不存在的号码。',
      '两份近期 Kansas residential address 文件，必须显示本人姓名和 physical address，不能只给 mailing address 或 P.O. Box。',
      '姓名不同于 lawful-presence 文件时，用政府签发的 marriage certificate、恢复姓名的 divorce decree、adoption order 或 legal-name-change court order 衔接。',
      '外州转入另带有效实体 license / ID；只有 temporary credential 或原卡遗失时，准备签发州 30 天内的 MVR 或 clearance letter。',
      '外国学生通常还要带 I-20，交流访问身份通常还要带 DS-2019，并配合有效 passport、I-94 或相应身份文件。',
      'REAL ID 和首次申请材料使用原件或签发机关认证件；普通 photocopy、手机图片、自行公证件和 laminated document 不接受。',
      '续期通常带 Kansas credential 和一封显示当前 residential address 的邮件，现场还要完成视力检查、照片和签名。',
      '补证通常需要两份可接受 identity 文件和一封显示本人姓名与 Kansas residential address 的邮件；SSN card 不能当作 replacement 的 identity 文件。',
      '使用 DE-56A portable checklist 按自己的 first-time、transfer、renewal、replacement、name change 或 REAL ID 路线逐项打勾。',
    ],
    commonMistakes: [
      'REAL ID 或首次申请只带一份 Kansas 地址证明，或两份文件只显示 P.O. Box。',
      '把医院纪念出生纸当作签发机关认证 birth certificate。',
      '携带 photocopy、手机照片、公证复印件或 laminated document，误以为等同于原件或 certified copy。',
      '姓名变化后未先在 SSA 更新并至少等待 24 小时，或没有带 legal-name-change document。',
      '拿外州 temporary license 直接转入，没有准备签发州的 MVR 或 clearance letter。',
      '外州驾照已过期仍按免试转入准备，漏掉 vision、written 和 driving exams。',
      '把中国大陆驾照套用台湾或韩国 reciprocity，默认可以免知识和驾驶考试。',
      '只在 iKan 尝试首次 REAL ID、首次证件、non-citizen 或复杂姓名变更，不准备本人到场。',
      '搬家后只向 USPS 设置转寄，没有在 10 天内更新 Kansas 驾照记录。',
      '申请实体卡后立刻搬家，误以为 credential 会被 USPS 转寄或能用 tracking 找到。',
      '把旧 fee chart 的 $8 address change 当作当前固定报价，忽略 Online Services 已显示 $10。',
      '看到西班牙文 handbook 就推断现场或线上知识考试一定提供中文，没有先向 office 核实。',
      '只看 county 名称就前往，未确认该地点是否提供考试、首次申请、non-citizen、REAL ID 或 CDL 服务。',
    ],
    recommendedSteps: [
      '先确定业务是 first-time、out-of-state transfer、foreign-license application、renewal、replacement、name / address change，还是 adding REAL ID。',
      '新居民记录建立 Kansas residency 的日期，并在 90 天期限内安排换证。',
      '只为国内航班或联邦用途需要新证件时，先比较 Kansas REAL ID 与现有 passport 等 TSA 接受证件。',
      '打开 Required Documents 和 DE-56A checklist，准备 lawful presence、完整 SSN、两份 physical-address 文件和完整 legal-name chain。',
      '非公民按当前身份准备 passport、I-94、Permanent Resident Card、EAD、I-20 或 DS-2019，并为 SAVE 核验预留时间。',
      '持外国驾照时先核对 Taiwan / South Korea reciprocity；中国大陆或其他未列入互惠的证件按 vision、written 和 driving exams 准备。',
      '续期或改址先看 iKan 与 Online Services 的个人资格；首次 REAL ID、身份核验和非公民业务按现场路线。',
      '在 station finder 核对 office 的具体服务，再预约；有预约的申请人会优先。',
      '需要知识考试时先读当前 handbook，并从 KDOR Online Services 进入官方线上考试；需要中文帮助先联系 office。',
      '付款前打开 fee chart 并核对实际交易报价，尤其注意 address change 的 $8 / $10 官方差异。',
      '交易完成后保存 temporary credential 和收据，确认邮箱能接收本人姓名邮件，并按最多 45 天规划实体卡。',
      '45 天仍未收到时，带 temporary credential 和当前地址证明到 driver license office 处理，不要假设邮局会转寄。',
    ],
    actionLinks: [
      {
        label: 'Kansas 驾照与 ID 入口',
        url: 'https://www.ksrevenue.gov/dovlicenses.html',
        description: '驾照、ID、handbook、地址变更和常见业务总入口。',
      },
      {
        label: 'Required Documents 与预约',
        url: 'https://www.ksrevenue.gov/dovtelegovreq.html',
        description: '按补证、外州转入、续期、首次申请、REAL ID 等业务查看材料并进入预约。',
      },
      {
        label: 'Kansas REAL ID',
        url: 'https://www.ksrevenue.gov/dovrealid.html',
        description: 'REAL ID 判断、材料和状态检查。',
      },
      {
        label: 'Online Services 与 iKan',
        url: 'https://www.ksrevenue.gov/dovonlineservices.html',
        description: '续期、改址、状态查询、预约和 non-commercial knowledge exam 入口。',
      },
      {
        label: '外州转入与首次驾照',
        url: 'https://www.ksrevenue.gov/dovobtainingdl.html',
        description: '有效或过期外州驾照、首次申请和考试要求。',
      },
      {
        label: 'Driver License FAQ',
        url: 'https://www.ksrevenue.gov/dovdlfaq.html',
        description: '90 天转入、邮寄、姓名变更、考试和外国驾照边界。',
      },
      {
        label: '续期说明',
        url: 'https://www.ksrevenue.gov/dovrenewingdl.html',
        description: '现场续期材料、视力检查、提前办理和地点要求。',
      },
      {
        label: '查找办理地点',
        url: 'https://www.ksrevenue.gov/dovstations.html',
        description: '按 county 查找 driver license office 并确认有限服务。',
      },
      {
        label: 'South Korea reciprocity',
        url: 'https://www.ksrevenue.gov/dovreciprocity.html',
        description: '韩国有效驾照的免 written / driving exam 条件和材料。',
      },
      {
        label: '费用表',
        url: 'https://www.ksrevenue.gov/pdf/dmvlicfees.pdf',
        description: '按年龄、class 和交易类型核对 Kansas driver license fee。',
      },
      {
        label: 'TSA 可接受身份证件',
        url: 'https://www.tsa.gov/travel/security-screening/identification',
        description: '国内航班的 REAL ID、passport 和其他可接受证件。',
      },
      {
        label: 'USA.gov 备用入口',
        url: 'https://www.usa.gov/state-motor-vehicle-services',
    ...
    sources: [
      {
        label: 'Kansas Division of Vehicles Home',
        url: 'https://www.ksrevenue.gov/dovindex.html',
        note: '每个 county 的驾照服务提示、iKan、REAL ID 和在线知识考试入口。',
      },
      {
        label: 'Kansas Licensing and Identification Cards',
        url: 'https://www.ksrevenue.gov/dovlicenses.html',
        note: '驾照与 ID 业务总入口，以及实体 credential 最多 45 天提示。',
      },
      {
        label: 'Kansas KDOR Required Documents and Appointment',
        url: 'https://www.ksrevenue.gov/dovtelegovreq.html',
        note: 'replacement、transfer、renewal、first-time、REAL ID、non-citizen 和 name change 材料。',
      },
      {
        label: 'Kansas DE-56A Portable Checklist',
        url: 'https://www.ksrevenue.gov/pdf/de56a.pdf',
        note: '当前 portable checklist，覆盖 identity、lawful presence、SSN、住址和姓名文件。',
      },
      {
        label: 'Kansas KDOR REAL ID',
        url: 'https://www.ksrevenue.gov/dovrealid.html',
        note: 'Kansas REAL ID 材料、状态检查和提前办理。',
      },
      {
        label: 'Kansas KDOR REAL ID FAQ',
        url: 'https://www.ksrevenue.gov/dovrealidfaq.html',
        note: 'REAL ID 日常用途、替代证件、原件、外州 REAL ID 和一次性核验。',
      },
      {
        label: 'Kansas Driver License Proof of Identity',
        url: 'https://www.ksrevenue.gov/dovproof.html',
        note: '公民与非公民 identity、SAVE、SSN、residency、姓名和外州证件清单。',
      },
      {
        label: 'Kansas Getting a Driver License',
        url: 'https://www.ksrevenue.gov/dovobtainingdl.html',
        note: '首次、有效外州和过期外州驾照的考试分界。',
      },
      {
        label: 'Kansas Driver License FAQ',
        url: 'https://www.ksrevenue.gov/dovdlfaq.html',
        note: '90 天转入、temporary credential、外国驾照、姓名、邮寄、费用和 appointment。',
      },
      {
        label: 'Kansas Renewing Driver License',
        url: 'https://www.ksrevenue.gov/dovrenewingdl.html',
        note: '现场续期材料、视力、提前一年和 full-service office 规则。',
      },
      {
        label: 'Kansas KDOR Online Services',
        url: 'https://www.ksrevenue.gov/dovonlineservices.html',
        note: 'iKan、改址、状态、预约和线上知识考试清单及当前改址报价。',
      },
      {
        label: 'Kansas About iKan',
        url: 'https://www.ksrevenue.gov/dovaboutikan.html',
        note: 'iKan 官方身份和可办理业务。',
      },
      {
        label: 'Kansas Online Address Change',
        url: 'https://www.ksrevenue.gov/dladdresschange/',
        note: '记录更新、不自动发新卡、CDL 限制和 physical address 要求。',
      },
      {
        label: 'Kansas Suspension FAQ',
        url: 'https://www.ksrevenue.gov/dovsuspendedfaq.html',
        note: '搬家后 10 天通知要求和可用渠道。',
      },
      {
        label: 'Kansas Appointment Information',
        url: 'https://www.ksrevenue.gov/DOVAppointmentInfo/',
        note: 'appointment priority、office 清单和 21 至 64 岁 iKan 续期提示。',
      },
      {
        label: 'Kansas Driver License Stations',
        url: 'https://www.ksrevenue.gov/dovstations.html',
        note: '按 county 查询地点、服务与预约。',
      },
      {
        label: 'Kansas South Korean Reciprocity',
        url: 'https://www.ksrevenue.gov/dovreciprocity.html',
        note: '韩国有效驾照免 written / driving exam 的当前材料路径。',
      },
      {
        label: 'Kansas Forms and Publications',
        url: 'https://www.ksrevenue.gov/dovforms.html',
        note: '英文与西班牙文 handbook、driver license forms 和 address change。',
      },
      {
        label: 'Kansas Driver License Fee Chart',
        url: 'https://www.ksrevenue.gov/pdf/dmvlicfees.pdf',
        note: '按年龄和 class 的费用表；文件标注 Updated 5/2023，须与当前交易页交叉核对。',
      },
      {
        label: 'TSA Acceptable Identification',
        url: 'https://www.tsa.gov/travel/security-screening/identification',
        note: '2025-05-07 后机场身份证件、替代证件和 temporary license 限制。',
      },
    ],
    relatedTopicSlugs: [
      'real-id-basics',
  ...
  },
  {
    ...
    reviewedAt: '2026-07-21',
    summary:
      'Louisiana 驾照和 ID 由 Office of Motor Vehicles 管理。建立 Louisiana domicile 后，外州驾照应在 30 天内转入；首次驾驶人、美国外州转入、外国驾照、续期、补证和 REAL ID 是不同路线，不能只从 ExpressLane 的一个线上按钮开始。',
    realIdSummary:
      'Louisiana 同时签发 REAL ID-compliant 与 non-compliant credential，REAL ID 是可选项且州证件费用相同。首次 REAL ID 要证明 identity、lawful status、date of birth、SSN，并提交两份显示本人姓名和 Louisiana street address、来自独立来源的 principal-residence 原件。',
    licenseSummary:
      '有效美国外州非商业驾照转入通常只考视力；外国驾照只有 Germany、Switzerland、South Korea 和 Taiwan 属于普通互惠名单。中国大陆驾照不在名单内，符合身份资格者通常要先办 TIP、完成 Louisiana driver education，再通过 knowledge、vision 和 road skills tests。',
    appointmentNote:
      '预约前先查 driver-license status 和 flags；reinstatement 只能在指定 customer service center 按预约办理。续期、补证和 ID renewal 有线上入口，但是否可用由邀请函、档案地址、证件状态、年龄和 record flags 决定；首次证件、外州转入、身份或姓名核验要按现场路线准备。',
    editorNotes: [
      '建立 Louisiana domicile 后，外州驾照必须在 30 天内转入；新证签发时原外州驾照会被收回并销毁。',
      '外州转入要带最近签发州的 photo license；没有原卡时，California、Connecticut、Illinois、Kentucky、Maine、Nevada、Oklahoma 或 West Virginia 的申请人还要提供含姓名、出生日期和驾照号码的 official driving record。',
      '有效 non-commercial 外州驾照转入与 Louisiana Class E / D 对等类别时通常只做 vision test；从等同 Class E 转为 Class D 仍要通过 written exam。',
      '外州转入材料至少包括原驾照、一份 primary、一份 secondary 和 Louisiana residency；材料必须是 original 或 issuing agency certified copy，姓名不一致时要先解决 supporting documents。',
      '外国驾照普通互惠名单当前只有 Germany、Switzerland、Taiwan 和 South Korea；这些路线可免 Louisiana driver education、knowledge 和 road skills tests，但仍要通过 vision 并满足身份材料要求。',
      'Taiwan 互惠路线的 notarized translation 要由 Taipei Economic and Cultural Office in Houston 认证，或由 Louisiana OMV 接受的译者提供。',
      '中国大陆驾照不在当前互惠名单内；符合 Louisiana credential 身份资格的首次申请人通常要取得 TIP、完成获许可的 driver education，并通过 knowledge、vision 与 road skills tests。',
      '互惠外国驾照持有人可以保留外国驾照，但必须在持有 Louisiana 驾照期间保持该外国驾照有效；commercial Class A、B、C 不属于互惠计划。',
      'Louisiana OMV 的 transfer 页面说明访客不符合 Louisiana 驾照或 ID 资格；现行移民身份政策对 B-1、B-2 和 B-1/B-2/BCC 分别设置 no-issuance 或额外 EAD / I-797 条件，不能仅凭有效签证推断可办。',
      '非移民首次申请通常要在 I-94 或 EAD 上至少剩余 180 天；H-2A 首次申请例外为至少 60 天，续期通常要求合法居留文件至少剩余 30 天。',
      '合法居留不足六年时，non-permanent resident credential 会随最后合法居留日采用 variable expiration，并标注 Limited-Term。',
      'Louisiana REAL ID 是可选项；有效 passport 等 TSA 接受证件可替代州 REAL ID 用于国内航班，而国际旅行仍需要 passport。',
      'REAL ID-compliant card 的卡面上部有金色边框白星；REAL ID 与 non-compliant Louisiana credential 的州证件费用相同。',
      '一个人只能持有一张 REAL ID credential；60 岁及以上可选的 permanent ID 只能是 Not for Federal Identification，若要 REAL ID ID card 则采用六年有效期。',
      '首次 Louisiana REAL ID 要覆盖 identity、lawful status、date of birth、assigned SSN 和两份 principal residence；非公民证件姓名必须与原始 immigration document 精确一致。',
      'REAL ID 的两份 residence documents 必须是 original、显示本人姓名和 Louisiana street address，并来自 separate / independent sources。',
      '普通 non-REAL-ID 驾照或 ID 的 residency policy 至少要求一份原始 Louisiana 地址文件；不要把 REAL ID 的两份规则机械套到每个普通业务。',
      '与申请人同住的 parent、guardian、spouse 或 immediate family member 的 Louisiana credential 可作为地址材料，但该 family member 必须本人到场。',
      '有 SSN 的申请人必须提供号码，REAL ID 可口头提供并由 SSOLV 核验；没有获分配 SSN 且身份类别不具资格时，要带 SSA 出具的 ineligible 或 not issued letter。',
      '姓名变更要先在 Social Security Administration 更新，Louisiana 政策提示数据库通常约 24 小时后才反映；之后用有效 credential 和 original / certified name-change record 到 OMV。',
      '所有首次 Class E 申请人在参加 knowledge test、驾驶教学或 road skills test 前都要先从 OMV 取得 TIP；TIP 最早可在 14 岁签发，但只允许在驾驶学校教练陪同的教学和考试场景使用。',
      '15 岁起可签发 learner permit；15 或 16 岁申请人通常要持 permit 至少 180 天，17 岁及以上可按年龄和考试条件进入 learner 或 full-license 路线。',
      '14 岁 9 个月至 17 岁的 driver education 为 30 小时课堂加 8 小时 behind-the-wheel；18 岁及以上可选 6 小时课堂加 8 小时驾驶的 pre-licensing course，或完整 38 小时课程。',
      'Class D、Class E 和 motorcycle 自动笔试系统列有 Cantonese，但没有列 Mandarin；英语读写困难者可带 interpreter 协助这些非 CDL knowledge tests，CDL 不允许 interpreter。',
      'OMV 当前 alternate-language driving-school 清单列出 Spanish、French、German、Arabic 和 Vietnamese，没有标出中文课程；笔试有 Cantonese 不等于 driver education 课程也有中文。',
      'Class E knowledge test 及格线是 80%；未通过时如当天时间允许可再考一次，作弊则普通驾照、chauffeur 和 motorcycle 考试至少等待 30 天。',
      'Class E road skills test 可由 OMV 或 approved third-party tester 办理，80 / 100 及格；OMV 不收考试费，third-party tester 可自行收费。',
      'OMV road test 自备车辆必须有效注册、车牌匹配、保险覆盖当天且申请人不是 excluded driver；车辆还要通过灯光、轮胎、车门、安全带、后视镜等现场检查。',
      '驾照可在到期前 180 天续期，前提是没有 suspension / revocation；OMV 网页称合格申请人约提前 100 天收到 invitation，mail / internet policy 则写 90 天，因此不要依赖邀请函才开始准备。',
      'mail / internet renewal 要先收到 invitation 且申请人是 Louisiana resident Class D / E；70 岁及以上、上次已按 mail renewal、证件过期至少 12 个月、record 有 flags、资料或身体状况变化、nonresident alien 等被 policy 列为不得 mail renewal 的情形，线上资格仍以系统 Check Renew Eligibility 为准。',
      '线上或邮寄证件最长可能需要 30 天寄达；满 30 天仍未收到且尚在交易后 60 天内，可带 receipt 到 OMV 申请免费 duplicate。档案地址错误时要现场改地址并付 duplicate fee，原线上交易不退款。',
      '线上 duplicate 只面向当前住在 Louisiana、credential 仍有效且 record 无阻止签发 flag 的人；每天最多一次，线上不能改地址，未满 18 岁不能线上补 driver license，未满 17 岁不能线上补 ID。',
      '当前 2026-07-01 fee policy 把六年 Class E 总额列为 $32.25 至 $40.25、70 岁及以上为 $18.75 至 $26.75、六年证 duplicate / address change 为 $17 至 $25，区间取决于 handling fee。',
      '现行 fee policy 对驾照过期超过 10 个 calendar days 加收 $15 delinquent fee；较旧的 2025 mail-renewal policy 仍写 $10，付款前应以 OMV checkout 和最新 fee policy 为准。',
    ],
    documentHighlights: [
      '普通首次 credential 按一份 primary 加两份 secondary，或两份 primary 的组合准备，并另带 Louisiana residency；已有可清晰识别的 Louisiana photo credential 时可能适用简化组合。',
      '所有 primary / secondary 文件须为 original 或 issuing agency certified copy；普通 photocopy 不接受，primary 与 secondary 姓名原则上须一致。',
      '外州转入带最近签发州的 photo license、一份 primary、一份 secondary 和一份 Louisiana residency；原卡遗失时按州别准备 official driving record。',
      'REAL ID 按 identity、lawful status、date of birth、assigned SSN 和两份独立来源的 Louisiana principal-residence 原件分组。',
      '常见 identity / lawful-status 文件包括有效美国 passport、州签发 original / certified birth certificate、naturalization / citizenship certificate，或按身份表组合的 passport、I-94、I-797、I-20、DS-2019、I-551、I-766 等。',
      '有 SSN 时可口头提供号码，建议带 Social Security card、W-2、SSA-1099、non-SSA 1099 或 pay stub 作为核验备用；不具 SSN 资格者带 SSA letter。',
      'residency 文件要显示本人姓名和 Louisiana street address；REAL ID 两份必须来自独立来源，例如 utility、bank、employer、insurance、tax、school、mortgage、lease 或 USCIS 文件。',
      '使用同住 immediate family member 的 Louisiana credential 作地址证明时，该 family member 要带有效证件本人到场。',
      '姓名变化先更新 SSA，再带 original / certified marriage certificate、court order、divorce decree 或其他适用的完整 legal record。',
      '中国大陆等非互惠外国驾照路线带 passport、当前 immigration / legal-presence documents、外国驾照和必要翻译，并预留 TIP、driver education 和全套考试。',
      '首次驾驶人先用身份证明、residency 和 SSN / SSA letter 取得 TIP；未满 18 岁另带 custodial parent / guardian 的身份证明和 custody documents。',
      'driver-education 结业后保留 Certificate of Successful Completion；TIP 转 learner permit 或 full license 时向 OMV 交回 TIP 和结业证明。',
      'road test 带有效 registration、匹配车牌和当天有效 liability-insurance proof，确认保险没有把申请人列为 excluded driver。',
      '现场续期带 proper identification、Louisiana residency、SSN、适用的 legal presence、车辆在本人名下时的 current liability insurance，并准备 vision test。',
      '线上续期或补证先确认 credential 上的地址完全正确、邀请或系统资格有效，并保存 receipt；线上 duplicate 不提供地址变更。',
    ],
    commonMistakes: [
      '建立 domicile 后继续等待外州驾照到期，错过 Louisiana 的 30 天转入期限。',
      '外州转入只带旧驾照，没有准备 primary、secondary 和 Louisiana residency 原件。',
      '原外州卡遗失时只拿手机照片，忽略部分州必须出具 official driving record。',
      '把中国大陆驾照套用 Taiwan 互惠，误以为可以免 driver education、knowledge 和 road tests。',
      '把有效 visitor visa 当成 Louisiana credential 资格，没有先按当前 immigration status 表确认。',
      '看到自动笔试有 Cantonese 就假定有 Mandarin，或误以为驾驶学校也一定提供中文课程。',
      '需要口译却报考 CDL；Louisiana 普通 Class D / E / motorcycle 可用 interpreter，但 CDL 明确不允许。',
      '第一次去驾驶学校或参加 knowledge / road test 前没有先取得 TIP。',
      '把 14 岁可取得 TIP 理解成可以由家人陪同上路；TIP 只用于 licensed driving-school instructor 陪同的教学和考试。',
      'REAL ID 两份地址证明来自同一机构，或文件只显示 P.O. Box、没有本人 Louisiana street address。',
      '把普通 credential 的一份 residency 要求和 REAL ID 的两份独立来源要求混在一起。',
      'REAL ID 材料带成普通 photocopy，或非公民证件姓名与原始 immigration document 不完全一致。',
      '姓名变更后尚未更新 SSA，或更新后未等数据库同步就立即去 OMV。',
      '收到 renewal invitation 就默认可以线上完成，没有检查 flags、证件状态、年龄、地址和资料变化。',
      '线上补证时顺便尝试改地址；系统会寄到 master record 地址，地址变化必须走现场路线。',
      '证件 90 天内到期仍办 duplicate，忽略此时必须按 renewal 处理。',
      'road test 使用未保险、registration / plate 不匹配、申请人被保险排除或安全设备不合格的车辆。',
      '只看 $32.25 基础总额，没有预留最高 $8 handling fee、duplicate fee 或过期超过 10 天的 delinquent fee。',
      '邮寄未满 30 天就重复付费，或超过交易后 60 天才带 receipt 申请未收到证件的免费 replacement。',
    ],
    recommendedSteps: [
      '先判断自己属于首次驾驶人、美国外州转入、外国驾照、renewal、duplicate、name / address change、ID card 还是 first-time REAL ID。',
      '建立 Louisiana domicile 后在 30 天期限内安排外州转入；先确认原驾照是否在手以及是否来自需要 driving record 的州。',
      '中国大陆或其他非互惠外国驾照持有人先用 immigration-status policy 确认资格，再按 TIP、Louisiana driver education、knowledge、vision 和 road-test 路线安排。',
      'Germany、Switzerland、South Korea 或 Taiwan 驾照持有人核对有效驾照、身份文件、vision 和翻译要求，再使用 reciprocity 路线。',
      '需要中文笔试时向办理点确认 K2D 的 Cantonese 版本；需要 Mandarin 或其他语言时提前安排合格 interpreter，且不要把该规则套到 CDL。',
      '首次驾驶人先到 OMV 取得 TIP，再报名 licensed driving school；未满 18 岁与成人按 38 小时或 14 小时课程分别准备。',
      '先决定是否需要 REAL ID；若已有 passport 等 TSA 接受证件，可以比较 non-compliant credential 的使用范围后再决定。',
      'REAL ID 材料按 identity / lawful status / date of birth、SSN、两份 independent residence 和 name-change chain 分组，只带 original / certified copy。',
      '普通 credential 也要按 identification policy 准备 primary / secondary 组合和至少一份 Louisiana residency，不要只带 REAL ID checklist。',
      '续期前检查 license status、record flags、档案地址和 180 天窗口；只有收到 invitation 且系统判定合格时才走 mail / internet / LA Wallet。',
      '补证先看证件是否仍有效、是否在 90 / 180 天续期窗口内以及地址是否正确；地址不对就直接走 field office。',
      '姓名变化先在 SSA 更新并等待至少约 24 小时，再带有效 credential 和 original / certified legal record 到 OMV。',
      'road test 前核对 registration、plate、insurance、excluded-driver 条款和车辆安全项目；比较 OMV 免费考试与 third-party tester 的自定收费。',
      '预约前查询 driver-license status；有 reinstatement 或其他 flag 时，选择明确提供对应服务的 customer service center。',
      '付款前查最新 fee policy 和 checkout 总额；完成后保存 receipt，并在 30 至 60 天未收到实体卡窗口内及时到 OMV 处理。',
    ],
    actionLinks: [
      {
        label: 'Louisiana REAL ID',
        url: 'https://expresslane.la.gov/omv/drivers/personal-driver-s-licenses/real-id/',
        description: '核对星标、材料、SSOLV、两份独立地址证明和替代证件。',
      },
      {
        label: 'New Licenses and TIP',
        url: 'https://expresslane.la.gov/omv/drivers/personal-driver-s-licenses/new-licenses/',
        description: '首次驾照、TIP、learner permit、考试和 Class E 费用入口。',
      },
      {
        label: 'Louisiana License Transfers',
        url: 'https://expresslane.la.gov/omv/drivers/personal-driver-s-licenses/license-transfers/',
        description: '核对 30 天期限、美国外州转入、外国驾照和 reciprocity。',
      },
      {
        label: 'Immigrant and Non-Immigrant Issuance',
        url: 'https://public.powerdms.com/ladpsc/documents/368156',
        description: '按当前身份类别核对 legal presence、剩余期限、SSN 和 Limited-Term。',
      },
      {
        label: 'Knowledge Examinations and Languages',
        url: 'https://public.powerdms.com/ladpsc/documents/368264',
        description: '查看 Cantonese、interpreter、80% 及格线和重考规则。',
      },
      {
        label: 'Driver Education and Testing',
        url: 'https://expresslane.la.gov/omv/drivers/driver-s-education-information/student-parent-information/',
        description: '核对未成年与成人课程、TIP、permit 和 road skills 流程。',
      },
      {
        label: 'Louisiana License Renewal',
        url: 'https://expresslane.la.gov/omv/drivers/personal-driver-s-licenses/license-renewal/',
        description: '核对 180 天窗口、现场材料、视力、保险和线上分流。',
      },
      {
        ...
        description: '区分 duplicate、renewal、线上补证和外州 reconstructed card。',
      },
      {
        label: 'Fees and Credential Duration',
        url: 'https://public.powerdms.com/ladpsc/documents/368099',
        description: '查看 2026 费用、handling fee、过期费和证件期限。',
      },
      {
        label: 'Appointment - Know Before You Go',
        url: 'https://expresslane.la.gov/omv/resources/appointment-know-before-you-go/',
        description: '预约前检查 status、flags、reinstatement 地点和线上资格。',
      },
      {
        label: 'Louisiana OMV Online Services',
        url: 'https://expresslane.la.gov/omv/online-services/',
        description: '进入续期、补证、status、driving record 和 REAL ID checklist。',
      },
      {
        label: 'OMV Offices and Public Tag Agents',
        url: 'https://offices.omv.la.gov/',
        description: '按地点和服务类型查 customer service center 或 Public Tag Agent。',
      },
      {
        label: 'TSA Acceptable Identification',
        url: 'https://www.tsa.gov/travel/security-screening/identification',
        description: '核对国内航班可接受的 REAL ID、passport 和其他证件。',
      },
    ],
    sources: [
      {
        label: 'Louisiana OMV Drivers',
        url: 'https://expresslane.la.gov/omv/drivers/',
        note: 'Louisiana OMV 驾照、ID、driver education、reinstatement 与线上服务总入口。',
      },
      {
        label: 'Louisiana OMV REAL ID',
        url: 'https://expresslane.la.gov/omv/drivers/personal-driver-s-licenses/real-id/',
        note: '联邦用途、卡面星标、州内费用、身份、SSN 和两份独立 residence 原件。',
      },
      {
        label: 'Louisiana REAL ID Issuance Policy',
        url: 'https://public.powerdms.com/ladpsc/documents/368157',
        note: '2026-04 修订的 REAL ID、非公民姓名、one-credential 和 permanent-ID 边界。',
      },
      {
        label: 'Louisiana Identification Requirements',
        url: 'https://public.powerdms.com/ladpsc/documents/368154',
        note: '2026-07 修订的 primary / secondary 组合、外州转入和 original / certified-copy 要求。',
      },
      {
        label: 'Louisiana Residency Requirements',
        url: 'https://public.powerdms.com/ladpsc/documents/368113',
        note: '普通 credential 的一份原始地址材料、可接受文件和 family-member 到场规则。',
      },
      {
        label: 'Louisiana Immigrant and Non-Immigrant Issuance',
        url: 'https://public.powerdms.com/ladpsc/documents/368156',
        note: '2026-03 修订的 legal-presence、身份类别、剩余期限、考试与 Limited-Term 规则。',
      },
      {
        label: 'Louisiana Foreign-License Reciprocity',
        url: 'https://public.powerdms.com/ladpsc/documents/368276',
        note: 'Germany、Switzerland、Taiwan、South Korea、H-2A 特例和 vision / translation 要求。',
      },
      {
        label: 'Louisiana OMV License Renewal',
        url: 'https://expresslane.la.gov/omv/drivers/personal-driver-s-licenses/license-renewal/',
        note: '180 天窗口、现场 identification、SSN、vision、residency 和 insurance。',
      },
      {
        label: 'Louisiana Renewal Policy',
        url: 'https://public.powerdms.com/ladpsc/documents/368114',
        note: '2025-11 修订的 eligibility、non-immigrant 30 天和现场续期材料。',
      },
      {
        label: 'Louisiana Mail or Internet Renewal Policy',
        url: 'https://public.powerdms.com/ladpsc/documents/368151',
        note: 'invitation、线上 / 邮寄排除项、LA Wallet、地址和 30 至 60 天未收卡处理。',
      },
      {
        label: 'Louisiana OMV License Transfers',
        url: 'https://expresslane.la.gov/omv/drivers/personal-driver-s-licenses/license-transfers/',
        note: '30 天转入、原卡、视力、foreign-license tests 和互惠概览。',
      },
      {
        label: 'Louisiana OMV Duplicate / Replacement Cards',
        url: 'https://expresslane.la.gov/omv/drivers/personal-driver-s-licenses/duplicate-replacement-reconstructed-cards/',
        note: 'duplicate / renewal 时间窗、photo retrieve、out-of-state reconstructed card 和排除项。',
      },
      {
        label: 'Louisiana Online Duplicate Policy',
        url: 'https://public.powerdms.com/LADPSC/documents/933694',
        note: '2025-10 修订的线上资格、未成年人、一天一次、地址和邮寄规则。',
      },
      {
        label: 'Louisiana New Licenses',
        url: 'https://expresslane.la.gov/omv/drivers/personal-driver-s-licenses/new-licenses/',
        note: 'TIP、learner / full license、translator、vision 和 Class E 费用。',
      },
      {
        label: 'Louisiana Permits',
        url: 'https://expresslane.la.gov/omv/drivers/personal-driver-s-licenses/permits/',
        note: 'TIP、graduated licensing、180 天、tests、minor documents 和结业证明。',
      },
      {
        label: 'Louisiana Driver Education and Testing',
        url: 'https://expresslane.la.gov/omv/drivers/driver-s-education-information/student-parent-information/',
        note: '30+8 / 6+8 小时课程、TIP、80% tests 和第三方考试。',
      },
      {
        label: 'Louisiana Knowledge Examination Policy',
        url: 'https://public.powerdms.com/ladpsc/documents/368264',
        note: '2026-01 修订的 Cantonese、interpreter、80% 及格线和重考规则。',
      },
      {
        label: 'Louisiana Alternate-Language Driving Schools',
        url: 'https://expresslane.la.gov/omv/drivers/driver-s-education-information/list-of-driving-schools-alternate-languages/',
        note: '当前官网列出的 Spanish、French、German、Arabic 和 Vietnamese 课程地点。',
      },
      {
        label: 'Louisiana Road Skills Test Policy',
        url: 'https://public.powerdms.com/ladpsc/documents/368267',
        note: 'OMV / third-party route、80 分、retest、考试费和车辆资格。',
      },
      {
        label: 'Louisiana Road-Test Vehicle Inspection',
        url: 'https://public.powerdms.com/ladpsc/documents/368265',
        note: '2026-06 修订的 insurance、registration、plate、emissions 和安全项目。',
      },
      {
        label: 'Louisiana Name Change Policy',
        url: 'https://public.powerdms.com/ladpsc/documents/368302',
        note: 'SSA 先更新、约 24 小时、有效 credential、legal records 和费用。',
      },
      {
        label: 'Louisiana Social Security Verification',
        url: 'https://public.powerdms.com/ladpsc/documents/368330',
        note: '2026-07 修订的 assigned SSN、SSA ineligible letter 和 SSOLV 姓名核验。',
      },
      {
        label: 'Louisiana Fees and Credential Duration',
        url: 'https://public.powerdms.com/ladpsc/documents/368099',
        note: '2026-07 修订的 Class E、ID、duplicate、handling 和 delinquent fees。',
      },
      {
        label: 'Louisiana Appointment - Know Before You Go',
        url: 'https://expresslane.la.gov/omv/resources/appointment-know-before-you-go/',
        note: 'status、flags、reinstatement、线上服务和预约入口。',
      },
      {
        label: 'Louisiana OMV Online Services',
        url: 'https://expresslane.la.gov/omv/online-services/',
        note: 'driver renewal、duplicate、status、records、ID renewal 和 REAL ID checklist。',
      },
      {
        label: 'Louisiana OMV Offices and Public Tag Agents',
        url: 'https://offices.omv.la.gov/',
        note: '按地点、营业时间和服务类型查现场入口。',
      },
      {
        label: 'TSA Acceptable Identification',
        url: 'https://www.tsa.gov/travel/security-screening/identification',
        note: '国内航班可接受身份证件与 REAL ID 替代证件。',
      },
    ],
    relatedTopicSlugs: [
      'real-id-basics',
  ...
  },
  {
    ...
    agencyUrl: 'https://www.dfa.arkansas.gov/office/driver-services/',
    publishedAt: '2026-07-13',
    modifiedAt: '2026-07-19',
    reviewedAt: '2026-07-19',
    summary:
      'Arkansas 驾照流程分成两站：Arkansas State Police 负责 knowledge / skills test，Department of Finance and Administration 的 Revenue Office 负责签发驾照或 ID。成为 Arkansas 居民后仍要在州内开车的人，应在 30 个日历日内取得 Arkansas 驾照；只是非居民但已在州内实际停留 6 个月的人也进入州驾照要求。',
    realIdSummary:
      'Arkansas REAL ID 可以签发为 driver license、state ID 或 CDL，DFA 说明升级按同类证件费用办理。当前打印清单要求一份 legal presence、一份 identity、一份 SSN 证明和两份 Arkansas residency；大多数居住文件须在 6 个月内，但清单对税表、选民登记等另有期限。SSN 证明存在官方表述差异：REAL ID 简介写 Social Security Card must be provided，当前打印清单和 DSMV FAQ 同时接受 DD214；使用 DD214 的申请人应携带打印清单并在到场前向 Revenue Office 确认。',
    licenseSummary:
      '新居民转入时要带有效 hard-copy 外州驾照，现行手册要求其过期不得超过 30 个日历日；签发 Arkansas 驾照或 ID 会取消其他州签发的驾照或 ID。持外国驾照的人不要默认可以直接换证：2026 Arkansas Driver License Study Guide 只列 Manitoba、Germany、France、Taiwan 和 South Korea 为免试互惠地区，中国大陆不在清单中。首次申请或不在互惠清单内的外国驾照持有人，应先按 State Police 流程准备考试，再到 Revenue Office 完成签发。',
    appointmentNote:
      'State Police 考试预约和 DFA Revenue Office 办事预约不是同一个系统。State Police 表示考试预约可保证日期和时间；非美国公民持移民文件预约考试时应选择对应 appointment type，而且并非每个考点都提供该加长时段。DFA 的 REAL ID 简介里“recommended, not required”只对应旧的 April 26 Saturday 活动，不能据此推定所有办公室、所有日期都长期接受 walk-in。',
    editorNotes: [
      'Arkansas State Police 现行手册要求新居民在成为 resident 后 30 个日历日内换证，并把非居民实际停留 6 个月列为另一条触发线；全日制或交换学生只有在学费规则下仍被视为 nonresident 时才属于手册列出的学生例外。',
      '首次笔试申请人不能只拿 DFA 的签发材料去考场；State Police 的 18 岁以上 1-2-3 checklist 要求 two primary documents，或 one primary plus one secondary document，姓名不一致时还要带 marriage license、adoption decree、divorce decree 等连接文件。',
      'State Police 当前说明称全州各县都有 driver license testing，预约可以保证考试日期和时间；2026 手册还提醒并非每个考点都提供 immigration-documents appointment feature。',
      '21 岁及以上 Class D 当前费用为 40 美元、有效 8 年，可从到期前 90 天开始续期；70 岁申请人可选 20 美元四年或 40 美元八年。普通续期如不改名且不升级 REAL ID，DFA 的到场清单称无需额外材料，但仍要做 vision exam 和拍照。',
      'DFA FAQ 表示过期 Class D 续期不需要重新考试；这一结论不应套用到 CDL 或其他特殊资格。',
      '线上地址更新免费且不会自动签发新卡；需要显示新地址的 replacement，可在线购买或到 Revenue Office 办理。DFA 线上服务预计 replacement 通过邮寄在 3 至 5 个工作日收到。',
      'Arkansas REAL ID 官方简介要求 Social Security Card；当前打印清单和 DSMV FAQ 同时列出 DD214。两项当前官方材料有差异，使用 DD214 时应先向具体 Revenue Office 确认。',
    ],
    documentHighlights: [
      'Legal presence 带一份原件或 certified document，例如 U.S. passport / passport card、U.S. birth certificate、naturalization / citizenship certificate，或适用的 foreign passport + valid U.S. visa + I-94、I-551、I-766；birth card 和 hospital birth certificate 不接受。',
      'Identity 带一份当前清单接受的文件，例如 current DL/ID、school ID、court order、近一年 tax return、marriage certificate、military ID、certified school record、Arkansas title / registration 或政府签发 ID。若该 identity 文件显示住宅地址，可同时算一份 residency proof。',
      'SSN 组按当前打印清单带 Social Security Card 或 DD214。REAL ID 简介仍只写 Social Security Card，因此使用 DD214 时不要只看简介，先向办理办公室确认。',
      'Arkansas residency 带两份；通常须在 6 个月内，可用 utility bill、lease / mortgage、bank statement、telephone / cable / internet bill、current insurance、pay slip、medical bill 等，税表须少于一年，voter registration 须少于四年。',
      'P.O. Box 或 business address 不接受为住宅地址。DFA 清单说明从 online account 打印的文件可能接受，但最终仍须符合文件类型和日期要求。',
      '未成年人可使用父母的 residency documents 并附 birth certificate；配偶可使用另一方的 residency documents 并附 marriage certificate。',
      '姓名、出生日期或 SSN 有变化时，要用 court order、marriage certificate、divorce decree、adoption document 等连接旧信息与新信息；Affidavit of Legal Name Change 只标注用于 linking documents 缺失的情况。',
      '外州转入还要带 hard-copy 外州驾照或 ID；Arkansas 签发新驾照或 ID 后，其他州签发的同类证件会被取消。',
    ],
    commonMistakes: [
      '把 State Police 考试点和 DFA Revenue Office 当成同一个地方，到了 Revenue Office 才发现首次申请还没完成考试。',
      '只按旧搜索摘要准备 SSN 文件；当前打印清单列 Social Security Card 或 DD214，没有列 W-2、1099 或 pay stub。',
      '只带一份 residency proof，或带超过当前期限的账单。',
      '用 P.O. Box 或 business address 当住宅地址。',
      '持中国大陆驾照就认为可以直接换证；2026 互惠免试清单没有列 China mainland。',
      '把旧 April 26 Saturday REAL ID 活动的“预约建议但非必需”当成永久、全州、所有业务通用规则。',
      '线上免费更新地址后，以为 DFA 会自动寄新卡；免费服务只更新记录，需要新卡还要另办 replacement。',
      '身份、SSN 或外州驾照上的姓名不同，却没有携带完整姓名连接文件。',
    ],
    recommendedSteps: [
      '先判断业务属于首次考试、新居民转入、外国驾照、普通续期、REAL ID 升级、replacement、name change 还是 address-only update。',
      '新居民在成为 Arkansas resident 后 30 个日历日内开始换证；带 hard-copy 外州驾照，并确认其是否已过期超过 30 天。',
      '需要考试时先打开 State Police Driver Examination，下载 June 2026 Study Guide 和对应 1-2-3 checklist，再预约 knowledge / skills test；非美国公民选择 immigration-documents appointment type。',
      '申请 REAL ID 时按 legal presence、identity、SSN、two residency proofs 四组整理，并使用当前打印清单逐项核对日期和原件要求。',
      '有姓名差异时带完整 linking documents；如果确实缺失，再查看 DFA 的 Affidavit of Legal Name Change 是否适用。',
      '在 Revenue Office locations 查具体地点和服务，再通过 DFA appointment 系统确认可约时段；不要依赖旧 Saturday 活动的 walk-in 说明。',
      'replacement、address update 或 application pre-registration 先看 DFA Online Driver Services。地址更新免费但不发新卡，线上 replacement 预计邮寄 3 至 5 个工作日。',
      '普通续期先核对 NCL 的费用、有效期和 90 天窗口；不改名且不升级 REAL ID 时，按 DFA 当前到场清单准备 vision exam 和拍照。',
    ],
    actionLinks: [
      {
        label: 'Arkansas REAL ID',
        url: 'https://www.dfa.arkansas.gov/real-id/',
        description: 'REAL ID 用途、材料概览、Real ID Quiz、Revenue Office 和预约入口。',
      },
      {
        label: 'REAL ID Printable Document Checklist',
        url: 'https://www.dfa.arkansas.gov/wp-content/uploads/Proof_ofLegalPresence_08142025.pdf',
        description: '当前 legal presence、identity、SSN、residency 和姓名变更打印清单。',
      },
      {
        label: 'Do You Have What You Need?',
        url: 'https://www.dfa.arkansas.gov/do-you-have-what-you-need/',
        description: '首次签发、续期、REAL ID 和 Revenue Office 到场材料。',
      },
      {
        label: 'Arkansas State Police Driver Examination',
        url: 'https://dps.arkansas.gov/law-enforcement/arkansas-state-police/services-programs/driver-examination/',
        description: '考试预约、知识与路考 checklist、官方练习和考点入口。',
      },
      {
        label: 'Arkansas Driver License Study Guide',
        url: 'https://dps.arkansas.gov/wp-content/uploads/Arkansas-DL-Manual-English.pdf',
        description: 'June 2026 驾驶手册、新居民期限、互惠免试地区和考试材料。',
      },
      {
        label: 'DFA Online Driver Services',
        url: 'https://www.dfa.arkansas.gov/online-services/drivers/',
        description: '补证、改址、预登记、预约和其他驾驶员线上服务入口。',
      },
      {
        label: 'Revenue Office Locations',
        url: 'https://www.dfa.arkansas.gov/all-county-offices/?_sft_office-location-category=revenue-office',
        description: '查找 Arkansas Revenue Office 地址和当前办公室信息。',
      },
      {
        label: 'Non-Commercial License Information',
        url: 'https://www.dfa.arkansas.gov/office/driver-services/licenses-ids-permits/non-commercial-information-ncl/',
        description: 'Class D 当前费用、有效期、续期窗口、endorsement 和 restriction。',
      },
      {
        label: 'Driver Services Forms',
        url: 'https://www.dfa.arkansas.gov/office/driver-services/driver-services-forms/',
        description: '改名、改址、legal presence 和其他 Driver Services 表格。',
      },
    ],
    sources: [
      {
      ...
      {
        label: 'Arkansas DFA REAL ID Printable Document Checklist',
        url: 'https://www.dfa.arkansas.gov/wp-content/uploads/Proof_ofLegalPresence_08142025.pdf',
      },
      {
        label: 'Arkansas DFA Do You Have What You Need?',
        url: 'https://www.dfa.arkansas.gov/do-you-have-what-you-need/',
      },
      {
        label: 'Arkansas DFA Driver Services',
        url: 'https://www.dfa.arkansas.gov/office/driver-services/',
      },
      {
        label: 'Arkansas DFA Licenses, IDs and Permits',
        url: 'https://www.dfa.arkansas.gov/office/driver-services/licenses-ids-permits/',
      },
      {
        label: 'Arkansas DFA Non-Commercial License Information',
        url: 'https://www.dfa.arkansas.gov/office/driver-services/licenses-ids-permits/non-commercial-information-ncl/',
      },
      {
        label: 'Arkansas DFA DSMV FAQs',
        url: 'https://www.dfa.arkansas.gov/office/motor-vehicle/faqs-for-dsmv/',
      },
      {
      ...
      {
        label: 'Arkansas DFA Revenue Office Locations',
        url: 'https://www.dfa.arkansas.gov/all-county-offices/?_sft_office-location-category=revenue-office',
      },
      {
        label: 'Arkansas DFA Driver Services Forms',
        url: 'https://www.dfa.arkansas.gov/office/driver-services/driver-services-forms/',
      },
      {
        label: 'Arkansas DFA Change of Address Form',
        url: 'https://www.dfa.arkansas.gov/wp-content/uploads/Address_Change_with_Voter_Information.pdf',
      },
      {
        label: 'Arkansas DFA Affidavit of Legal Name Change',
        url: 'https://www.dfa.arkansas.gov/wp-content/uploads/Affidavit_of_Legal_Name_Change_2019.pdf',
      },
      {
        label: 'Arkansas State Police Driver Examination',
        url: 'https://dps.arkansas.gov/law-enforcement/arkansas-state-police/services-programs/driver-examination/',
      ...
      {
        label: 'Arkansas State Police Driver License Study Guide, June 2026',
        url: 'https://dps.arkansas.gov/wp-content/uploads/Arkansas-DL-Manual-English.pdf',
      },
    ],
    relatedTopicSlugs: [
  ...
  },
  {
    ...
    reviewedAt: '2026-07-21',
    summary:
      '新墨西哥州 MVD 提供带金色星标的 REAL ID 和 Standard Driver License / ID。先按用途选证件，再区分首次申领、美国外州转入、外国驾照、续期、补证或资料变更；首次签发与首次升级 REAL ID 按现场路线准备。',
    realIdSummary:
      'New Mexico REAL ID 要各准备一份 Lawful Identity and Age、Identification Number，以及两份 New Mexico Residency 证明。材料须为原件或签发机关认证副本；普通复印件、公证复印件和非认证副本不接受，法律身份和识别号码还要通过电子核验。',
    licenseSummary:
      'Standard Driver License / ID 的基础文件路径是一份 identity and age 与两份 New Mexico residency，MVD 明确说明不需要 SSN 或指纹；无法证明 lawful status 的申请人只能申请 Standard。两类驾照都能用于驾驶，但 Standard 不能作为 REAL ID 联邦身份证件。',
    appointmentNote:
      '州营 MVD field office 当前要求所有业务预约，municipal office 则可能接受 walk-in、预约或两者兼有，并可能另收 $5 至 $50 的本地 transaction fee。先查具体地点和停业公告；符合资格的续期或补证再从 MyMVD Online Services 开始。',
    editorNotes: [
      '建立 New Mexico residency 后，MVD 要求交回其他州驾照并申请本州证件；官方没有在该说明中给出统一的换证天数。',
      '当前有效美国外州驾照可免 written 和 road test，但仍要通过 eye exam；外州转入另收一次性 $15 DWI records check fee。',
      '持当前外国驾照也要通过 eye exam，且所有 out-of-country license 申请人都要参加 written test。MVD 程序手册只在可核验外文驾照或提供 certified translation 的条件下留下免 road test 的可能，因此中国驾照持有人不要预设路考必然免除。',
      '非商业知识考试提供 English、Spanish、Tagalog、Italian、German、French、Vietnamese 和 Chinese，Class D / M 笔试达到 70% 才通过。',
      '知识考试每周最多两次，可以同一天考两次；第三次未通过后，MVD 程序说明要求从首次考试日起等待六个月。',
      'MVD 当前 Driver Licenses 页面写驾照过期一年或以上要笔试，而 Apply for a New Driving Credential 页面和程序手册写五年或以上；临界情况应在预约前向具体 field office 确认。',
      '首次 New Mexico licensee 年龄 18 至 24 岁须提交 None for the Road DWI awareness class 完成证明；25 岁以上且曾有 DWI conviction 的首次申请人也要提交合格课程证明。',
      '首次驾照、续期和补证都会先签发 temporary license，永久卡中央制作后寄到申请时登记的 mailing address。已有外州驾照或 New Mexico ID 会打孔，与 temporary license 一起使用时最多可作为 45 天的身份证明。',
      '普通驾照费用当前为四年 $18、八年 $34；79 岁及以上每年续期但免 renewal fee，76 至 78 岁的期限和费用可能按到 79 岁前剩余年数调整。',
      '续期最早可在到期前 90 天办理，MVD 还允许在过期后最多两年内通过线上续期流程；提前超过 90 天办理会按 replacement 而不是 renewal 处理。',
      '地址变化后 10 天内要通知 MVD；只更新系统记录可在线、传真或邮寄，若要把新地址印到卡上则须到 field office 拍新照片并支付 license fee。',
      'REAL ID 的两份 residency 文件必须显示 New Mexico physical residential address，HC 和 P.O. Box 不接受；同一类别可以，但不能由同一实体出具。',
      'utility bill、bank / credit-card statement、pay stub 和学校文件通常须在 60 天内，insurance bill / card / binder 须在六个月内；租约、购房协议和政府居住证明须保持当前有效。',
      '非英文材料要附完整英文翻译并由译者认证；只做 abstract translation 不够，翻译件还要覆盖除印章本身外的全部文字。',
      '用于 REAL ID 的 lawful status 与 identification number 会分别通过 SAVE、USPVS 或 SSOLV 等系统核验，现场提交文件不代表一定能当场通过。',
      '姓名与 identity 文件不一致时，要用 marriage certificate、divorce decree、adoption record 或 court order 串起每一次变化；改名业务本身也要求原件或认证副本。',
      '路考由申请人自备与申请 class 相符、已登记、已投保且车况合格的车辆，并携带 registration 与 current insurance proof。',
      '州营 office 采用预约制，预约最多可提前 30 天；不同地点并非都提供相同 appointment type，迟到超过 10 分钟可能被取消。',
    ],
    accessStatus: {
    ...
    documentHighlights: [
      ...
      'Identification Number 文件必须显示完整号码；只露出末四位的工资单或税表不符合 REAL ID 清单。',
      'New Mexico residency 准备两份，均须显示本人姓名与相同的 current physical residential address；HC 和 P.O. Box 不能替代实体住址。',
      '两份居住材料可以属于同一类别，但不能来自同一 entity，例如同一家公司的连续两个月账单不能算两份独立证明。',
      'utility、bank / credit-card statement、pay stub 与学校文件通常限 60 天内，insurance bill / card / binder 限六个月内；租约、购房协议及政府文件要保持当前有效。',
      '全部 REAL ID 文件须为原件或签发机关认证副本；photocopy、notarized photocopy 和 non-certified copy 不接受。',
      '当前姓名与 identity document 不一致时，准备 marriage、divorce、adoption 或 court records 形成连续 linking-document chain。',
      '非英文文件须附译者认证的完整英文翻译；印章的位置和存在应标注，除印章本身外的文字都要翻译。',
    ...
    commonMistakes: [
      '把 Standard license 当作国内航班或受 REAL ID 规则约束的联邦设施身份证件；驾驶资格与联邦身份用途是两件事。',
      ...
      '持中国驾照就预设 written 或 road test 都可免除；MVD 明确要求 out-of-country license 申请人参加 written test，路考豁免还受文件核验和翻译影响。',
      '临近下班才去参加 written test；MVD 说明州营 office 通常在下午 3 点后不再开始该考试。',
      '只预算州定 $18 / $34 license fee，忽略外州转入的 $15 record-check fee 或 municipal office 可能另收的 transaction fee。',
      '把 temporary license 单独当作有效身份证件；官方说明原外州 license 或 prior New Mexico ID 被打孔后，要与 temporary license 一起出示才可在最多 45 天内用于身份用途。',
      '搬家超过 10 天仍未通知 MVD，或以为在线改记录会自动寄来印有新地址的卡。',
      '18 至 24 岁首次申请时没有先完成 None for the Road，或曾有 DWI conviction 的 25 岁以上首次申请人没有准备合格课程证明。',
    ],
    recommendedSteps: [
      '先判断是否需要用 New Mexico DL / ID 处理国内航班或其他 REAL ID 联邦用途；已有 TSA 接受的护照等证件时，也可以继续选择 Standard。',
      ...
      '选择 Standard 时改用 Standard acceptable-documents PDF，不要把两套清单混用；无法证明 lawful status 的申请人按 Standard 路线准备。',
      ...
      '外州转入带当前实体驾照并预算一次性 $15 record-check fee；中国或其他外国驾照持有人至少准备 eye exam 与 written test，并向办理点确认是否还要 road test。',
      '首次申请年龄 18 至 24 岁先完成 None for the Road；需要路考时准备合格车辆、registration 和 current insurance proof。',
      '从 Maps & Locations 核对地点、服务类型与临时停业信息；州营 office 预约，municipal office 另查 walk-in 政策和附加费。',
      '符合资格的 renewal / replacement 先试 MyMVD；首次申领、首次 REAL ID、需要文件核验或要把新地址印到卡上时按现场路线。',
    ...
    actionLinks: [
      {
        ...
        description:
          'REAL ID 与 Standard license 区别、材料要求、FAQ 和 RIC 入口。',
      },
      {
      ...
      {
        label: 'Standard Acceptable Documents PDF',
        url: 'https://www.mvd.newmexico.gov/wp-content/uploads/2023/05/RevisedStandardacceptabledocs3.10.23.pdf',
        description:
          'Standard Driver License / ID 的 identity、age 与 residency 材料表。',
      },
      {
        label: 'Driver Licenses and IDs',
        url: 'https://www.mvd.newmexico.gov/nm-drivers-licenses-ids/drivers-license/',
        description: '首次申领、测试、费用和 temporary credential 总入口。',
      },
      {
        label: 'MyMVD Online Services',
        url: 'https://eservices.mvd.newmexico.gov/eTapestry/',
        description: '符合资格的驾照或 ID 续期、补证和其他在线服务。',
      },
      {
      ...
      {
        label: 'MVD Appointments',
        url: 'https://www.mvd.newmexico.gov/https-www-mvd-newmexico-gov-mvd-direct-appointments/',
        description: '州营 office 预约规则、业务类型和线上预约入口。',
      },
      {
        label: 'Maps and Locations',
        url: 'https://www.mvd.newmexico.gov/maps-and-locations/',
        description: '查找 field office、营业时间和可办理服务。',
      },
      {
        label: 'Where Is My License',
        url: 'https://www.mvd.newmexico.gov/where-is-my-license/',
        description: '办理后查询实体驾照或 ID 制作状态。',
      },
    ],
    sources: [
      {
      ...
      {
        label: 'New Mexico Standard Acceptable Documents, revised 2023-03-10',
        url: 'https://www.mvd.newmexico.gov/wp-content/uploads/2023/05/RevisedStandardacceptabledocs3.10.23.pdf',
      },
      {
      ...
      {
        label: 'New Mexico MVD Apply for a New Driving Credential',
        url: 'https://www.mvd.newmexico.gov/nm-drivers-licenses-ids/drivers-license/apply-for-a-new-driving-credential/',
      },
      {
        label: 'New Mexico MVD Non-Commercial License Procedures',
        url: 'https://www.mvd.newmexico.gov/chapter-2-non-commercial-license/',
      },
      {
        label: 'New Mexico MVD Road and Written Test Requirements',
        url: 'https://www.mvd.newmexico.gov/chapter-11-road-and-written-test-requirements/',
      },
      {
        label: 'New Mexico MVD Knowledge Examination Changes',
        url: 'https://www.mvd.newmexico.gov/knowledge-written-examination-changes/',
      },
      {
      ...
      {
        label: 'New Mexico MVD Lost or Stolen Credential',
        url: 'https://www.mvd.newmexico.gov/nm-drivers-licenses-ids/drivers-license/replace-a-lost-or-stolen-driving-credential/',
      },
      {
      ...
      {
        label: 'New Mexico MVD Name Change',
        url: 'https://www.mvd.newmexico.gov/how-do-i-change-the-name-on-my-driver-license/',
      },
      {
        label: 'New Mexico MVD Driver License Fees',
        url: 'https://www.mvd.newmexico.gov/how-much-does-a-driver-license-cost/',
      },
      {
        label: 'New Mexico MVD Appointment Rules',
        url: 'https://www.mvd.newmexico.gov/https-www-mvd-newmexico-gov-mvd-direct-appointments/',
      },
      {
        label: 'New Mexico MVD Location Events and Closings',
        url: 'https://www.mvd.newmexico.gov/location-events-and-closings/',
      },
      {
        label: 'New Mexico MVD Maps and Locations',
        url: 'https://www.mvd.newmexico.gov/maps-and-locations/',
      },
      {
        label: 'New Mexico MVD Online Services',
        url: 'https://eservices.mvd.newmexico.gov/eTapestry/',
      },
      {
        label: 'New Mexico MVD Where Is My License',
        url: 'https://www.mvd.newmexico.gov/where-is-my-license/',
      },
      {
        label: 'TSA Acceptable Identification',
  ...
  },
  {
    ...
    reviewedAt: '2026-07-21',
    summary:
      'Maine BMV 的办理路线在 2025 年 11 月后发生了重要变化：首次申请或从 standard credential 升级 REAL ID 仍要去 branch office 或 mobile unit；已经持有 Maine REAL ID 的部分 U.S. citizen 可按条件 online renewal / duplicate，或到 local AAA branch 续期。外州新居民则要在成为 Maine resident 后 30 天内到 BMV 转证，不能把 online renewal 当成 transfer。',
    realIdSummary:
      'Maine REAL ID 只能作为 driver license 或 State ID 中的一张合规证件。首次申请要本人到 branch office 或 mobile unit，准备 identity / date of birth / lawful status、SSN 或不符合 SSN 资格证明、两份带 physical address 的 Maine residence，以及完整 name-change trail；P.O. Box 不接受，文件要用未改动的原件或 issuing agency certified copy。',
    licenseSummary:
      '持美国州或加拿大省签发、当前有效或过期不超过五年的普通外州驾照者，可在 BMV office 申请 Maine Class C；要核对 legal presence、Maine residency、SSN、vision 和姓名连接文件，即使原证已经是 REAL ID 也仍有 Maine 附加材料。自 2026 年 2 月 1 日起，Class C 笔试可免费申请 professional interpreter；中文不在八种数字考试语言名单内，预约翻译可能要四周或更久。',
    appointmentNote:
      'BMV 当前提醒部分 branch 在高峰期 walk-in 等候可能超过三小时、达到容量后会限流，并可能在下午 4 点提前停止接待；appointments 每日释放。现行 online service 不能修改证件资料且只寄到 BMV 在档地址，改地址先电话、邮件或 Contact Us，改姓名、需要 vision / medical review、非 U.S. citizen、CDL、外州证件或首次 REAL ID 都应走 office 路线。',
    editorNotes: [
      'Maine 当前 REAL ID 页面写明：首次申请必须本人到 BMV branch office 或 mobile unit；从 2025 年 11 月 13 日起，已有 REAL ID 的部分申请人可 online renewal，或到 local AAA branch 续期。',
      'Maine 仍在线的 2022 REAL ID brochure 写着 online renewal 和 AAA 都不可用，这一渠道信息已经过时；材料类别仍可参考，但办理地点和线上资格应以当前 REAL ID 页面与 transaction portal 为准。',
      '现行 online REAL ID renewal / duplicate 只面向 U.S. citizen、non-commercial driver license 或 State ID、无需 vision screening、不更改资料且当前照片年龄符合 federal guidelines 的申请人。',
      '现行 online service 明确排除首次 REAL ID、外州驾照、CDL、name change、新增或变化的 medical condition、取消 corrective-lens restriction、非 U.S. citizen 和需要 vision screening 的申请人。',
      '地址渠道存在新旧页面冲突：较旧 online FAQ 仍写可更新部分资料，但当前 transaction portal 和 BMV Update My Current License 页面都写明不能在线改地址。应先通过 207-624-9000 x 52114、BMV 邮箱或 Contact Us 更新，再订 duplicate / renewal。',
      '成为 Maine resident 后 30 天内要换证。美国州或加拿大省签发、当前有效或过期不超过五年的驾照可走 Class C conversion；要带原外州证件，遗失时用出具未满 30 天的 certified driving record。',
      '外州换证要核对 legal presence、Maine residency、SSN、vision 和费用；written / road test 可能豁免，但不是自动保证。原外州证即使已经是 REAL ID，申请 Maine REAL ID 仍要补 Maine 的附加材料。',
      'Maine 只允许一人持有一张 REAL ID-compliant credential，即 driver license 或 identification card 二选一。已有有效 passport 等 TSA 接受证件的人，不一定需要为了旅行升级。',
      '首次 REAL ID 要提供 SSN 或不符合 SSN 资格的证据；BMV 明确不要求出示实体 Social Security card。续期时 SSN 要在档，不能取得 SSN 者按 BMV 页面准备有效 immigration document 或 SSA written statement。',
      '非 U.S. citizen 申请或续期 Maine driver license / State ID 都要证明 legal presence；常见移民文件必须清晰、有效且未过期，证件有效期可能短于普通州证件。非 U.S. citizen 不能使用当前 online renewal portal。',
      '首次 REAL ID 文件会被验证、扫描并保存；个人身份资料或 immigration status 没有变化时，后续现场续期通常只带将到期的 REAL ID，name change 或 status change 时要补相应文件。',
      '当前费用页把 Class C 分为：65 岁以下 standard 6 年 $30、REAL ID 6 年 $55；65 岁及以上 standard 4 年 $20、REAL ID 4 年 $40。REAL ID State ID original / renewal 和所有 REAL ID duplicate 均为 $30；non-compliant duplicate 为 $5。',
      'duplicate 有 online、branch/mobile unit、mail 三条路线。现场补证要两份 identification，其中一份显示 date of birth、另一份带 written signature；online 前要先把地址更新到 BMV record。',
      '自 2026 年 2 月 1 日起，Maine 为 Class C basic knowledge test 提供免费 professional interpreter。数字系统只有 Arabic、Canadian French、English、French、Portuguese、Somali、Spanish、Swahili；普通话不在列表时可申请翻译，但官方提示安排可能需四周或更久。',
      'Class C knowledge test 共 30 题，至少答对 24 题；首次驾照还包括 vision screening 和 road test。外州有效驾照转入时 written / road test 可能被免除，应由 BMV 柜台确认。',
      'BMV 首页当前提醒 REAL ID 需求导致 branch 高客流，部分地点 walk-in 可能等候超过三小时、达到容量后限流或下午 4 点提前停止接待；appointments 每日释放，近期旅行者被建议约提前两个月办理。',
    ],
    documentHighlights: [
      'Identity / lawful status 准备一份或相应组合的合格文件，例如有效 U.S. passport、issuing agency certified birth certificate、Certificate of Naturalization / Citizenship、Permanent Resident Card，或与 I-94、I-797、I-20、DS-2019 等配套的有效移民文件。',
      '提供 Social Security Number；实体 Social Security card 不是 Maine REAL ID 的必带件。不符合 SSN 资格者要准备 BMV 接受的 ineligibility evidence。',
      'REAL ID 准备两份写有姓名和 Maine physical residential address 的文件；standard non-REAL ID 通常只需一份。P.O. Box 不能代替 physical address。',
      '常见 residence 文件包括 Maine vehicle registration、pay stub、tax bill / return、W-2、utility bill、insurance、financial statement、lease / lien 或政府文件；以 current BMV list 为准。',
      '没有常规地址文件时，可使用两名了解本人 Maine residence 的人分别签署 BMV residency affidavit；未满 18 岁由 parent / guardian 签署时只需一份。',
      '姓名变化要用 marriage license、divorce decree 或 court order 形成从 identity document 到当前姓名的完整 clear trail。',
      '外州转入带 current out-of-state license；证件遗失时，准备出具日期未满 30 天、能验证原驾照信息的 certified driving record。',
      '线上续期 / 补证准备 SSN、有效信用卡和 printer；成品只寄到 BMV 当前在档地址。旧地址先单独联系 BMV 更新，不要指望 transaction portal 在提交时改。',
      '现场续期已有 REAL ID 且姓名未变时，BMV FAQ 通常只要求带将到期的 credential；name、SSN 或 immigration status 改变时要补对应官方文件。',
    ],
    commonMistakes: [
      '第一次申请或从 standard credential 升级 Maine REAL ID 时尝试完全在线办理。',
      '继续照 2022 brochure 判断“REAL ID 不能 online / AAA”，没有看到 2025 年 11 月后的 current page 更新。',
      '以为外州 REAL ID 可以原样转入，忽略 Maine 仍要求本州 residence、legal presence、SSN 和其他附加材料。',
      '在需要 vision、medical review、name change、非 U.S. citizen、CDL 或外州 transfer 时继续尝试 online service。',
      '相信旧 online FAQ 可以直接改地址；现行 portal 只寄到在档地址，地址应先通过 BMV 更新。',
      '以为必须带实体 Social Security card，或反过来以为没有 SSN 也不需要准备 ineligibility evidence。',
      '只带一份地址文件申请 REAL ID，或者用 P.O. Box 代替 Maine physical residence。',
      '身份文件与当前姓名不一致，却没有带完整 marriage / divorce / court-order chain。',
      '把普通话当成数字考试内置语言，没有提前申请 free interpreter 并预留四周以上排期。',
      '直接 walk in 而不看 specific branch 状态；高峰期可能限流、等候超过三小时或提前停止接待。',
    ],
    recommendedSteps: [
      '先选业务：首次 / 升级 REAL ID、已有 REAL ID renewal、standard renewal / duplicate、外州 transfer、首次考试或资料变更；不要从付款入口反推资格。',
      '只为旅行时先查 TSA 接受证件；已有有效 passport 或其他替代证件，不必把临行前升级 REAL ID 当成唯一方案。',
      '首次或升级 REAL ID 按 identity / lawful status、SSN / ineligibility、two physical-residence documents、name-change trail 四组整理未改动原件或 certified copies。',
      '已有 REAL ID 想线上续期时，逐项确认 U.S. citizen、non-commercial、无需 vision、不改资料、照片年龄合规；任一项不符就转 office。',
      '需要改地址时先电话、邮件或 Contact Us 更新 BMV record；name change、medical condition 或 corrective-lens restriction 变化直接安排 office。',
      '外州新居民在 30 天内去 BMV，带外州证件或未满 30 天 certified driving record，并准备 Maine residence、legal presence、SSN、vision 和费用。',
      '非 U.S. citizen 先打开 BMV legal-presence page 检查当前 immigration documents；不要使用 online renewal，疑难 status 在到场前联系 License Information。',
      '需要中文笔试翻译时在 Class C exam application 上写明语言需求，并按至少四周排期准备；同时使用 Maine Motorist Handbook 学习。',
      '查看 specific branch 状态并预约；有近期旅行时按 BMV 提示约提前两个月办理，同时携带 passport 等备用 TSA 证件。',
      '线上办理后保存 receipt 和 temporary credential；官方 FAQ 写明 temporary credential 有效 60 天，成品最多可能三周寄达。',
    ],
    actionLinks: [
      {
        label: 'Maine REAL ID',
        url: 'https://www.maine.gov/sos/bmv/driver-licenses-and-ids/real-id',
        description: '当前首次 / 续期渠道、材料、one-credential rule、费用和 online / AAA 更新。',
      },
      {
        label: 'Maine Online Renewal / Replacement',
        url: 'https://apps1.web.maine.gov/online/bmv/dlr_v2/',
        description: '现行资格、排除条件、地址限制和 REAL ID renewal / duplicate 入口。',
      },
      {
        label: 'Maine New Resident / Out-of-State Transfer',
        url: 'https://www.maine.gov/sos/bmv/driver-licenses-and-ids/i-moved-to-from-a-different-state',
        description: '30 天期限、外州 / 加拿大证件、材料、vision 和 test waiver 边界。',
      },
      {
        label: 'Maine Renew My License',
        url: 'https://www.maine.gov/sos/bmv/driver-licenses-and-ids/update-my-current-license/renew-my-license',
        description: '普通续期的 physical address、legal presence、vision 和 SSN 要求。',
      },
      {
        label: 'Maine Update Current License',
        url: 'https://www.maine.gov/sos/bmv/driver-licenses-and-ids/update-my-current-license',
        description: '当前地址不能线上修改；电话、邮件与 Contact Us 路径。',
      },
      {
        label: 'Maine Replacement / Duplicate',
        url: 'https://www.maine.gov/sos/bmv/driver-licenses-and-ids/update-my-current-license/replacement-duplicate-license-identification-card',
        description: 'online、branch/mobile、mail 三条补证路线和费用。',
      },
      {
        label: 'Maine Driver License Exam / Interpreter',
        url: 'https://www.maine.gov/sos/bmv/driver-licenses-and-ids/car-license/drivers-license-exam',
        description: '30 题笔试、vision / road test，以及 2026 年免费 interpreter 规则。',
      },
      {
        label: 'Maine Residency Documents',
        url: 'https://www.maine.gov/sos/bmv/visit-your-bmv-branch/how-to-prove-maine-residency',
        description: 'standard 一份、REAL ID 两份 physical-address 文件和 affidavit 替代路径。',
      },
      {
        label: 'Maine Non-Citizen Legal Presence',
        url: 'https://www.maine.gov/sos/bmv/visit-your-bmv-branch/how-to-prove-legal-presence-for-a-non-united-states-citizen',
        description: '永久 / limited legal presence 常见文件和证件期限提醒。',
      },
      {
        label: 'BMV Appointment System',
        url: 'https://mainebmvappt.cxmflow.com/',
        description: 'BMV branch office 预约；appointments 每日释放。',
      },
      {
        label: 'Maine Branch Offices / Mobile Units',
        url: 'https://www.maine.gov/sos/bmv/visit-your-bmv-branch/find-your-local-branch',
        description: '各 branch、mobile unit、营业时间和当前服务提醒。',
      },
      {
        label: 'Maine Driver License Fees',
        url: 'https://www.maine.gov/sos/bmv/driver-licenses-and-ids/drivers-license-and-examination-fees',
        description: 'Class C、REAL ID、考试和外州转入费用表。',
      },
      {
        label: 'Maine BMV Home',
        url: 'https://www.maine.gov/sos/bmv',
        description: '高客流提醒、online services、appointments 和 branch 总入口。',
      },
    ],
    sources: [
      {
        ...
        url: 'https://www.maine.gov/sos/bmv/driver-licenses-and-ids/real-id',
        note: '当前 first-time / renewal / AAA 渠道、材料、SSN card、one credential、扫描保留与费用。',
      },
      {
        label: 'Maine 2022 REAL ID Brochure（渠道信息已过时）',
        url: 'https://www.maine.gov/sos/sites/maine.gov.sos/files/content/assets/MVL-9Checklist-20Brochure-20Revised-207-2022.pdf',
        note: '用于说明旧版 brochure 曾写 online renewal / AAA 不可用；办理渠道必须与当前 REAL ID 页面和 transaction portal 交叉核对。',
      },
      {
        label: 'Maine Online Renewal / Replacement',
        url: 'https://apps1.web.maine.gov/online/bmv/dlr_v2/',
        note: '现行 REAL ID 线上资格、资料不可修改、寄送地址和必须转 office 的情况。',
      },
      {
        label: 'Maine Online Renewal FAQ',
        url: 'https://www.maine.gov/online/bmv/dlr/faq.html',
        note: 'vision renewal 周期、temporary credential 60 天和最多三周寄送；地址表述较旧，须与现行 portal 交叉核对。',
      },
      {
        label: 'Maine New Resident / Out-of-State Transfer',
        url: 'https://www.maine.gov/sos/bmv/driver-licenses-and-ids/i-moved-to-from-a-different-state',
        note: '30 天、五年内过期外州 / 加拿大证件、certified driving record、材料、vision 和 REAL ID 附加要求。',
      },
      {
        label: 'Maine Renew My License',
        url: 'https://www.maine.gov/sos/bmv/driver-licenses-and-ids/update-my-current-license/renew-my-license',
        note: '普通续期的 Maine physical address、legal presence、vision 与 SSN / ineligibility。',
      },
      {
        label: 'Maine Update Current License',
        url: 'https://www.maine.gov/sos/bmv/driver-licenses-and-ids/update-my-current-license',
        note: '地址不能在线改；电话、邮箱与 Contact Us 所需信息。',
      },
      {
        label: 'Maine Replacement / Duplicate',
        url: 'https://www.maine.gov/sos/bmv/driver-licenses-and-ids/update-my-current-license/replacement-duplicate-license-identification-card',
        note: 'online / branch / mail 三条路线、现场 identification 和 $5 / $30 duplicate fee。',
      },
      {
        label: 'Maine Driver License Exam / Interpreter',
        url: 'https://www.maine.gov/sos/bmv/driver-licenses-and-ids/car-license/drivers-license-exam',
        note: '30 题 / 24 题通过、vision / road test、八种数字语言与 2026 年免费 interpreter。',
      },
      {
        label: 'Maine Residency Documents',
        url: 'https://www.maine.gov/sos/bmv/visit-your-bmv-branch/how-to-prove-maine-residency',
        note: 'standard 一份、REAL ID 两份 physical-address 文件、exemptions 和 affidavit。',
      },
      {
        label: 'Maine Non-Citizen Legal Presence',
        url: 'https://www.maine.gov/sos/bmv/visit-your-bmv-branch/how-to-prove-legal-presence-for-a-non-united-states-citizen',
        note: '永久 / limited legal presence 常见文件、有效期和 credential term。',
      },
      {
        label: 'Maine U.S. Citizen Legal Presence',
        url: 'https://www.maine.gov/sos/bmv/visit-your-bmv-branch/how-to-prove-united-states-citizenship',
        note: 'U.S. passport、certified birth certificate、Naturalization / Citizenship 等常见文件。',
      },
      {
        label: 'Maine Driver License Fees',
        url: 'https://www.maine.gov/sos/bmv/driver-licenses-and-ids/drivers-license-and-examination-fees',
        note: 'Class C、REAL ID、written exam 与 out-of-state conversion 当前费用。',
      },
      {
        label: 'Maine BMV Home / Service Capacity',
        url: 'https://www.maine.gov/sos/bmv',
        note: '高客流、walk-in 限流、提前闭门、appointments 每日释放与两个月旅行提前量。',
      },
      {
        label: 'Maine Branch Offices / Mobile Units',
        url: 'https://www.maine.gov/sos/bmv/visit-your-bmv-branch/find-your-local-branch',
        note: 'branch 与 mobile unit 地点、服务和当前营业信息。',
      },
      {
        label: 'Maine BMV Appointment System',
        url: 'https://mainebmvappt.cxmflow.com/',
        note: 'BMV branch office 官方预约系统。',
      },
      {
        label: 'TSA Acceptable Identification',
        url: 'https://www.tsa.gov/travel/security-screening/identification',
        note: '机场安检可接受证件清单；用于判断 passport 等 REAL ID 替代证件。',
      },
    ],
    relatedTopicSlugs: [
      'real-id-basics',
  ...
  },
  {
    ...
    nameEn: 'Hawaii',
    nameZh: '夏威夷州',
    agency: 'Hawaii DOT + County Driver Licensing Offices',
    agencyUrl: 'https://hidot.hawaii.gov/driverslicense/',
    publishedAt: '2026-07-13',
    modifiedAt: '2026-07-19',
    reviewedAt: '2026-07-19',
    summary:
      'Hawaii DOT 发布全州通用的 REAL ID、legal presence 和材料规则，但没有一个统一办理全州业务的 DMV 柜台。预约、地点、费用、考试、续期和补证由四个县分别处理：Oahu 看 Honolulu，Maui、Molokai、Lanai 看 Maui County，Hawaii Island 看 Hawaii County，Kauai 看 Kauai County。第一步不是先找“州 DMV”，而是先确认自己所在的县。',
    realIdSummary:
      'Hawaii 只允许一人持有一张 REAL ID-compliant credential。选择星标 driver license 时，要交回星标 Hawaii State ID；选择星标 State ID 时，可以另行申请不具联邦用途的 Limited Purpose Driver License。2024 年 3 月 13 日材料表把首证分为 legal presence / legal name / date of birth、SSN 和 Hawaii principal residence address，并要求两份地址文件来自不同实体。',
    licenseSummary:
      'Oahu 的外州换证页把有效美国州、领地和 Canada 驾照列为 transfer 路径；Honolulu 另与 Japan、Korea、Taiwan 设有附条件 reciprocity，符合条件者可免 written 和 road test。中国大陆驾照不在该三地名单中，不能自行套用 Taiwan 路线；应按所在县确认 instruction permit、knowledge test 和 road test。',
    appointmentNote:
      '四县预约系统不同。Oahu 的到场业务使用 AlohaQ，且只在材料已在档、资料完全不变时提供驾照或 permit 的 online exact duplicate；Maui County 使用自己的 Qmatic 入口，Class 3 road test 要按县页电话预约；Hawaii County 每个 appointment 只办一项业务且 walk-in 名额有限；Kauai 的预约客户优先，Lihue walk-in ticket 会提前停止发放。',
    realIdCredentialMode: 'single-compliant-card',
    editorNotes: [
      ...
      '一人只能持有一张 REAL ID-compliant credential。以 driver license 作为星标证件时要交回星标 State ID；以 State ID 作为星标证件时，可申请 Limited Purpose Driver License 用于驾驶，但它不能用于 REAL ID 联邦用途。',
      '最新核对到的统一材料表修订日期是 2024 年 3 月 13 日。地址要求明确为两份文件来自不同 entities，不应写成“不同 entities 或 accounts”。',
      '2024 统一材料表写明自 2021 年 6 月 18 日起，出示 SSN documentation 是 optional；但 Hawaii County 和 Kauai 的当前外州转入页仍列出 original Social Security card 或 SSN proof。办理人应以本县具体业务页和预约确认单为准，有卡时带上，不要只凭统一 PDF 推断柜台一定不看。',
      '首证文件必须是有效、未过期的原件或 issuing entity 签发的 certified copy；notarized copy、fax 和普通复印件不等于 certified copy。',
      'U.S. citizen 或 permanent resident 以前已完成五类材料核验、且资料没变时，HIDOT 说明续期通常不必全部重交；temporary legal presence 申请人续期或补证要本人出示 continued legal presence，也不能走 mail renewal。',
      'Hawaii 驾照最早可在到期前六个月续期。过期后已经不能合法驾驶；Kauai 与 Honolulu 页面都说明 90 天内仍可续期，超过 90 天会产生 reactivation fee，超过一年通常按新申请处理。',
      'Honolulu 的 Japan、Korea、Taiwan reciprocity 只适用于符合条件的有效驾照，并要求相应领事机构出具 notarized、translated、sealed verification letter；过期外国驾照不能按该 transfer 路径免 written 和 road test。',
      '中国大陆驾照不在 Honolulu 公布的 Japan、Korea、Taiwan reciprocity 名单中。不要把 China 与 Taiwan 混写；应按普通 foreign-license applicant 准备英文翻译、instruction permit、general knowledge test 和可能的 road test。',
      '访客能否用外国驾照驾驶不是“有外国驾照就行”。Honolulu 只写明 1949 Geneva Convention 缔约地的有效驾照可配合 passport 使用，驾驶人须至少 18 岁，并建议携带 IDP；具体国别资格和停留期限应在出发前向所在县确认。',
      'Oahu 对无法读写英文的申请人提供受限制的 oral examination 安排：Kapalama 可人工安排 phone translation 或 English oral classroom test，并另收 oral test fee；页面没有承诺任意日期都提供普通话。',
      '临时卡或现场给的 temporary document 不能作为 REAL ID 旅行证件。Honolulu 提醒永久卡通常需 6-8 周，Hawaii County 写明最多预留 8 周；有近期出行计划应带护照等 TSA 接受证件。',
      '费用、付款方式、笔试截止时间和 walk-in 规则由县决定。Honolulu 的 fee table、Maui 的 fee PDF、Hawaii County 的 License Fees 与 Kauai fee chart 不能互相替代。',
    ],
    documentHighlights: [
      ...
      'SSN 仍是首证核验类别，但 2024 统一清单把“出示 SSN documentation”标为 optional。县级 transaction page 可能仍要求 original Social Security card、W-2、1099 或 pay stub，因此要再核对本县清单。',
      '准备两份 Hawaii principal residence address 文件，必须来自不同 entities，并显示申请人的 full first and last name 与 Hawaii address。P.O. Box 通常不能代替 principal residence，除非当地没有分配可投递的 street address。',
      'utility bill、financial statement 或政府/医疗邮件通常要在两个月内；payroll check / stub 可在六个月内。lease 通常要覆盖六个月或以上，其他材料的日期窗口按 2024 清单逐项核对。',
      '本人没有地址文件时，可向 county DMV 询问 Hawaii principal residence affidavit。该表通常由同住者提供地址材料，并在公证员前签署或由柜台人员见证。',
      ...
      '所有身份材料带有效原件或 issuing entity certified copy。外国申请材料按 Honolulu 指引准备 English translation，并把译文与原文件一起带到现场。',
    ],
    commonMistakes: [
      ...
      '把同一实体的不同 accounts 当成两份地址证明；2024 表要求 different entities。',
      ...
      '把 exact duplicate online service 当成首次 REAL ID、续期、改名或改地址入口；资料有变化时通常要走另一条路径。',
      '拿 temporary card 去机场，或在六周内出行却没有准备护照等备用证件。',
    ],
    recommendedSteps: [
      '先按岛屿确定办理县：Oahu、Maui County、Hawaii County 或 Kauai County；不要先在其他县的系统里抢 appointment。',
      '决定唯一 REAL ID credential 放在 driver license 还是 State ID 上。需要同时驾驶与保留星标 State ID 时，再核对 Limited Purpose Driver License。',
      ...
      '再打开本县具体 transaction page。若县页和统一材料表在 SSN、renewal documents 或 office 服务上表述不同，先联系本县 office 并保留回复或预约确认。',
      '外州有效驾照按本县 transfer 路径准备 surrender 与 vision screening。Japan、Korea、Taiwan 驾照另看 Honolulu reciprocity 条件；中国大陆驾照按可能需要 permit、笔试和路考准备。',
      '有外文材料时先完成 English translation；temporary legal presence 申请人把当前 USCIS / DHS 文件和 continued legal presence 一并带到现场。',
      '按县预约：Oahu 用 AlohaQ，Maui、Hawaii County、Kauai 使用各自系统；road test、普通柜台和 online duplicate 不是同一个入口。',
      '有六至八周内的出行计划时，不依赖 temporary document，随身准备有效护照或其他 TSA 接受证件。',
    ],
    actionLinks: [
      {
        label: 'HIDOT REAL ID / Driver License',
        url: 'https://hidot.hawaii.gov/driverslicense/',
        description: '全州 legal presence、续期/补证材料规则、唯一 REAL ID credential 和四县入口。',
      },
      {
        label: 'Hawaii REAL ID Documents (Rev. 3/13/2024)',
        url: 'https://www.honolulu.gov/csd/wp-content/uploads/sites/6/2024/03/Acceptable-Documents-for-a-REAL-ID-Compliant-Star-DL-SID-Print-Button-2024-03-13.pdf',
        description: '当前身份、SSN、两份不同实体地址材料、姓名连接文件清单。',
      },
      {
        label: 'Oahu Driver License Procedures',
        url: 'https://www.honolulu.gov/csd/drivers-license-procedures/',
        description: 'Oahu permit、transfer、renewal、duplicate、Limited Purpose 和语言协助。',
      },
      {
        label: 'Oahu Foreign License Transfer',
        url: 'https://www.honolulu.gov/csd/foreign-drivers-license/',
        description: 'Japan、Korea、Taiwan reciprocity、领事验证信和考试边界。',
      },
      {
        label: 'Oahu AlohaQ / Service Locations',
        url: 'https://www.honolulu.gov/csd/services-and-locations/',
        description: 'Oahu Driver Licensing Centers、Satellite City Hall 服务范围和 AlohaQ 入口。',
      },
      {
        label: 'Maui County DMV',
        url: 'https://www.mauicounty.gov/1328/DMV',
        description: 'Maui、Molokai、Lanai 的办公室、预约、road test 和材料入口。',
      },
      {
        label: 'Maui County Appointment',
        url: 'https://wb-mauicountydmv.qmatic.cloud/',
        description: 'Maui County driver license / State ID 柜台预约系统；road test 仍按县页电话预约。',
      },
      {
        label: 'Hawaii County Driver Licensing',
        url: 'https://www.vrl.hawaiicounty.gov/driver-s-licensing',
        description: 'Hawaii Island 驾照、转入、续期、REAL ID、考试和 office 总入口。',
      },
      {
        label: 'Hawaii County Appointment',
        url: 'https://hawaiicountyvrl.qmatic.io/booking/singlebooking/serviceselection',
        description: 'Hawaii County driver license / State ID 预约系统。',
      },
      {
        label: 'Kauai County DMV',
        url: 'https://www.kauai.gov/Government/Departments-Agencies/Finance/Drivers-Licensing-and-Motor-Vehicles',
        description: 'Kauai 驾照、REAL ID、转入、续期、road test 和 office 总入口。',
      },
      {
        label: 'Kauai County Appointment',
        url: 'https://kauaidmvappt.cxmflow.com/en/WizardAppt/Units',
        description: 'Kauai DMV 柜台预约系统。',
      },
    ],
    sources: [
      {
        label: 'HIDOT REAL ID / Driver License FAQ',
        url: 'https://hidot.hawaii.gov/driverslicense/',
        note: '州级 legal presence、材料、续补证、六个月续期窗口、唯一 REAL ID credential 和县级 contacts。',
      },
      {
        label: 'Hawaii REAL ID Documents (Rev. 3/13/2024)',
        url: 'https://www.honolulu.gov/csd/wp-content/uploads/sites/6/2024/03/Acceptable-Documents-for-a-REAL-ID-Compliant-Star-DL-SID-Print-Button-2024-03-13.pdf',
        note: '当前五类材料、SSN documentation optional、two different entities、文件日期、affidavit、P.O. Box 和 connecting documents。',
      },
      {
        label: 'Honolulu REAL ID (Oahu)',
        url: 'https://www.honolulu.gov/csd/real-id/',
        note: '唯一 REAL ID card、Limited Purpose 路径、temporary card、6-8 周邮寄、online exact duplicate 和 Oahu 现场入口。',
      },
      {
        label: 'Honolulu Driver License Procedures (Oahu)',
        url: 'https://www.honolulu.gov/csd/drivers-license-procedures/',
        note: 'permit、外州转入、续期、地址、补证、Limited Purpose、foreign applicant、oral exam 和新卡寄送。',
      },
      {
        label: 'Honolulu Foreign Driver License Transfer (Oahu)',
        url: 'https://www.honolulu.gov/csd/foreign-drivers-license/',
        note: 'Japan、Korea、Taiwan reciprocity、领事验证信、有效期、surrender 和 written/road test waiver。',
      },
      {
        label: 'Honolulu Driver License Requirements / Fees (Oahu)',
        url: 'https://www.honolulu.gov/csd/drivers-license-requirements/',
        note: 'Oahu fees、年龄/证件期限、考试费、付款方式和 one-license rule。',
      },
      {
        label: 'Honolulu Driver License FAQ (Oahu)',
        url: 'https://www.honolulu.gov/csd/drivers-license-faq/',
        note: '六个月续期、90 天/一年过期处理、foreign applicant、visitor treaty route、oral exam 和 out-of-state transfer。',
      },
      {
        label: 'Honolulu Services and Locations (Oahu)',
        url: 'https://www.honolulu.gov/csd/services-and-locations/',
        note: 'AlohaQ、Driver Licensing Centers、Satellite City Hall 服务和笔试日期。',
      },
      {
        label: 'Maui County DMV',
        url: 'https://www.mauicounty.gov/1328/DMV',
        note: 'Maui County driver license / State ID、office、预约和 road test 路径。',
      },
      {
        label: 'Maui County Appointment Validation',
        url: 'https://www.mauicounty.gov/2145',
        note: 'Qmatic 柜台预约、one appointment per person、材料确认和 Class 3 road test 电话预约。',
      },
      {
        label: 'Maui County DMV Wait Times / Offices',
        url: 'https://www.mauicounty.gov/2125/DMV-Wait-Times',
        note: 'Maui、Hana、Lanai、Molokai offices、笔试截止时间和 walk-in 信息。',
      },
      {
        label: 'Hawaii County Driver Licensing',
        url: 'https://www.vrl.hawaiicounty.gov/driver-s-licensing',
        note: 'Hawaii Island driver license 业务、online test、续转补证、REAL ID、locations 和 up-to-8-week mailing notice。',
      },
      {
        label: 'Hawaii County Appointments',
        url: 'https://www.vrl.hawaiicounty.gov/other-services/all-appointment-page',
        note: 'one transaction per appointment、limited walk-ins、application 和 Qmatic scheduler。',
      },
      {
        label: 'Hawaii County Out-of-State Transfers',
        url: 'https://www.vrl.hawaiicounty.gov/driver-s-licensing/out-of-state-transfers',
        note: '外州证件、SSN card、两份地址、vision、surrender 和无实体卡时的 written/road test。',
      },
      {
        label: 'Hawaii County REAL ID Requirements',
        url: 'https://www.vrl.hawaiicounty.gov/driver-s-licensing/real-id-requirements',
        note: 'one compliant credential、Limited Purpose route、材料类别和 temporary card 风险。',
      },
      {
        label: 'Kauai County DMV',
        url: 'https://www.kauai.gov/Government/Departments-Agencies/Finance/Drivers-Licensing-and-Motor-Vehicles',
        note: 'Kauai appointment、office、walk-in、written test、REAL ID、transfer 和 renewal 入口。',
      },
      {
        label: 'Kauai County REAL ID',
        url: 'https://www.kauai.gov/Government/Departments-Agencies/Finance/Drivers-Licensing-and-Motor-Vehicles/REAL-ID',
        note: 'Kauai REAL ID steps、SSN、two residence documents、fees 和 forms。',
      },
      {
        label: 'Kauai County Out-of-State License Transfers',
        url: 'https://www.kauai.gov/Government/Departments-Agencies/Finance/Drivers-Licensing-and-Motor-Vehicles/Out-of-State-License-Transfers',
        note: '有效外州证件、SSN proof、surrender、无塑料卡时的 written/road test 和 fee chart。',
      },
      {
        label: 'Kauai County Driver License Renewals',
        url: 'https://www.kauai.gov/Government/Departments-Agencies/Finance/Drivers-Licensing-and-Motor-Vehicles/Hawaii-Drivers-License-Renewals',
        note: '六个月续期窗口、原件、90 天 grace/reactivation、一年后新申请和费用。',
      },
    ],
    relatedTopicSlugs: [
      'real-id-basics',
  ...
  },
  {
    ...
    reviewedAt: '2026-07-19',
    summary:
      '搬到 Alaska 后，普通驾照应在成为居民后 90 天内转入，CDL 是 30 天。转入普通驾照要通过 Alaska knowledge test 和 vision test。只有最近 5 年持有美国州/领地、Canada 或 South Korea 驾照的人可免 road test；中国大陆驾照不在这份免试清单。',
    realIdSummary:
      'Alaska 标准 DL/ID 与 REAL ID 都要求 identity / lawful status、完整 SSN 或近 90 天的 SSA ineligibility letter，以及适用的姓名连接文件。主要差别是标准证件要一份 Alaska residence document，REAL ID 要两份；当前费用表中非商用驾照为标准 $20、REAL ID $40。',
    licenseSummary:
      '访客可持有效外州或外国驾照在 Alaska 驾驶最多 90 天；外国驾照不是英文时，DMV 要求随身携带由使领馆提供的官方翻译，Alaska 不签发也不强制 IDP。成为居民后不能继续按访客路线，外国驾照用户应按 first Alaska credential 准备笔试、视力和可能的路考。',
    appointmentNote:
      'Alaska 州办公室、contract agent 与私人 business partner 的服务不同；business partner 可能处理 credential、考试和路考，但会另收服务费。州办公室的路考日期和截止考试时间按地点变化，应先查具体 location 再约。偏远社区还可能适用 Mobile DMV 或 Off-Highway Driver License，不应直接套用 Anchorage 办事路径。',
    editorNotes: [
      ...
      '外文身份文件要有认证英文翻译；Alaska DMV 提供 Certificate of Accuracy of Translation 表格。',
      '非公民首次申请或续期要携带有效未过期的 USCIS/DHS 文件和适用的 I-797 / I-94；SAVE 若转人工 secondary verification，DMV 说明约可需两个月。',
      '普通驾照可从到期前一年开始续期，但线上续期只在 21 岁生日后可用；21 岁证件在生日后 90 天到期，换水平版证件要完成 alcohol awareness test。',
      '线上补证可向州外申请人发电子临时证件，DMV 标注处理时间为 1 至 2 个工作日。',
      '姓名或地址变化要在 30 天内通知 DMV；线上更新地址不会收到确认通知，需要显示新地址的实体证件时还要另办 replacement。',
    ...
    documentHighlights: [
      ...
      '在申请表填写完整 SSN；不符合 SSN 资格的申请人要带 SSA 在近 90 天签发的验证信。',
      '标准 DL/ID 带一份 Alaska residence document，REAL ID 带两份；文件要显示本人姓名和 current residence address，不能只有 P.O. Box 或 mail cache。',
      'REAL ID 的两份居住文件可用 lease、utility bill、employment / insurance document、bank statement、voter confirmation、USPS change confirmation 等；同一来源在同一月或 billing cycle 签发的文件不能算两份。',
    ...
    commonMistakes: [
      '持中国大陆驾照就认为转入 Alaska 可免路考；当前近五年免试列表只写美国州/领地、Canada 和 South Korea。',
      '把游客可用外国驾照 90 天误解为成为 Alaska 居民后也能继续等 90 天以外。',
      '申请 REAL ID 时两份地址文件来自同一来源、同一 billing cycle，或只显示 P.O. Box。',
      '带普通复印件、手机截图或未认证的外文翻译。',
      '没有 SSN 时什么都不带，或 SSA ineligibility letter 已超过 90 天。',
      '以为线上续期或补证入口可以完成首次 REAL ID；首次升级要本人出示 source documents。',
      '去私人 business partner 前没核对服务图标和额外费用。',
      '居住在不通公路的偏远社区，却没先查 Mobile DMV、rural guide 或 Off-Highway 资格。',
    ],
    recommendedSteps: [
      '先判断自己是 visitor 还是已成为 Alaska resident；访客外国驾照和居民换证是两条不同路线。',
      ...
      '有外文文件时先完成 certified English translation；非公民再加入当前有效的 USCIS/DHS、I-797 和需要的 I-94。',
      '查 State DMV Office / Contract Agent Locations 的当日服务和考试截止时间；选 business partner 时同时确认它是否办 credential / test 以及额外费用。',
      '不通公路的社区居民先查 Rural Outreach 和 Guide to Rural Driving，再确认 Mobile DMV、document pre-screening 或 Off-Highway Class D 是否适用。',
      '续期、补证、地址更新先用 Online DMV 判断线上资格；姓名或地址改变不要超过 30 天通知期。',
    ],
    actionLinks: [
      {
        label: 'Visiting or New to Alaska',
        url: 'https://dmv.alaska.gov/general-information/visiting-or-new-to-alaska/',
        description: '新居民换证期限、笔试/视力、路考免试范围和 visitor 规则。',
      },
      {
        label: 'Alaska REAL ID Update',
        url: 'https://dmv.alaska.gov/credential-services/realidupdate/',
        description: 'REAL ID 是否必要、到场规则和材料总览。',
      },
      {
        label: 'Alaska REAL ID Checklist PDF',
        url: 'https://dmv.alaska.gov/media/ozwhxz3e/ak-real-id-checklist.pdf',
        description: '当前 identity、SSN、two residency、name chain 及翻译要求。',
      },
      {
        label: 'Standard Alaska Checklist PDF',
        url: 'https://dmv.alaska.gov/media/1eyni4yh/standard-alaska-checklist.pdf',
        description: '标准驾照/ID 的 identity、SSN、one residency 和 name chain 材料。',
      },
      {
        label: 'New to Alaska from Another Country',
        url: 'https://dmv.alaska.gov/credential-services/new-to-alaska-from-another-country/',
        description: '移民文件、I-94、SAVE 核验和非公民证件期限说明。',
      },
      {
        label: 'Renew or Replace an Alaska License',
        url: 'https://dmv.alaska.gov/credential-services/renew-your-alaska-driver-license/',
        description: '续期窗口、21 岁规则、线上资格和州外临时证件。',
      },
      {
        label: 'Changing Identification Details',
        url: 'https://dmv.alaska.gov/credential-services/changing-identification-details/',
        description: '姓名/地址 30 天通知、连接文件和 replacement 路径。',
      },
      {
        label: 'State DMV and Contract Agent Locations',
        url: 'https://dmv.alaska.gov/locations/state-dmv-office-locations/',
        description: '办公室、路考日期、预约、笔试截止时间和当前关闭信息。',
      },
      {
        label: 'Guide to Rural Driving',
        url: 'https://dmv.alaska.gov/credential-services/guide-to-rural-driving-information/',
        description: '偏远社区 Off-Highway Class D 资格、笔试、视力和邮寄路径。',
      },
      {
        label: 'Alaska Online DMV',
        url: 'https://online.dmv.alaska.gov/',
        description: '线上续期、补证、地址更新、查状态和练习题入口。',
      },
    ],
    sources: [
      {
        label: 'Alaska DMV Visiting or New to Alaska',
        url: 'https://dmv.alaska.gov/general-information/visiting-or-new-to-alaska/',
      },
      {
      ...
      {
        label: 'Alaska Standard Credential Checklist PDF',
        url: 'https://dmv.alaska.gov/media/1eyni4yh/standard-alaska-checklist.pdf',
      },
      {
        label: 'Alaska DMV REAL ID Interactive Checklist',
        url: 'https://online.dmv.alaska.gov/RealIDChecklist/Home/Checklist',
      },
      {
        label: 'Alaska DMV New to Alaska from Another Country',
        url: 'https://dmv.alaska.gov/credential-services/new-to-alaska-from-another-country/',
      },
      {
        label: 'Alaska DMV International Driving Permit',
        url: 'https://dmv.alaska.gov/credential-services/international-driving-permit/',
      },
      {
        label: 'Alaska DMV Renew Your Driver License',
        url: 'https://dmv.alaska.gov/credential-services/renew-your-alaska-driver-license/',
      },
      {
        label: 'Alaska DMV Duplicate Driver License',
        url: 'https://dmv.alaska.gov/credential-services/duplicate-alaska-driver-license/',
      },
      {
      ...
      {
        label: 'Alaska DMV License Fees',
        url: 'https://dmv.alaska.gov/credential-services/license-fees/',
      },
      {
        label: 'Alaska DMV State Office and Contract Agent Locations',
        url: 'https://dmv.alaska.gov/locations/state-dmv-office-locations/',
      },
      {
        label: 'Alaska DMV Business Partners',
        url: 'https://dmv.alaska.gov/locations/business-partners/',
      },
      {
        label: 'Alaska DMV Guide to Rural Driving',
        url: 'https://dmv.alaska.gov/credential-services/guide-to-rural-driving-information/',
      },
      {
        label: 'Alaska DMV Rural Outreach',
        url: 'https://dmv.alaska.gov/general-information/rural-outreach/',
      },
      {
        label: 'Alaska DMV Certificate of Accuracy of Translation',
        url: 'https://dmv.alaska.gov/media/nn3cydgn/translationpdf.pdf',
      },
      {
        label: 'Alaska Driver Manual',
        url: 'https://dmv.alaska.gov/media/t5ef5vi2/dlman.pdf',
      },
      {
        label: 'Alaska Online DMV',
        url: 'https://online.dmv.alaska.gov/',
  ...
  },
  {
    ...
    reviewedAt: '2026-07-21',
    summary:
      'Mississippi 的路线与多数州不同：DSB FAQ 写明本州签发的 driver license 和 ID 都是 REAL ID compliant，并自动带 Gold Star，不需要另选 standard credential。首次申请、外州转入和非公民业务走 Driver Service station；符合条件的 U.S. citizen 可线上续期、补证或在续期/补证过程中改地址。',
    realIdSummary:
      'Mississippi 不设普通驾照与 REAL ID 的升级二选一，州 FAQ 说明所有 Mississippi driver license / ID 自动为 Gold Star compliant credential。首次 credential 仍要准备 completed application、original 或 certified birth / identity document、SSN card 或显示完整九位号码的政府文件、两份带 physical Mississippi address 的 domicile documents，以及适用的 legal name-change papers。',
    licenseSummary:
      '新居民按官方驾驶手册应在搬入后 60 天内取得 Mississippi license，并交回外州证件；有效外州驾照通常免 computerized exam，但仍要 vision screening。当前 Class R 页面把任何 expired out-of-state license 都列为要考 knowledge exam，而 2025 manual 写成过期超过 30 天，边界有冲突，应按当前业务页准备考试并在预约前向 DSB 确认。',
    appointmentNote:
      'DSB 对所有申请人都强烈建议预约。线上 renewal 只适用于 U.S. citizen 的有效 Class R / Class D，并允许最早到期前六个月、最迟过期一年内办理且不能连续两次 online；non-U.S. citizen、过期超过十二个月、没有有效照片或需要立即拿 duplicate 的申请人应到 Driver Service station。',
    editorNotes: [
      'Mississippi FAQ 明确写着所有 Mississippi driver licenses 和 ID 都是 REAL ID compliant，并自动显示 Gold Star；线上续期同样会取得 Gold Star，不应再写成 standard 与 REAL ID 二选一。',
      'DSB FAQ 同一处仍保留“REAL ID deadline 延到 May 3, 2023”的旧答案；该日期已经失效，机场身份证件以 TSA 当前规则为准。',
      '新居民手册要求搬入 Mississippi 后 60 天内换驾照，交回所有外州证件；外州证件遗失时要向 Driver License office 领取 Affidavit of Inability to Surrender，并对签名做 notarization。',
      '有效外州驾照转入可免 Computerized Exam，但仍要 vision screening。考试边界存在官方表述差异：当前 Class R 页面说 expired out-of-state license 要考，2025 manual 则写过期超过 30 天才考；保守做法是过期证件都按需考准备并向 DSB 确认。',
      '首次 Class R 当前费用为 4 年 $24 或 8 年 $47。申请人通常要 completed application、original birth certificate 或 acceptable document、完整九位 SSN 证明、两份不超过 60 天的 residency 和适用的 legal name-change documents。',
      '17 岁及以上首次申请人无需持 permit 12 个月，可在同一天完成 permit 与 license 路线，但要通过 knowledge 和 eye exam；当前 Class R 页面还写明 regular license 暂不要求 skills / road test。',
      '16 岁申请人通常要持 learner permit 12 个月或直到 17 岁，以先到者为准，并准备 valid permit、更新的 school attendance form 和 Waiver of Road Testing Affidavit。',
      'DSB 2026 年 6 月更新写明：自 2027 年 7 月 1 日起，所有 new driver 取得 regular license 都要完成 certified Driver Education；自 2026 年 7 月 1 日起，Hardship License 只接受 DPS 或 MDE certified instructor 完成的课程。',
      '需要考试口译时，申请人要自行携带 interpreter，并提交经过 notarization 的 Mississippi Interpreter Oath。口译员只能准确翻译，不能给答案、提示或解释题意。',
      '普通续期最早可在到期前六个月办理；未过期超过 12 个月可 online 或到 station，超过 12 个月必须现场，过期续期加 $1 late fee。',
      '线上续期只允许 every other renewal；上一次已 online renewal 的，本次要到 Driver Service station。online license renewal 还要求 U.S. citizen、有效 Class R / Class D、有效照片和本人办理。',
      '续期页面说证件过期不超过 60 个月通常不要求文件，但 DSB 也提醒新 records system 可能没有完整历史材料；带 birth certificate、SSN 和两份 residency 可减少现场中断。超过 60 个月必须重交材料，driver license 还要重考 knowledge exam。',
      'non-U.S. citizen 必须在到期前 30 天内才可续期，必须本人带 Homeland Security immigration documents 到 station，不能 online renewal。证件期限按 authorized stay 决定且最长四年。',
      'non-U.S. citizen 的 lawful status 要经 SAVE 核验；不能即时验证时，官方提示制证可能延迟最多 30 天，并可能要求补件。SSN 只在 applicable 时提供，不要把公民材料清单原样套到所有移民类别。',
      'duplicate driver license / ID 费用为 $11，可 online 申请；需要立即取得证件或没有有效照片时应到 station，现场会重新拍照并填写 duplicate application。',
      '线上改地址不能单独免费完成：官方 portal 要求同时订 duplicate credential，或在符合资格的 online renewal 中修改。成品只寄到 credential 地址，不能寄 P.O. Box 或 alternate address。',
      '新 State ID 可由六岁及以上申请人办理，4 年 $17、8 年 $33；材料仍包括申请表、原件或 certified identity、SSN 证明、两份 residency 和姓名变化法律文件。',
    ],
    documentHighlights: [
      'Completed and signed Mississippi Driver License / ID application；外州转入还要带 out-of-state credential，遗失时按 DSB 手册取得 notarized inability-to-surrender affidavit。',
      'Date of birth / identity 使用带 state seal 和 certificate number 的 original 或 certified birth certificate，或 Certificate of Naturalization / Citizenship；普通 photocopy 不接受。',
      'SSN 使用 Social Security Card，或显示申请人姓名与完整九位 SSN 的 official government correspondence，例如 returned W-2 / 1099、pay stub、DD-214 或 NGB-22。',
      '首次 Class R 的两份 Mississippi residency 应带本人姓名和 physical residence address，并且当前 Class R 页面要求不超过 60 天。',
      'P.O. Box、junk / soliciting mail、envelope、handwritten document / letter 和 blank check 不能作为 domicile proof。',
      '常见地址文件包括 utility / internet / phone bill、bank or credit-card statement、pay stub、lease、insurance、vehicle title / registration、tax / government document 或 property record；最终由 DSB 判断是否接受。',
      '21 岁以下可使用 parent / guardian domicile 文件；21 岁以上没有本人账单时，可用 spouse / parent 文件并以 marriage license 或 birth certificate 证明关系。',
      'roommate、landlord、parent 或 guardian 路线可用 official Proof of Domicile Affidavit，再配同址 driver license / ID 或一份合格 domicile document，凑足两份。',
      '姓名变化只接受 Marriage License、Divorce Decree、Adoption Order 或 Court Order。首次交易时 SSN card 不一定已改成新姓名，但 DSB 强烈建议续期前更新。',
      'non-U.S. citizen 根据身份准备 passport、I-94、valid visa、I-551、I-766、I-20、DS-2019、I-797 等当前类别要求；所有 supporting documents 上的姓名和出生日期要一致。',
    ],
    commonMistakes: [
      '以为 Mississippi 还要在 standard 与 REAL ID 之间选择，另外寻找不存在的升级流程。',
      '继续引用 DSB FAQ 内已经失效的 May 3, 2023 REAL ID deadline。',
      '外州证件已经过期，却只按 valid transfer 的免考路线准备，没有预留 knowledge exam。',
      '把中国或其他外国驾照当作 U.S. out-of-state transfer；DSB 公布的免考转入规则只写有效外州 license，非公民仍要走 original / lawful-status 与考试路线。',
      '地址证明使用 P.O. Box、信封、junk mail、手写信、blank check，或首次 Class R 文件已经超过 60 天。',
      'SSN 文件只显示后四位，或没有申请人姓名和完整九位号码。',
      '姓名变化只带普通复印件、姓名声明或翻译件，没有 marriage / divorce / adoption / court order 原件链。',
      '上次已经 online renewal，本次仍直接在线付款；Mississippi 只允许 every other renewal online。',
      'non-U.S. citizen 提前超过 30 天续期、尝试 online renewal，或没有带完整 Homeland Security documents。',
      '只在线提交独立地址更新；portal 要求把地址变更放进 renewal 或 duplicate，而且不会寄到 P.O. Box / alternate address。',
    ],
    recommendedSteps: [
      '先选业务：first license、valid / expired out-of-state transfer、renewal、duplicate / address、State ID 或 non-U.S. citizen；Mississippi 不需要单独选择 REAL ID upgrade。',
      '首次或外州转入按 application、identity / birth、full-nine-digit SSN、two recent physical-address proofs、name-change chain 分组原件。',
      '新居民在 60 天内预约 station；带外州 credential，遗失时先取得 notarized inability-to-surrender affidavit。证件过期则按 knowledge exam 路线准备。',
      '首次申请前确认年龄路线：17 岁及以上准备 knowledge + eye exam；16 岁路线另核对 12-month permit、school form 和 road-test waiver。',
      '需要中文口译时下载 Interpreter Oath，提前找到 interpreter 并完成 notarization；口译员不得解释或提示答案。',
      '续期先核对是否 U.S. citizen、Class R / D、有效照片、过期未超一年，以及上一次是否 online；任一不符就预约 station。',
      '续期即使未满 60 个月也带核心材料备份；超过 60 个月则必须按 first-credential 材料和 knowledge exam 准备。',
      'non-U.S. citizen 在到期前 30 天内预约现场，按具体 immigration category 整理原件，并为 SAVE 最多 30 天的追加核验留出时间。',
      '改地址时选择 eligible online renewal 或 $11 duplicate；先确认 USPS 会投递到 physical address，不能使用 P.O. Box 或 alternate mailing address。',
      '查看具体 Driver Service location 和 appointment confirmation；计划在 2027 年 7 月 1 日后首次领证的申请人还要检查 certified Driver Education 新要求。',
    ],
    actionLinks: [
      {
      ...
      },
      {
        ...
        description: 'domicile、identity / birth、完整 SSN、姓名变化和 affidavit 路线。',
      },
      {
        label: 'Mississippi Regular Driver License / Out-of-State Transfer',
        url: 'https://www.driverservicebureau.dps.ms.gov/Drivers/ClassR',
        description: '首次 Class R、外州免考边界、年龄路线、interpreter 和当前 road-test 说明。',
      },
      {
        label: 'Mississippi Renew Driver License / ID',
        url: 'https://www.driverservicebureau.dps.ms.gov/node/298',
        description: '六个月提前量、12 / 60 个月分界、every-other-online 与 non-citizen 排除。',
      },
      {
        label: 'Mississippi Online Services',
        url: 'https://www.ms.gov/dps/license_renewal/',
        description: '官方 online renewal、duplicate、change address 和 appointment 总入口。',
      },
      {
        label: 'Mississippi Change Address',
        url: 'https://www.ms.gov/dps/license_renewal/ChangeAddress',
        description: '地址变更必须搭配 duplicate 或 eligible renewal，以及 P.O. Box / alternate-address 限制。',
      },
      {
        label: 'Mississippi Duplicate License / ID',
        url: 'https://www.driverservicebureau.dps.ms.gov/Drivers/Duplicate_License',
        description: '$11 online / in-person duplicate 和立即取证、拍照边界。',
      },
      {
        label: 'Mississippi Online Duplicate Portal',
        url: 'https://www.ms.gov/dps/license_renewal/Duplicate',
        description: '官方 online duplicate 入口、有效照片、寄送地址与 P.O. Box 限制。',
      },
      {
        label: 'Mississippi Identification Cards',
        url: 'https://www.driverservicebureau.dps.ms.gov/Drivers/Identification_Cards',
        description: '六岁以上 State ID、4 / 8 年费用和首次材料。',
      },
      {
        label: 'Mississippi Non-U.S. Citizen Information',
        url: 'https://www.driverservicebureau.dps.ms.gov/Drivers/Non_Citizen',
        description: '现场续期、30 天窗口、legal-presence 类别、limited term 与 SAVE。',
      },
      {
        label: 'Mississippi Learner Permit / Testing',
        url: 'https://www.driverservicebureau.dps.ms.gov/Drivers/Learners_Permit',
        description: 'in-person knowledge exam、年龄路线、禁用电子设备和官方手册入口。',
      },
      {
        label: 'Mississippi Interpreter Oath',
        url: 'https://www.driverservicebureau.dps.ms.gov/node/368',
        description: '考试口译表格和 interpreter 的准确翻译 / 禁止提示边界。',
      },
      {
        label: 'Mississippi Driver Education Update',
        url: 'https://www.driverservicebureau.dps.ms.gov/node/400',
        description: '2026 hardship 课程认证和 2027 new-driver mandatory education 生效日期。',
      },
      {
        label: 'Mississippi Driver Service Fees',
        url: 'https://www.driverservicebureau.dps.ms.gov/Drivers/Driver_Service_Fees',
        description: 'Class R、State ID、duplicate、non-citizen 与 late fee。',
      },
      {
        label: 'Mississippi Driver License Locations',
        url: 'https://www.driverservicebureau.dps.ms.gov/drivers/driver_license_locations',
        description: 'station 地址、营业时间和部分 location 的业务限制。',
      },
      {
        label: 'Mississippi DPS Appointment',
        url: 'https://telegov.egov.com/dps',
        description: 'Mississippi Department of Public Safety 官方预约系统。',
      },
    ],
    sources: [
      {
        label: 'Mississippi Driver Service Bureau',
        url: 'https://www.driverservicebureau.dps.ms.gov/',
        note: '当前 online services、appointment、locations、manual 和 2026 news 总入口。',
      },
      {
        label: 'Mississippi Required Documents',
        url: 'https://www.driverservicebureau.dps.ms.gov/node/303',
        note: 'two domicile proofs、P.O. Box / junk mail 排除、affidavit、identity、full SSN 和 name change。',
      },
      {
        label: 'Mississippi Regular Driver License / Transfer',
        url: 'https://www.driverservicebureau.dps.ms.gov/Drivers/ClassR',
        note: 'Class R 费用、60-day residency freshness、年龄路线、外州考试、interpreter 与 current road-test rule。',
      },
      {
        label: 'Mississippi 2025 Driver Manual',
        url: 'https://www.driverservicebureau.dps.ms.gov/sites/default/files/2025-02/1.15.2025%20Revised%20MDPS%20Driver%27s%20Manual.pdf',
        note: '新居民 60 天、外州证件交回 / 遗失 affidavit、外州过期 30 天表述和 nonresident foreign license 边界。',
      },
      {
        label: 'Mississippi Driver License / ID Application (2025)',
        url: 'https://www.driverservicebureau.dps.ms.gov/sites/default/files/2025-02/DLapplication_2.6.2025.pdf',
        note: '外州申请材料、原件姓名链、取消其他州 credential 和当前申请字段。',
      },
      {
        label: 'Mississippi Renew Driver License / ID',
        url: 'https://www.driverservicebureau.dps.ms.gov/node/298',
        note: '六个月提前量、12 / 60 个月分界、every-other-online、$1 late fee 和 non-citizen 现场规则。',
      },
      {
        label: 'Mississippi Online Services',
        url: 'https://www.ms.gov/dps/license_renewal/',
        note: '官方 online renewal、duplicate、address、manual 和 appointment 入口。',
      },
      {
        label: 'Mississippi Online License Renewal',
        url: 'https://www.ms.gov/dps/license_renewal/License',
        note: 'U.S. citizen、Class R / D、有效证件 / 照片、时间窗口、费用和 mailing address 限制。',
      },
      {
        label: 'Mississippi Change Address',
        url: 'https://www.ms.gov/dps/license_renewal/ChangeAddress',
        note: '地址变更搭配 renewal / duplicate，physical delivery、P.O. Box 与 alternate address 限制。',
      },
      {
        label: 'Mississippi Duplicate License / ID',
        url: 'https://www.driverservicebureau.dps.ms.gov/Drivers/Duplicate_License',
        note: '$11、online / station、立即取证和现场拍照。',
      },
      {
        label: 'Mississippi Online Duplicate Portal',
        url: 'https://www.ms.gov/dps/license_renewal/Duplicate',
        note: 'online duplicate 的 valid-photo、card、mailing-address、P.O. Box 和 address-change 条件。',
      },
      {
        label: 'Mississippi Identification Cards',
        url: 'https://www.driverservicebureau.dps.ms.gov/Drivers/Identification_Cards',
        note: '六岁以上、4 / 8 年费用、申请表与首次材料。',
      },
      {
        label: 'Mississippi Non-U.S. Citizen Information',
        url: 'https://www.driverservicebureau.dps.ms.gov/Drivers/Non_Citizen',
        note: 'immigration documents、if-applicable SSN、30-day renewal、in-person、limited term 与 SAVE delay。',
      },
      {
        label: 'Mississippi Non-US Status Verification',
        url: 'https://www.driverservicebureau.dps.ms.gov/Security/Non_US_Status_Verification',
        note: 'SAVE verification 和常见 passport / visa / I-551 / I-766 文件入口。',
      },
      {
        label: 'Mississippi Learner Permit / Testing',
        url: 'https://www.driverservicebureau.dps.ms.gov/Drivers/Learners_Permit',
        note: 'in-person knowledge exam、电子设备禁令、年龄路线、school form 与 permit term。',
      },
      {
        label: 'Mississippi Interpreter Oath',
        url: 'https://www.driverservicebureau.dps.ms.gov/sites/default/files/2025-03/MDPS%20-%20Interpreter%20Oath.pdf',
        note: 'notarized interpreter oath、准确完整翻译与禁止答题 / 提示 / 解释。',
      },
      {
        label: 'Mississippi Mandatory Driver Education Update',
        url: 'https://www.driverservicebureau.dps.ms.gov/node/400',
        note: '2026-07-01 hardship instructor 认证和 2027-07-01 all-new-driver education 要求。',
      },
      {
        label: 'Mississippi Driver Service Fees',
        url: 'https://www.driverservicebureau.dps.ms.gov/Drivers/Driver_Service_Fees',
        note: 'Class R、State ID、duplicate、non-citizen、late renewal 和支付方式。',
      },
      {
        label: 'Mississippi Driver License Locations',
        url: 'https://www.driverservicebureau.dps.ms.gov/drivers/driver_license_locations',
        note: 'station 地点、weekday hours、部分 appointment-only / limited-services 边界。',
      },
      {
        label: 'Mississippi DPS Appointment System',
        url: 'https://telegov.egov.com/dps',
        note: 'DPS 官方 appointment scheduling。',
      },
      {
        label: 'Mississippi DSB Frequently Asked Questions',
        url: 'https://www.driverservicebureau.dps.ms.gov/frequently-asked-questions',
        note: 'all-MS-credentials Gold Star、online services；页面含失效 2023 deadline，必须交叉核对。',
      },
      {
        label: 'TSA Acceptable Identification',
        url: 'https://www.tsa.gov/travel/security-screening/identification',
        note: '当前机场安检身份证件规则，用于替代 DSB FAQ 中失效的 2023 deadline。',
      },
    ],
    relatedTopicSlugs: [
      'real-id-basics',
  ...
  },
  {
    ...
    reviewedAt: '2026-07-21',
    summary:
      'South Dakota 首次申请、新居民转入、non-U.S. citizen 和需要考试的业务应走 Driver Licensing location；只有符合条件的现有 Gold Star credential 持有人才考虑 online / mail renewal 或 duplicate。州法把已在 South Dakota 居住 90 天的人视为驾照目的下的 resident，不能长期把外州或外国证件当作免换路线。',
    realIdSummary:
      'South Dakota 的 printable checklist 分三路：Section 1 是 first-time / new resident 且没有外州 REAL ID，准备 identity、完整 SSN 和两份地址；Section 2 是持外州 Gold Star card 转入，仍要该卡、另一份 identity 和两份地址；Section 3 是现有 South Dakota Gold Star card 续补证，通常带原卡和两份地址，卡丢失则按 Section 2 补 identity。',
    licenseSummary:
      '当前费用表写明普通 driver license / renewal / non-driver ID 为 $38，duplicate / replacement 或 name / address change 为 $20。普通驾照通常有效五年、最早到期前 180 天续期；过期超过 30 天要到 exam station 通过 knowledge test。首次领证还要 vision、80% knowledge 和 80% drive test。',
    appointmentNote:
      'Walk-in 可按容量接待，但任何 knowledge / drive test 都必须预约；non-U.S. citizen 必须去 state Driver Licensing location。full-time traveler / PMB 路线另需 notarized Residency Affidavit、过去一年内 South Dakota 一晚住宿收据和 PMB 文件，virtual address 不接受。',
    editorNotes: [
      '当前 SD.gov Fees 和 FAQ 已把普通 driver license / renewal 调整为 $38、duplicate / address change 调整为 $20；旧版 dps.sd.gov Driving Tests 与 Replacement 页面仍残留 $28 / $15，不应继续采用旧金额。',
      '两个当前知识库入口对寄送时间也不完全一致：online renew / replace 写 4–6 周，duplicate / address change 写 3–4 周；需要邮寄时按 4–6 周或更久规划，不承诺固定到证日。',
      'South Dakota Codified Law 32-12-26.1 写明，已经在州内居住 90 天的人被视为驾照目的下的 resident；这是居民身份门槛，不等于允许在第 90 天之后继续只用外州证件。',
      'Section 1 适用于 first-time / new resident 且没有外州 REAL ID，Section 2 适用于持外州 Gold Star credential 的转入，Section 3 适用于现有 South Dakota Gold Star credential 的续期或补证。',
      'new applicant、non-U.S. citizen 和 out-of-state transfer 都要提交 lawful-status identity；non-U.S. citizen 不能去 county / city issuance point，必须到 state Driver Licensing location。',
      '首次普通驾照要 vision、knowledge 和 drive test，knowledge 与 drive 都要求 80%；road test 要自备车辆，测试车内不能带乘客或宠物。',
      '现行 SDCL 32-12-126 只提供 English / Spanish application 和 written knowledge test；road-test instructions 使用 English，其他母语申请人可自行找到并付费使用经 DPS 批准的 interpreter 参加 driving test。',
      'online renewal / replacement 要求 U.S. citizen 或 permanent resident、未过期 Gold Star card、DL/ID number、DOB、SSN 后四位和两份一年内 physical-address documents。',
      '十年内没有 in-person、改姓名或 class / endorsement、需要 drive test、使用 bioptic lenses 或更新过 USCIS status，都要现场办理；后来又取得其他州 credential 时，原 South Dakota card 会 inactive，不能 online renewal。',
      '65 岁及以上通过 online 或 mail 续驾照，要交由 eye doctor 填写且不超过一年的 Vision Statement；bioptic-lens driver 不符合远程续期资格。',
      'driver license 过期超过 30 天必须现场考 knowledge；Class 2 motorcycle endorsement 还要 operator 与 motorcycle 两项 knowledge tests，所有 testing visit 都要预约。',
      'Residency Affidavit 不只是地址表：签字人声明 South Dakota 是居住州、没有在其他州维持 residence，并接受 perjury 条款；表格还提示取得 South Dakota DL / ID 可能带来州内 jury-duty 义务。',
      'full-time traveler 首次领证必须现场；使用 mail forwarding 时要 notarized affidavit、过去一年内一晚住宿收据和一年内 PMB 文件，virtual-only mailbox 不符合要求。',
      'state driver exam station 可在到访当天发实体 credential；full-time traveler 专页说明 county / city issuance location 当天只给 paper temporary，实体卡通常邮寄 4–6 周。',
      '现行申请表要求披露其他州或国家的 driver license / ID；South Dakota 签发后，其他州已签发的 credential 会被取消。',
      '州法允许 16 岁及以上 nonresident 随身持有效 home-state 或 home-country license 驾车，但 DPS 的 Gold Star transfer checklist 只写 another state；中国或其他外国驾照不能自行套用 Section 2 或假定免考。',
    ],
    documentHighlights: [
      'Section 1 identity：state / county certified U.S. birth certificate、未过期 U.S. passport / passport card、Consular Report of Birth Abroad、Certificate of Citizenship / Naturalization，或适用的 non-citizen 原件；hospital certificate 和 photocopy 不接受。',
      'Section 1 SSN：Social Security Card、W-2、1099 或 pay stub，必须显示姓名和完整 SSN；普通复印件不接受。',
      '所有申请人准备两份一年内的 South Dakota physical / residential address 文件，显示本人 full name；handwritten mail / address 和 photocopy 不接受。',
      '姓名与 lawful-status document 不同时，用政府签发的 certified marriage certificate、divorce decree 或 court order 串起从出生姓名到当前姓名的每一步。',
      'Section 2 要带外州 REAL ID compliant driver license / ID（valid 或 expired）、另一份公民或移民 identity 原件，以及两份 South Dakota physical-address documents。',
      'Section 3 的 U.S. citizen 可用现有 South Dakota Gold Star driver license / ID（valid 或 expired）作 identity，再加两份地址；卡丢失则按 Section 2 的 identity 清单。',
      'PO Box 最多出现在其中一份续期地址文件上，另一份必须显示 physical / residential address；18 岁以下可使用 parent / guardian mail。',
      'non-U.S. citizen 按身份准备 unexpired Permanent Resident Card、Employment Authorization Card，或 I-94 加未过期 foreign passport / visa；最终以当前 lawful status 和 DPS 核验为准。',
      'online / mail renewal 还要未过期 Gold Star card；online 要 DL/ID number、DOB、SSN 后四位，两份地址文件可 upload、email、fax 或 mail。',
      'full-time traveler / PMB 再加 notarized Residency Affidavit、一年内本人 South Dakota overnight-stay receipt，以及一年内显示姓名与 PMB address 的非手写文件。',
      '65 岁及以上 online / mail 续驾照再交一年内由 eye doctor 填写的官方 Vision Statement；只续 non-driver ID 的人不要套用驾照视力规则。',
    ],
    commonMistakes: [
      '继续引用旧 DPS 内容里的 $28 首证 / $15 duplicate，而没有核对当前 $38 / $20 fee table。',
      '持外州 Gold Star card 就只带这一张；Section 2 仍要求另一份 identity 和两份 South Dakota address documents。',
      '把中国或其他外国驾照当作 another-state Gold Star transfer，直接假定进入 Section 2 或免除考试。',
      '在 South Dakota 已居住满 90 天后仍把自己当临时 nonresident，不启动本州申请。',
      '地址文件超过一年、使用 handwritten mail / virtual address，或两份都只显示 PO Box。',
      '多次改名只带最后一张 marriage certificate，无法从 birth document 追到当前姓名。',
      '不是 U.S. citizen / permanent resident、卡已过期、上次已远程办理或后来取得外州 credential，仍直接提交 online renewal。',
      '驾照过期超过 30 天却没有预约 knowledge test；testing visit 不接受仅靠普通 walk-in 保证。',
      '为 written knowledge test 寻找中文口译；现行规则只列 English / Spanish，其他语言 interpreter 路线针对 driving test 且需 DPS 批准。',
      '把 PMB 当普通地址捷径，使用 virtual-only service 或在 Residency Affidavit 中忽略 residence、perjury 和 jury-duty 提示。',
      '把 3–4 周寄送说明当作保证；另一个当前入口写 4–6 周，邮寄材料还可能更久。',
    ],
    recommendedSteps: [
      '先定路线：first license、out-of-state Gold Star transfer、现有 South Dakota Gold Star renewal / duplicate、non-U.S. citizen、expired over 30 days 或 full-time traveler。',
      '新居民记录开始在 South Dakota 居住的日期；接近 90 天居民门槛前完成材料核对和地点安排。',
      '按对应 Section 整理 original identity、适用的 full-SSN proof、two recent physical-address documents 和完整 legal-name chain。',
      '持中国或其他外国驾照者按 new applicant / lawful-status 路线准备，不自行主张 another-state Gold Star transfer；预约前向 DPS 确认考试项目。',
      '需要考试时先预约；written test 按 English / Spanish 备考，driving test 需要其他语言帮助时提前确认 approved interpreter，并自备合格车辆。',
      '续期先核对 180-day window、卡是否未过期、上次是否 online / mail、十年内是否现场、是否有 name / class / USCIS 变化和 bioptic lens。',
      '65 岁及以上远程续驾照先让 eye doctor 完成一年内 Vision Statement；证件已过期超过 30 天则改走现场 knowledge-test 路线。',
      'full-time traveler 仔细阅读 Residency Affidavit 后再公证，并准备 overnight stay 与 PMB 文件；朋友或家人地址另用 Consent for Use of Address。',
      '付款前核对当前 Fees：普通首证 / 续期 $38，duplicate / address change $20，online 或现场刷卡另有 administrative fee。',
      '最后确认是 state exam station 还是 county / city issuance point、预约编号和交付方式；需要邮寄时按至少 4–6 周留出余量。',
    ],
    actionLinks: [
      {
      ...
      {
        label: 'South Dakota Current Required Documents',
        url: 'https://www.sd.gov/dps?id=kb_article_view&sysparm_article=KB0043703',
        description: '首证、外州转入、续补证、军人、未成年人和 full-time traveler 当前说明。',
      },
      {
        label: 'South Dakota Renew or Replace Online',
        url: 'https://www.sd.gov/dps?id=kb_article_view&sysparm_article=KB0043275',
        description: '线上资格、地址文件、65+ vision、排除条件与当前 4–6 周说明。',
      },
      {
        label: 'South Dakota Renew In Person',
        url: 'https://www.sd.gov/dps?id=kb_article_view&sysparm_article=KB0044261',
        description: '必须现场的情况、材料、30 天过期规则与 testing appointment。',
      },
      {
        label: 'South Dakota Duplicate / Address Change',
        url: 'https://www.sd.gov/dps?id=kb_article_view&sysparm_article=KB0043549',
        description: '补证、改地址的 online / mail / in-person 资格、$20 fee 与寄送说明。',
      },
      {
        label: 'South Dakota Driver License Testing',
        url: 'https://www.sd.gov/dps?id=kb_article_view&sysparm_article=KB0043731',
        description: 'vision、80% knowledge / road test、自备车辆和预约规则。',
      },
      {
        label: 'South Dakota Current Fees',
        url: 'https://www.sd.gov/dps?id=kb_article_view&sysparm_article=KB0043708',
        description: '当前 $38 首证 / 续期、$20 duplicate / address change 与支付附加费。',
      },
      {
        label: 'South Dakota Full-Time Travelers',
        url: 'https://www.sd.gov/dps?id=kb_article_view&sysparm_article=KB0043552',
        description: '首次到场、PMB、overnight stay、affidavit 和发证方式。',
      },
      {
        label: 'South Dakota Driver Licensing FAQ',
        url: 'https://www.sd.gov/dps?id=kb_article_view&sysparm_article=KB0043747',
        description: '五年有效期、180 天续期、考试、姓名变更和补证。',
      },
      {
        label: 'South Dakota Driver License Locations',
        url: 'https://www.sd.gov/dps?id=kb_article_view&sysparm_article=KB0010315',
        description: '州内 Driver Licensing location 地址与开放时间入口。',
      },
      {
        label: 'South Dakota Appointment Scheduler',
        url: 'https://432201.waitwell.us/locations',
        description: '预约、修改或取消 knowledge / drive test 和现场办理时段。',
      },
      {
        label: 'South Dakota Applications and Forms',
        url: 'https://www.sd.gov/dps?id=kb_article_view&sysparm_article=KB0043707',
        description: '申请表、Vision Statement、Consent for Use of Address 等表格入口。',
      },
      {
        label: 'South Dakota Driver License / ID Application (2025)',
        url: 'https://www.sd.gov/sys_attachment.do?sys_id=38a03980471eba50237fbd51026d4356',
        description: '当前申请表、其他州/国家 credential 披露和签字声明。',
      },
      {
        label: 'South Dakota Residency Affidavit',
        url: 'https://www.sd.gov/sys_attachment.do?sys_id=49c27bd087a26250b81f0f280cbb3563',
        description: 'full-time traveler 的公证、residence、perjury 与 jury-duty 提示。',
      },
      {
        label: 'South Dakota 90-Day Licensing Residency Law',
        url: 'https://sdlegislature.gov/Statutes/32-12-26.1',
        description: '驾照目的下居住 90 天的 resident 定义。',
      },
      {
        label: 'South Dakota Test Language / Interpreter Law',
        url: 'https://sdlegislature.gov/Statutes/32-12-126',
        description: 'English / Spanish written test 与 driving-test interpreter 边界。',
      },
      {
    ...
    sources: [
      ...
      {
        label: 'South Dakota Residency Affidavit (2024)',
        url: 'https://www.sd.gov/sys_attachment.do?sys_id=49c27bd087a26250b81f0f280cbb3563',
      },
      {
        label: 'South Dakota 90-Day Licensing Residency Law',
      ...
      {
        label: 'South Dakota Nonresident Foreign-License Law',
        url: 'https://sdlegislature.gov/Statutes/32-12-24',
      },
      {
        label: 'South Dakota Test Language / Interpreter Law',
        url: 'https://sdlegislature.gov/Statutes/32-12-126',
      ...
      {
        label: 'South Dakota Legacy Driving Tests (fee conflict)',
        url: 'https://dps.sd.gov/driver-licensing/south-dakota-licensing-information/driving-tests',
      },
      {
        label: 'South Dakota Legacy Replacement Page (fee conflict)',
        url: 'https://dps.sd.gov/driver-licensing/renew-and-duplicate/replacement-or-duplicate',
      },
      {
        label: 'South Dakota DPS',
        url: 'https://www.sd.gov/dps',
