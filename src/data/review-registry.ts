...
export const semanticReviews: Record<string, SemanticReview> = {
  ...
  '/topics/temporary-tag-trip-permit-dealer-plate/': {
    ...
    notes:
      '2026-07-29 重新核对 Texas HB 718、temporary permits 及 CA、NY、FL、WA、OR、VA、GA、CO、MA 当前官方入口；现有结论未变。Georgia 官网对 dealer TOP 写有 30 天与 45 天两种口径，正文因此继续不写死期限，并保留“dealer 不得自行续发”的窄化表达。',
  },
