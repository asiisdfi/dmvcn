...
export const editorialUpdates: EditorialUpdate[] = [
  ...
  },
  {
    ...
    summary:
      '高风险页面现在会把人工签字日期与当前内容更新、事实核对日期逐页比较。签字后又发生实质修改时，旧签字自动失效，页面改为 noindex 并从 sitemap 移除；真实人员重新核对当前版本并签字后才恢复收录。本轮识别出的四个旧签字页面没有补写或伪造新审核日期。',
    scope: [
      '高风险内容版本登记',
      '人工签字新鲜度门禁',
      '四个页面自动退出 sitemap',
  ...
  },
  {
    ...
    title: '补齐五个曝光页面的查询归因',
    summary:
      '从 Search Console 为五个已有曝光的页面补齐 140 条页面级查询证据。四个页面当前只出现泛英文或其他非目标查询，不再据此扩写中文正文；亲属赠车与继承页面出现一条涉及债务责任的中文查询，已转入人工语义与官方依据复核，不自动生成答案。',
    scope: [
      '140 条页面级查询证据',
      '四个非目标英文曝光页面',
      '一个法律责任人工复核信号',
