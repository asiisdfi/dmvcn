...
- 数据状态：可用于规划；快照 2026-07-24，最新完整数据 2026-07-22。
- 纳入页数：124
- 可见查询：1000 条；中文查询 29 条 / 56 次曝光
- 泛英文 DMV 大词曝光：548
- 可自动处理的中文信号：18；需要人工复核：3
...
- /directories/dmv-services/（展现 1922）— 2026-07-24 已设置 noindex，2026-08-21 复查 Google 索引状态；观察期内不按这些曝光扩写内容。
- /sources/（展现 1033）— 2026-07-24 已设置 noindex，2026-08-21 复查 Google 索引状态；观察期内不按这些曝光扩写内容。
- /directories/service-paths/（展现 323）— 2026-07-24 已设置 noindex，2026-08-21 复查 Google 索引状态；观察期内不按这些曝光扩写内容。

## 中文查询信号
- 本月识别 18 个可自动处理信号，优先用于标题、摘要、入口和内部链接校准。
...
## 泛英文曝光观察
- /states/new-jersey/（展现 75）— 现有页面级信号来自泛英文或本地查询，不为非目标曝光扩写中文内容。
- /states/georgia/（展现 59）— 现有页面级信号来自泛英文或本地查询，不为非目标曝光扩写中文内容。
- /topics/tickets-tolls-insurance-lapse-registration-hold/（展现 56）— 现有页面级信号来自泛英文或本地查询，不为非目标曝光扩写中文内容。
- /states/utah/（展现 53）— 现有页面级信号来自泛英文或本地查询，不为非目标曝光扩写中文内容。
- /states/north-carolina/（展现 51）— 现有页面级信号来自泛英文或本地查询，不为非目标曝光扩写中文内容。
